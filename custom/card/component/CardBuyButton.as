package custom.card.component
{
   ...
   public class CardBuyButton extends Group implements IStateClient2
   {
      ...
      public function CardBuyButton()
      {
         ...
         var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._CardBuyButton_Button1_i);
         _loc2_ = new DeferredInstanceFromFunction(this._CardBuyButton_ButtonBuy1_i);
         states = [new State({
            "name":"none",
            "overrides":[]
         }),new State({
      ...
      private function _CardBuyButton_ButtonBuy1_i() : ButtonBuy
      {
      ...
      {
         dispatchEvent(new CardEvent(CardEvent.BUY_BUTTON_CLICKED));
      }
      
      private function _CardBuyButton_Button1_i() : Button
      {
