   ...
   public final class FSM_imalloc extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         else if(uint(_loc1_) <= uint(2048))
         {
            ...
            _loc3_ = li32(cmodule.aircall._page_dir);
            _loc4_ = _loc2_ << 2;
            ...
            if(_loc4_ == 0)
            {
               _loc3_ = 4096;
               cmodule.aircall.mstate.esp -= 4;
               si32(_loc3_,cmodule.aircall.mstate.esp);
               cmodule.aircall.mstate.esp -= 4;
               FSM_malloc_pages.start();
               _loc3_ = int(cmodule.aircall.mstate.eax);
               cmodule.aircall.mstate.esp += 4;
               if(_loc3_ != 0)
               {
                  _loc4_ = 4096;
                  ...
                  if(_loc6_ <= _loc8_)
                  {
                     ...
                     if(_loc13_ < _loc9_)
                     {
                        ...
                        while(_loc14_ += 1, _loc14_ != _loc9_);
                     ...
                     _loc4_ = li32(cmodule.aircall._malloc_origo);
                     _loc3_ >>>= 12;
                     _loc3_ -= _loc4_;
                     ...
                     else
                     {
                        ...
                        while(_loc9_ = _loc7_ & _loc8_, _loc9_ == 0);
                        
                     }
                     _loc7_ ^= _loc8_;
                     si32(_loc7_,_loc5_);
                     _loc7_ = li16(_loc4_ + 12);
                     _loc7_ = _loc7_ + -1;
                     ...
                     _loc2_ <<= 3;
                     _loc3_ = li8(cmodule.aircall._malloc_junk_2E_b);
                  ...
                  {
                     cmodule.aircall.mstate.esp -= 4;
                     si32(_loc7_,cmodule.aircall.mstate.esp);
                     cmodule.aircall.mstate.esp -= 4;
                     FSM_imalloc.start();
                     _loc8_ = int(cmodule.aircall.mstate.eax);
                     cmodule.aircall.mstate.esp += 4;
                     if(_loc8_ != 0)
                     {
                        §§goto(addr310);
         ...
         else
         {
            ...
            cmodule.aircall.mstate.esp -= 4;
            FSM_malloc_pages.start();
            _loc2_ = int(cmodule.aircall.mstate.eax);
            cmodule.aircall.mstate.esp += 4;
         }
         _loc3_ = li8(cmodule.aircall._malloc_zero_2E_b);
         _loc3_ ^= 1;
         if(_loc2_ != 0)
         {
            _loc3_ &= 1;
