package cmodule.aircall
{
   ...
   public final class FSM_write_tables_only extends Machine
   {
      ...
      public function FSM_write_tables_only()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_write_tables_only = null;
         _loc1_ = new FSM_write_tables_only();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 5:
               ...
               return;
            default:
               throw "Invalid state in _write_tables_only";
         }
         continue loop3;
      }
   }
