package cmodule.aircall
{
   ...
   public final class FSM_finish_pass_master extends Machine
   {
      ...
      public function FSM_finish_pass_master()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_finish_pass_master = null;
         _loc1_ = new FSM_finish_pass_master();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 1:
               ...
               return;
            default:
               throw "Invalid state in _finish_pass_master";
         }
      }
   }
}
