package cmodule.aircall
{
   ...
   public final class FSM_jpeg_make_c_derived_tbl extends Machine
   {
      ...
      public function FSM_jpeg_make_c_derived_tbl()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_jpeg_make_c_derived_tbl = null;
         _loc1_ = new FSM_jpeg_make_c_derived_tbl();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 1:
               ...
               si32(this.i7,this.i8 + 20);
               this.i7 = li32(this.i1);
               si32(this.i3,this.i7 + 24);
               ...
               while(true)
               {
                  ...
                  if(this.i10 >= 0)
                  {
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           this.i11 = mstate.ebp + -272;
                           this.i11 += this.i6;
                           si8(this.i7,this.i11);
                           this.i6 += 1;
                           continue loop1;
                        }
                     }
                        ...
                        if(this.i9 == 16)
                        {
                           ...
                           if(this.i7 != 0)
                           {
                              ...
                              while(true)
                              {
                                 this.i11 = mstate.ebp + -272;
                                 this.i11 += this.i10;
                                 this.i11 = si8(li8(this.i11));
                                 if(this.i11 == this.i7)
                                 {
                                    this.i11 = 0;
                                    this.i12 = this.i10 << 2;
                                    this.i12 = this.i0 + this.i12;
                                    this.i13 = this.i10 + this.i5;
                                    do
                                    {
                                       this.i14 = this.i9 + this.i11;
                                       si32(this.i14,this.i12);
                                       this.i14 = this.i13 + this.i11;
                                       this.i14 = si8(li8(this.i14 + 1));
                                       this.i12 += 4;
                                       this.i11 += 1;
                                    }
                                    while(this.i14 == this.i7);
                           ...
                           this.i7 = 0;
                           this.i9 = this.i4 + 1024;
                           this.i10 = 256;
                           memset(this.i9,this.i7,this.i10);
                           §§push(this);
                           if(this.i2 == 0)
                           {
                              §§push(255);
            ...
            case 6:
               ...
               while(true)
               {
                  ...
                  this.i10 = this.i5 + this.i7;
                  this.i10 = li8(this.i10);
                  this.i9 = this.i4 + this.i9;
                  si8(this.i10,this.i9 + 1024);
                  this.i0 += 4;
                  this.i7 += 1;
                  if(this.i7 != this.i6)
                  {
               ...
               break;
            default:
               throw "Invalid state in _jpeg_make_c_derived_tbl";
         }
         continue loop4;
      }
   }
