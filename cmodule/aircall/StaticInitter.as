package cmodule.aircall
{
   public class StaticInitter
   {
      ...
      {
         cmodule.aircall.gstate.gworker.mstate._mw16(param1,param2);
      }
      ...
      {
         cmodule.aircall.gstate.gworker.mstate._mw32(param1,param2);
      }
      ...
      public function alloc(param1:int, param2:int) : int
      {
         ...
         this.ptr = !!this.ptr ? this.ptr : (!!cmodule.aircall.gstate.ds.length ? int(cmodule.aircall.gstate.ds.length) : 1024);
         this.ptr = this.ptr + param2 - 1 & ~(param2 - 1);
         _loc3_ = this.ptr;
         this.ptr += param1;
         cmodule.aircall.gstate.ds.length = this.ptr;
         return _loc3_;
      }
      ...
      {
         cmodule.aircall.gstate.gworker.mstate._mw8(param1,param2);
      }
