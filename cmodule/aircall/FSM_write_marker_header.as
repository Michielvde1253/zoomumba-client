package cmodule.aircall
{
   ...
   public final class FSM_write_marker_header extends Machine
   {
      ...
      public function FSM_write_marker_header()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_write_marker_header = null;
         _loc1_ = new FSM_write_marker_header();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 3:
               ...
               return;
            default:
               throw "Invalid state in _write_marker_header";
         }
         mstate.esp -= 8;
         si32(this.i1,mstate.esp);
