      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               mstate.esp -= 0;
               this.i0 = li32(cmodule.aircall.___atexit);
               this.i1 = li32(mstate.ebp + 8);
               if(this.i0 == 0)
               {
                  this.i0 = cmodule.aircall.___atexit0_2E_3021;
                  si32(this.i0,cmodule.aircall.___atexit);
                  break;
               }
               this.i2 = this.i0;
               addr205:
            ...
            case 1:
               ...
               if(this.i2 != 0)
               {
                  this.i3 = li32(cmodule.aircall.___atexit);
                  if(this.i0 != this.i3)
                  {
                     this.i0 = 0;
                     mstate.esp -= 8;
                  ...
                  si32(this.i2,cmodule.aircall.___atexit);
                  this.i0 = this.i2;
                  this.i2 = this.i0;
                  §§goto(addr205);
               }
