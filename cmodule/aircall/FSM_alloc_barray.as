package cmodule.aircall
{
   ...
   public final class FSM_alloc_barray extends Machine
   {
      ...
      public function FSM_alloc_barray()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_alloc_barray = null;
         _loc1_ = new FSM_alloc_barray();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i4 = uint(999999988) / uint(this.i1);
            ...
            case 3:
               ...
               if(uint(this.i8) < uint(this.i6))
               {
                  ...
                  this.i4 = uint(this.i9) <= uint(this.i4) ? this.i9 : this.i4;
                  mstate.esp -= 12;
                  this.i9 = this.i1 * this.i4;
                  si32(this.i2,mstate.esp);
               ...
               break;
            default:
               throw "Invalid state in _alloc_barray";
         }
         this.i4 = this.i4 < this.i6 ? this.i4 : this.i6;
