package cmodule.aircall
{
   ...
   public final class FSM_int_downsample extends Machine
   {
      public function FSM_int_downsample()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         _loc1_ = li32(cmodule.aircall.mstate.ebp + 12);
         _loc2_ = li32(cmodule.aircall.mstate.ebp + 8);
         _loc3_ = li32(_loc2_ + 228);
         _loc4_ = li32(_loc1_ + 8);
         _loc5_ = li32(_loc2_ + 232);
         ...
         _loc14_ = li32(cmodule.aircall.mstate.ebp + 16);
         _loc15_ = li32(cmodule.aircall.mstate.ebp + 20);
         _loc11_ >>= 1;
         _loc13_ -= _loc2_;
         _loc1_ += 12;
         if(_loc13_ >= 1)
         {
            if(_loc5_ >= 1)
            {
               ...
               if(_loc13_ >= 1)
               {
                  ...
                  do
                  {
                     _loc18_ = li32(_loc17_);
                     _loc19_ = _loc3_ / _loc4_;
                     _loc19_ = _loc9_ * _loc19_;
                  ...
                  while(_loc13_ += 1, _loc13_ < _loc5_);
               ...
               do
               {
                  ...
                  do
                  {
                     ...
                     else
                     {
                        ...
                        {
                           _loc21_ = 0;
                           _loc22_ = _loc3_ / _loc4_;
                           _loc23_ = li32(_loc19_);
                           ...
                           do
                           {
                              ...
                              _loc23_ = li8(_loc23_);
                              _loc21_ += 1;
                              _loc18_ = _loc23_ + _loc18_;
                           }
                           while(_loc21_ < _loc8_);
                           
                           _loc19_ += 4;
                        }
                        while(_loc20_ += 1, _loc20_ < _loc7_);
                  ...
                  while(uint(_loc15_) < uint(_loc12_));
