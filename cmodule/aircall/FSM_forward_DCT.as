package cmodule.aircall
{
   ...
   public final class FSM_forward_DCT extends Machine
   {
      ...
      public function FSM_forward_DCT()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_forward_DCT = null;
         _loc1_ = new FSM_forward_DCT();
            ...
            case 1:
               ...
               if(uint(this.i8) < uint(this.i7))
               {
                  ...
                  do
                  {
                     ...
                     this.i21 = li8(this.i21);
                     this.i21 += -128;
                     si32(this.i21,this.i19 + 24);
                     this.i20 += this.i12;
                     this.i20 = li8(this.i20);
                     this.i20 += -128;
                     si32(this.i20,this.i19 + 28);
                     this.i19 += 32;
                     this.i11 += 4;
                     this.i10 += 1;
                  }
               ...
               break;
            default:
               throw "Invalid state in _forward_DCT";
         }
