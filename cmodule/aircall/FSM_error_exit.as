package cmodule.aircall
{
   ...
   public final class FSM_error_exit extends Machine
   {
      ...
      public function FSM_error_exit()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_error_exit = null;
         _loc1_ = new FSM_error_exit();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 3:
               mstate.esp += 4;
            default:
               throw "Invalid state in _error_exit";
         }
         this.i0 = 0;
