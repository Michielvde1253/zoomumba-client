package cmodule.aircall
{
   ...
   public final class FSM_do_barray_io extends Machine
   {
      ...
      public function FSM_do_barray_io()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_do_barray_io = null;
         _loc1_ = new FSM_do_barray_io();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               break;
            default:
               throw "Invalid state in _do_barray_io";
         }
