package cmodule.aircall
{
   ...
   public final class FSM_start_pass_fdctmgr extends Machine
   {
      ...
      public function FSM_start_pass_fdctmgr()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_start_pass_fdctmgr = null;
         _loc1_ = new FSM_start_pass_fdctmgr();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               this.i1 = li32(this.i0 + 356);
               this.i2 = li32(this.i0 + 64);
               this.i3 = li32(this.i0 + 56);
               this.i4 = this.i0 + 56;
               if(this.i3 >= 1)
               {
                  this.i3 = 0;
               ...
               while(true)
               {
                  ...
                  if(this.i11 != 2)
                  {
                     if(this.i11 != 1)
                     {
                        ...
                        this.i9 <<= 2;
                        this.i9 = this.i1 + this.i9;
                        this.i11 = li32(this.i9 + 12);
                        this.i9 += 12;
                        if(this.i11 == 0)
                        {
                           this.i11 = 256;
                     ...
                     else
                     {
                        ...
                        while(true)
                        {
                           this.i11 = cmodule.aircall._aanscales_2E_3123;
                           this.i12 = 0;
                           this.i13 = this.i12;
                           while(true)
                           {
                              this.i14 = this.i11 + this.i13;
                              this.i15 = this.i10 + this.i13;
                              this.i15 = li16(this.i15);
                              this.i14 = si16(li16(this.i14));
                              this.i14 *= this.i15;
                              this.i14 += 1024;
                              this.i14 >>= 11;
                  ...
                  else
                  {
                     ...
                     while(true)
                     {
                        this.i11 = cmodule.aircall._aanscalefactor_2E_3131;
                        this.i12 = 0;
                        do
                        {
                           this.i13 = cmodule.aircall._aanscalefactor_2E_3131;
                           ...
                           do
                           {
                              this.i17 = li16(this.i16);
                              this.f1 = Number(uint(this.i17));
            ...
            case 5:
               ...
               §§goto(addr926);
            default:
               throw "Invalid state in _start_pass_fdctmgr";
         }
         continue loop0;
      }
   }
