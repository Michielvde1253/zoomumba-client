package cmodule.aircall
{
   ...
   public final class FSM_select_scan_parameters extends Machine
   {
      ...
      public function FSM_select_scan_parameters()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_select_scan_parameters = null;
         _loc1_ = new FSM_select_scan_parameters();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               if(this.i1 != 0)
               {
                  this.i4 = li32(this.i0 + 328);
                  this.i4 = li32(this.i4 + 32);
                  this.i5 = this.i4 * 36;
                  this.i5 = this.i2 + this.i5;
                  this.i6 = li32(this.i5);
                  si32(this.i6,this.i0 + 240);
                  this.i6 = li32(this.i5);
                  if(this.i6 >= 1)
                  {
                     this.i6 = 0;
                     ...
                     do
                     {
                        this.i9 = this.i1 + this.i8;
                        this.i9 = li32(this.i9 + 4);
                        this.i10 = li32(this.i7);
                        this.i9 *= 84;
                        this.i11 = this.i3 + this.i8;
                        this.i9 = this.i10 + this.i9;
                        si32(this.i9,this.i11 + 244);
                        this.i9 = li32(this.i5);
                        this.i8 += 4;
                        this.i6 += 1;
                     }
                     while(this.i9 > this.i6);
                     
                  }
                  this.i3 = this.i4 * 36;
                  this.i3 = this.i2 + this.i3;
                  this.i1 = li32(this.i3 + 20);
                  si32(this.i1,this.i0 + 312);
                  this.i1 = li32(this.i3 + 24);
                  si32(this.i1,this.i0 + 316);
                  this.i1 = li32(this.i3 + 28);
                  si32(this.i1,this.i0 + 320);
                  this.i3 = li32(this.i3 + 32);
                  si32(this.i3,this.i0 + 324);
               }
               else
               {
                  ...
                  if(this.i1 >= 5)
                  {
                     ...
                     si32(this.i5,this.i1 + 24);
                     this.i1 = li32(this.i0);
                     this.i5 = 4;
                     si32(this.i5,this.i1 + 28);
                     this.i1 = li32(this.i0);
                  ...
                  si32(this.i1,this.i0 + 312);
                  this.i2 = 63;
                  si32(this.i2,this.i0 + 316);
                  si32(this.i1,this.i0 + 320);
                  si32(this.i1,this.i0 + 324);
               }
            ...
            case 1:
               ...
               §§goto(addr460);
            default:
               throw "Invalid state in _select_scan_parameters";
         }
         this.i2 = 0;
         this.i4 = li32(this.i0 + 64);
         this.i3 += 244;
         do
         {
