package cmodule.aircall
{
   ...
   public final class FSM_format_message extends Machine
   {
      ...
      public function FSM_format_message()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_format_message = null;
         _loc1_ = new FSM_format_message();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               if(this.i1 >= 1)
               {
                  this.i3 = li32(this.i0 + 116);
                  if(this.i3 >= this.i1)
                  {
                     this.i3 = li32(this.i0 + 112);
                     this.i4 = this.i1 << 2;
                     this.i3 += this.i4;
               ...
               this.i3 = li32(this.i0 + 120);
               if(this.i3 != 0)
               {
                  this.i4 = li32(this.i0 + 124);
                  if(this.i4 <= this.i1)
                  {
                     this.i5 = li32(this.i0 + 128);
                     if(this.i5 >= this.i1)
                     {
               ...
               si32(this.i7,mstate.esp + 20);
               si32(this.i6,mstate.esp + 24);
               si32(this.i5,mstate.esp + 28);
               si32(this.i4,mstate.esp + 32);
               si32(this.i3,mstate.esp + 36);
               state = 2;
               mstate.esp -= 4;
               FSM_sprintf.start();
               return;
            ...
            case 2:
               ...
               break;
            default:
               throw "Invalid state in _format_message";
         }
