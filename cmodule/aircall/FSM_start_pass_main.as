package cmodule.aircall
{
   ...
   public final class FSM_start_pass_main extends Machine
   {
      ...
      public function FSM_start_pass_main()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_start_pass_main = null;
         _loc1_ = new FSM_start_pass_main();
         ...
         switch(state)
         {
            case 0:
               ...
               if(this.i2 == 0)
               {
                  ...
                  if(this.i3 == 0)
                  {
                     this.i0 = cmodule.aircall._process_data_simple_main;
            ...
            case 1:
               ...
               break;
            default:
               throw "Invalid state in _start_pass_main";
         }
