package cmodule.aircall
{
   ...
   public final class FSM_term_destination extends Machine
   {
      ...
      public function FSM_term_destination()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_term_destination = null;
         _loc1_ = new FSM_term_destination();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 4:
               ...
               return;
            default:
               throw "Invalid state in _term_destination";
         }
