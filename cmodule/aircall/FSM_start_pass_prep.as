package cmodule.aircall
{
   ...
   public final class FSM_start_pass_prep extends Machine
   {
      ...
      public function FSM_start_pass_prep()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_start_pass_prep = null;
         _loc1_ = new FSM_start_pass_prep();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 1:
               ...
               break;
            default:
               throw "Invalid state in _start_pass_prep";
         }
         this.i2 = 0;
         this.i3 = li32(this.i0 + 32);
         si32(this.i3,this.i1 + 48);
         si32(this.i2,this.i1 + 52);
         si32(this.i2,this.i1 + 56);
         this.i0 = li32(this.i0 + 232);
         this.i0 <<= 1;
         si32(this.i0,this.i1 + 60);
