package cmodule.aircall
{
   ...
   public final class FSM_empty_output_buffer extends Machine
   {
      ...
      public function FSM_empty_output_buffer()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_empty_output_buffer = null;
         _loc1_ = new FSM_empty_output_buffer();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               break;
            default:
               throw "Invalid state in _empty_output_buffer";
         }
         this.i0 = 4096;
