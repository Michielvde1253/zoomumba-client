package cmodule.aircall
{
   ...
   public final class FSM_pre_process_data extends Machine
   {
      public static const intRegCount:int = 30;
      ...
      public function FSM_pre_process_data()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_pre_process_data = null;
         _loc1_ = new FSM_pre_process_data();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i8 = li32(mstate.ebp + 32);
               this.i9 = this.i2;
               this.i10 = this.i4;
               if(uint(this.i3) < uint(this.i6))
               {
                  this.i11 = this.i0 + 352;
                  this.i12 = this.i0 + 28;
                  this.i13 = this.i0 + 56;
                  this.i14 = this.i9 + 48;
                  this.i15 = this.i9 + 8;
                  this.i16 = this.i0 + 348;
                  this.i9 += 52;
                  this.i17 = this.i0 + 232;
                  break;
               }
               §§goto(addr936);
            case 1:
               ...
               this.i20 = this.i19 - this.i3;
               si32(this.i20,this.i14);
               if(this.i19 == this.i3)
               {
                        ...
                        while(true)
                        {
                           ...
                           if(this.i20 < this.i3)
                           {
                              ...
                              do
                              {
                                 this.i25 = 1;
                                 this.i26 = this.i20 << 2;
                                 this.i26 = this.i22 + this.i26;
                                 do
                                 {
                                    this.i27 = this.i24 + this.i26;
                                    this.i28 = li32(this.i26 + -4);
                                    this.i27 = li32(this.i27);
                                    this.i29 = this.i21;
                                    memcpy(this.i27,this.i28,this.i29);
                                    this.i26 += 4;
                                    this.i25 += -1;
                                 }
                                 while(this.i25 >= 1);
                              ...
                              while(this.i23 != this.i3);
                              
                           }
                           this.i3 = li32(this.i13);
                  ...
                  if(this.i3 == this.i18)
                  {
                     ...
                     this.i18 = li32(this.i18 + 4);
                     this.i19 = li32(this.i7);
                     mstate.esp -= 20;
                     si32(this.i0,mstate.esp);
                     si32(this.i15,mstate.esp + 4);
                     si32(this.i3,mstate.esp + 8);
                     si32(this.i4,mstate.esp + 12);
                     si32(this.i19,mstate.esp + 16);
                     state = 2;
                     mstate.esp -= 4;
            ...
            case 2:
                     ...
                     if(this.i0 >= 1)
                     {
                        ...
                        do
                        {
                           ...
                           if(this.i9 < this.i10)
                           {
                              ...
                              {
                                 this.i12 = 1;
                                 this.i14 = this.i5 * this.i4;
                                 this.i14 <<= 2;
                                 this.i14 = this.i6 + this.i14;
                                 do
                                 {
                                    this.i15 = this.i10 + this.i14;
                                    this.i16 = li32(this.i14 + -4);
                                    this.i15 = li32(this.i15);
                                    this.i17 = this.i2;
                                    memcpy(this.i15,this.i16,this.i17);
                                    this.i14 += 4;
                                    this.i12 += -1;
                                 }
                                 while(this.i12 >= 1);
               ...
               §§goto(addr936);
            default:
               throw "Invalid state in _pre_process_data";
         }
         this.i18 = li32(this.i7);
         if(uint(this.i18) >= uint(this.i8))
         {
            addr936:
         ...
         mstate.esp -= 20;
         this.i3 = uint(this.i3) <= uint(this.i19) ? this.i3 : this.i19;
         this.i19 = this.i5 + this.i21;
         si32(this.i0,mstate.esp);
