package cmodule.aircall
{
   ...
   public final class FSM_write_file_header extends Machine
   {
      ...
      public function FSM_write_file_header()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_write_file_header = null;
         _loc1_ = new FSM_write_file_header();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 44:
               ...
               break;
            default:
               throw "Invalid state in _write_file_header";
         }
         this.i0 = 0;
         this.i2 = li16(this.i1 + 212);
         mstate.esp -= 8;
         si32(this.i1,mstate.esp);
         si32(this.i2,mstate.esp + 4);
         state = 20;
