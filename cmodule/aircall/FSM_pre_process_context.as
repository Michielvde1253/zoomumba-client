package cmodule.aircall
{
   ...
   public final class FSM_pre_process_context extends Machine
   {
      ...
      public function FSM_pre_process_context()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_pre_process_context = null;
         _loc1_ = new FSM_pre_process_context();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               this.i1 = li32(mstate.ebp + 28);
               this.i2 = li32(this.i0 + 232);
               this.i3 = li32(this.i0 + 336);
               ...
               this.i9 = li32(mstate.ebp + 32);
               this.i10 = this.i3;
               if(uint(this.i4) < uint(this.i9))
               {
                  this.i4 = this.i10 + 56;
                  ...
                  this.i16 = this.i10 + 8;
                  this.i17 = this.i0 + 348;
                  this.i18 = this.i10 + 52;
                  this.i10 += 60;
                  break;
               }
               §§goto(addr1011);
            case 1:
                  ...
                  if(this.i20 >= 1)
                  {
                     ...
                     do
                     {
                        ...
                        if(this.i23 >= 1)
                        {
                           ...
                           {
                              this.i24 = 1;
                              this.i25 = this.i23 ^ 0x3FFFFFFF;
                              this.i26 = li32(this.i12);
                              this.i27 = li32(this.i22);
                              this.i25 <<= 2;
                              do
                              {
                                 this.i28 = this.i25 + this.i27;
                                 this.i29 = li32(this.i27);
                                 this.i28 = li32(this.i28);
                                 this.i30 = this.i26;
                                 memcpy(this.i28,this.i29,this.i30);
                                 this.i27 += 4;
                                 this.i24 += -1;
                              }
                              while(this.i24 >= 1);
                              
                              this.i24 = li32(this.i5);
                              this.i25 = this.i23 + 1;
                              this.i23 += 2;
               ...
               si32(this.i19,this.i15);
               this.i19 = li32(this.i10);
               if(this.i20 != this.i19)
               {
                  while(true)
                  {
                     this.i19 = li32(this.i1);
                     if(uint(this.i19) < uint(this.i9))
                     {
                        while(true)
                        {
                           break loop9;
               ...
               this.i19 = li32(this.i11);
               this.i19 = li32(this.i19 + 4);
               this.i20 = li32(this.i1);
            ...
            case 2:
               ...
               this.i19 = li32(this.i1);
               this.i19 += 1;
               si32(this.i19,this.i1);
               this.i19 = li32(this.i4);
               this.i20 = li32(this.i5);
               this.i19 = this.i20 + this.i19;
               this.i19 = this.i19 < this.i2 ? this.i19 : 0;
               si32(this.i19,this.i4);
               ...
               §§goto(addr996);
            default:
               throw "Invalid state in _pre_process_context";
         }
         continue loop0;
      }
   }
