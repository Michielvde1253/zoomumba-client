package cmodule.aircall
{
   ...
   public final class FSM_flush_bits5 extends Machine
   {
      ...
      public function FSM_flush_bits5()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_flush_bits5 = null;
         _loc1_ = new FSM_flush_bits5();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 4:
               ...
               §§goto(addr524);
            default:
               throw "Invalid state in _flush_bits5";
         }
         continue loop0;
      }
   }
