package cmodule.aircall
{
   ...
   public final class FSM_write_file_trailer extends Machine
   {
      ...
      public function FSM_write_file_trailer()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_write_file_trailer = null;
         _loc1_ = new FSM_write_file_trailer();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 1:
               ...
               return;
            default:
               throw "Invalid state in _write_file_trailer";
         }
      }
   }
}
