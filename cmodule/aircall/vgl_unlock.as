package cmodule.aircall
{
   ...
   {
      if(cmodule.aircall.gvglbmd && cmodule.aircall.gvglpixels)
      {
         cmodule.aircall.gstate.ds.position = cmodule.aircall.gvglpixels;
         cmodule.aircall.gvglbmd.setPixels(cmodule.aircall.gvglbmd.rect,cmodule.aircall.gstate.ds);
      }
   }
}
