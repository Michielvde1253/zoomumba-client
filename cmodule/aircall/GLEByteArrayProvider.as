package cmodule.aircall
{
   ...
   internal class GLEByteArrayProvider
   {
      ...
      public static function get() : ByteArray
      {
         ...
         try
         {
            result = cmodule.aircall.gdomainClass.currentDomain.domainMemory;
         }
         catch(e:*)
         {
         }
         if(!result)
         {
            ...
            try
            {
               result.length = cmodule.aircall.gdomainClass.MIN_DOMAIN_MEMORY_LENGTH;
               cmodule.aircall.gdomainClass.currentDomain.domainMemory = result;
            }
            catch(e:*)
            {
