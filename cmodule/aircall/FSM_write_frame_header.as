package cmodule.aircall
{
   ...
   public final class FSM_write_frame_header extends Machine
   {
      ...
      public function FSM_write_frame_header()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_write_frame_header = null;
         _loc1_ = new FSM_write_frame_header();
         ...
         switch(state)
         {
            case 0:
               ...
               if(this.i2 <= 0)
               {
                  ...
                  addr177:
                  this.i2 = this.i3;
                  this.i3 = li32(this.i0 + 176);
                  this.i5 = this.i0 + 176;
                  if(this.i3 == 0)
                  {
                     this.i3 = li32(this.i0 + 224);
                     if(this.i3 == 0)
                     {
                        ...
                        if(this.i3 == 8)
                        {
                           ...
                           else
                           {
                              ...
                              while(true)
                              {
                                 this.i7 = li32(this.i3 + 20);
                                 if(this.i7 <= 1)
                                 {
                                    this.i7 = li32(this.i3 + 24);
                                    if(this.i7 <= 1)
                                    {
                                    }
                                    addr281:
            ...
            case 3:
               ...
               return;
            default:
               throw "Invalid state in _write_frame_header";
         }
