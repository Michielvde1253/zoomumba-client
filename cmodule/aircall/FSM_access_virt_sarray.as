package cmodule.aircall
{
   ...
   public final class FSM_access_virt_sarray extends Machine
   {
      ...
      public function FSM_access_virt_sarray()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_access_virt_sarray = null;
         _loc1_ = new FSM_access_virt_sarray();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 7:
               ...
               break;
            default:
               throw "Invalid state in _access_virt_sarray";
         }
         if(this.i4 != 0)
         {
            §§goto(addr875);
