package cmodule.aircall
{
   ...
   public final class FSM_add_huff_table extends Machine
   {
      ...
      public function FSM_add_huff_table()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_add_huff_table = null;
         _loc1_ = new FSM_add_huff_table();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i6 = 17;
               memcpy(this.i1,this.i2,this.i6);
               this.i2 = 0;
               this.i1 = this.i2;
               do
               {
                  this.i6 = this.i5 + this.i1;
            ...
            case 2:
               ...
               break;
            default:
               throw "Invalid state in _add_huff_table";
         }
         this.i1 = 0;
