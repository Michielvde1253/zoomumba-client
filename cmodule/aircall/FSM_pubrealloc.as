      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               mstate.esp -= 4096;
               this.i0 = li32(cmodule.aircall._malloc_active_2E_3509);
               ...
               if(this.i0 >= 1)
               {
                  ...
                  {
                     this.i2 = 2;
                     si32(this.i2,cmodule.aircall._malloc_active_2E_3509);
                  }
                  this.i2 = 88;
                  si32(this.i2,cmodule.aircall._val_2E_1440);
                  this.i2 = 0;
               }
               else
               {
                  this.i0 = 1;
                  si32(this.i0,cmodule.aircall._malloc_active_2E_3509);
                  this.i0 = li8(cmodule.aircall._malloc_started_2E_3510_2E_b);
                  if(this.i0 == 0)
                  {
                     if(this.i2 == 0)
                     {
                        this.i0 = 0;
                        this.i4 = li32(cmodule.aircall._val_2E_1440);
                        ...
                        while(true)
                        {
                           ...
                           {
                              this.i0 = cmodule.aircall.__2E_str876;
                              this.i1 = 4;
                              log(this.i1,mstate.gworker.stringFromPtr(this.i0));
                              mstate.esp -= 4;
                              this.i0 = cmodule.aircall.__2E_str113335;
                           ...
                           while(true)
                           {
                              ...
                              this.i0 = li8(cmodule.aircall._malloc_zero_2E_b);
                              this.i0 ^= 1;
                              this.i0 &= 1;
                              if(this.i0 == 0)
                              {
                                 this.i0 = 1;
                                 si8(this.i0,cmodule.aircall._malloc_junk_2E_b);
                              }
                              this.i0 = cmodule.aircall.__2E_str210;
                              this.i1 = 4;
                              this.i5 = 0;
                              log(this.i1,mstate.gworker.stringFromPtr(this.i0));
                              ...
                              this.i0 = 4096;
                              this.i0 = _sbrk(this.i0);
                              si32(this.i0,cmodule.aircall._page_dir);
                              this.i0 = this.i5;
                              this.i0 = _sbrk(this.i0);
                              this.i0 += 4095;
                              this.i0 >>>= 12;
                              this.i0 += -12;
                              si32(this.i0,cmodule.aircall._malloc_origo);
                              this.i0 = 1024;
                              si32(this.i0,cmodule.aircall._malloc_ninfo);
                              this.i0 = li32(cmodule.aircall._malloc_cache);
                              if(this.i0 == 0)
                              {
                                 this.i0 += 1;
                                 si32(this.i0,cmodule.aircall._malloc_cache);
                              }
                              this.i1 = 20;
                              this.i0 <<= 12;
                              si32(this.i0,cmodule.aircall._malloc_cache);
                        ...
                        this.i0 = cmodule.aircall.__2E_str96;
                        mstate.esp -= 20;
                        this.i1 = cmodule.aircall.__2E_str13;
                        this.i7 = 99;
                        this.i8 = 22;
                     ...
                     si32(this.i2,cmodule.aircall._malloc_active_2E_3509);
                     this.i3 = 88;
                     si32(this.i3,cmodule.aircall._val_2E_1440);
                  }
                  addr1131:
                  this.i0 = li8(cmodule.aircall._malloc_sysv_2E_b);
                  ...
                  {
                     this.i0 = li32(cmodule.aircall._malloc_origo);
                     this.i2 = this.i1 >>> 12;
                     this.i4 = this.i2 - this.i0;
                     this.i5 = this.i1;
                     if(uint(this.i4) > uint(11))
                     {
                        this.i6 = li32(cmodule.aircall._last_index);
                        if(uint(this.i4) <= uint(this.i6))
                        {
                           this.i6 = li32(cmodule.aircall._page_dir);
                           this.i7 = this.i4 << 2;
                           ...
                           if(this.i7 == 2)
                           {
                              ...
                              if(this.i5 == 0)
                              {
                                 ...
                                 this.i5 = li8(cmodule.aircall._malloc_realloc_2E_b);
                                 if(this.i5 == 0)
                                 {
                                    if(uint(this.i0) >= uint(this.i3))
                                    {
                                       ...
                                       {
                                          this.i5 = li8(cmodule.aircall._malloc_junk_2E_b);
                                          if(this.i5 != 0)
                                          {
                                             this.i5 = -48;
                           ...
                           else if(uint(this.i7) >= uint(4))
                           {
                              ...
                              if(this.i4 == 0)
                              {
                                 ...
                                 if(this.i4 == 0)
                                 {
                                    this.i4 = li8(cmodule.aircall._malloc_realloc_2E_b);
                                    if(uint(this.i2) >= uint(this.i3))
                                    {
                                       ...
                                       if(this.i4 != 0)
                                       {
                                          ...
                                          this.i0 = li8(cmodule.aircall._malloc_junk_2E_b);
                                          this.i0 ^= 1;
                                          this.i0 &= 1;
                                          if(this.i0 == 0)
                                          {
            ...
            case 1:
               ...
               this.i0 = this.i5;
               log(this.i1,mstate.gworker.stringFromPtr(this.i0));
               si32(this.i8,cmodule.aircall._val_2E_1440);
               §§goto(addr900);
            case 2:
               while(true)
               {
                  ...
                  if(this.i0 != 0)
                  {
                     this.i1 = li32(cmodule.aircall._malloc_cache);
                     this.i7 = li8(cmodule.aircall._malloc_hint_2E_b);
                     this.i8 = li8(cmodule.aircall._malloc_realloc_2E_b);
                     this.i9 = li8(cmodule.aircall._malloc_junk_2E_b);
                     this.i10 = li8(cmodule.aircall._malloc_sysv_2E_b);
                     this.i11 = li8(cmodule.aircall._malloc_zero_2E_b);
                     while(true)
                     {
                        this.i12 = this.i1;
                        this.i1 = li8(this.i0);
                     ...
                     si32(this.i1,cmodule.aircall._malloc_cache);
                     si8(this.i7,cmodule.aircall._malloc_hint_2E_b);
                     si8(this.i8,cmodule.aircall._malloc_realloc_2E_b);
                     si8(this.i9,cmodule.aircall._malloc_junk_2E_b);
                     si8(this.i10,cmodule.aircall._malloc_sysv_2E_b);
                     si8(this.i0,cmodule.aircall._malloc_zero_2E_b);
                  }
                  §§goto(addr900);
               }
            case 3:
               this.i0 = mstate.eax;
               mstate.esp += 4;
               si32(this.i0,cmodule.aircall._px);
               si32(this.i4,cmodule.aircall._val_2E_1440);
               this.i0 = 1;
               si8(this.i0,cmodule.aircall._malloc_started_2E_3510_2E_b);
               §§goto(addr1131);
            case 5:
               mstate.esp += 4;
               si32(this.i3,cmodule.aircall._malloc_active_2E_3509);
               this.i1 = 2048;
               this.i0 = this.i3;
               break;
            case 4:
            ...
            case 6:
               ...
               si32(this.i1,cmodule.aircall._malloc_active_2E_3509);
               this.i1 = this.i0 & 1;
               this.i0 = this.i1;
               this.i1 = this.i3;
               break;
         ...
         {
            this.i0 = 12;
            si32(this.i0,cmodule.aircall._val_2E_1440);
         }
         mstate.eax = this.i1;
         addr2151:
