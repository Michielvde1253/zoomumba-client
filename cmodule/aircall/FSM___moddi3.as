package cmodule.aircall
{
   ...
   public final class FSM___moddi3 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc3_ = li32(cmodule.aircall.mstate.ebp + 20);
         _loc4_ = li32(cmodule.aircall.mstate.ebp + 8);
         _loc5_ = _loc2_ >> 31;
         _loc6_ = li32(cmodule.aircall.mstate.ebp + 16);
         _loc7_ = _loc3_ >> 31;
         _loc4_ = int(__addc(_loc4_,_loc5_));
         _loc8_ = int(__adde(_loc2_,_loc5_));
         _loc6_ = int(__addc(_loc6_,_loc7_));
         _loc3_ = int(__adde(_loc3_,_loc7_));
         cmodule.aircall.mstate.esp -= 20;
         _loc3_ ^= _loc7_;
         _loc6_ ^= _loc7_;
         _loc7_ = _loc8_ ^ _loc5_;
         _loc4_ ^= _loc5_;
         si32(_loc4_,cmodule.aircall.mstate.esp);
         si32(_loc7_,cmodule.aircall.mstate.esp + 4);
         si32(_loc6_,cmodule.aircall.mstate.esp + 8);
         si32(_loc3_,cmodule.aircall.mstate.esp + 12);
         si32(_loc1_,cmodule.aircall.mstate.esp + 16);
         cmodule.aircall.mstate.esp -= 4;
         FSM___qdivrem.start();
         _loc1_ = int(cmodule.aircall.mstate.eax);
         _loc1_ = int(cmodule.aircall.mstate.edx);
         cmodule.aircall.mstate.esp += 20;
         ...
         {
            _loc2_ = 0;
            _loc1_ = int(__subc(_loc2_,_loc1_));
            _loc3_ = int(__sube(_loc2_,_loc3_));
         }
         cmodule.aircall.mstate.edx = _loc3_;
