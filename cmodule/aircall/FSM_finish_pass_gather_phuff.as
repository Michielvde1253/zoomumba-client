package cmodule.aircall
{
   ...
   public final class FSM_finish_pass_gather_phuff extends Machine
   {
      ...
      public function FSM_finish_pass_gather_phuff()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_finish_pass_gather_phuff = null;
         _loc1_ = new FSM_finish_pass_gather_phuff();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 2:
               ...
               state = 3;
               mstate.esp -= 4;
               FSM_jpeg_gen_optimal_table.start();
               return;
            case 3:
               mstate.esp += 12;
            ...
            case 5:
               ...
               §§goto(addr691);
            default:
               throw "Invalid state in _finish_pass_gather_phuff";
         }
