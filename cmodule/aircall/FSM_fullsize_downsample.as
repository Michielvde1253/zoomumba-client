package cmodule.aircall
{
   ...
   public final class FSM_fullsize_downsample extends Machine
   {
      public function FSM_fullsize_downsample()
      {
         super();
      }
