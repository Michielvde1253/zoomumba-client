package cmodule.aircall
{
   ...
   public final class FSM_jpeg_CreateCompress extends Machine
   {
      ...
      public function FSM_jpeg_CreateCompress()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_jpeg_CreateCompress = null;
         _loc1_ = new FSM_jpeg_CreateCompress();
         ...
         switch(state)
         {
            ...
            case 1:
               ...
               if(this.i0 == 0)
               {
                  ...
                  si32(this.i8,this.i9 + 20);
                  this.i8 = li32(this.i6);
                  this.i9 = 0;
                  si32(this.i9,this.i8 + 24);
               ...
               addr254:
               this.i5 = cmodule.aircall._alloc_small;
               si32(this.i5,this.i0);
               this.i5 = cmodule.aircall._alloc_large;
               si32(this.i5,this.i4 + 4);
               this.i5 = cmodule.aircall._alloc_sarray;
               si32(this.i5,this.i4 + 8);
               this.i5 = cmodule.aircall._alloc_barray;
               si32(this.i5,this.i4 + 12);
               this.i5 = cmodule.aircall._request_virt_sarray;
               si32(this.i5,this.i4 + 16);
               this.i5 = cmodule.aircall._request_virt_barray;
               si32(this.i5,this.i4 + 20);
               this.i5 = cmodule.aircall._realize_virt_arrays;
               si32(this.i5,this.i4 + 24);
               this.i5 = cmodule.aircall._access_virt_sarray;
               si32(this.i5,this.i4 + 28);
               this.i5 = cmodule.aircall._access_virt_barray;
               si32(this.i5,this.i4 + 32);
               this.i5 = cmodule.aircall._free_pool;
               si32(this.i5,this.i4 + 36);
               this.i5 = cmodule.aircall._self_destruct;
               si32(this.i5,this.i4 + 40);
               this.i5 = 1000000000;
               si32(this.i5,this.i4 + 48);
               this.i5 = li32(mstate.ebp + -4);
               si32(this.i5,this.i4 + 44);
               this.i5 = 0;
               this.i6 = this.i4 + 44;
               do
               {
                  this.i8 = 0;
                  si32(this.i8,this.i3 + 56);
                  si32(this.i8,this.i3 + 64);
                  this.i3 += -4;
                  this.i5 += 1;
               }
               while(this.i5 != 2);
               ...
               this.i3 = 0;
               si32(this.i3,this.i4 + 68);
               si32(this.i3,this.i4 + 72);
               this.i3 = 84;
               si32(this.i3,this.i4 + 76);
               si32(this.i0,this.i2);
               mstate.esp -= 4;
               this.i0 = cmodule.aircall.__2E_str125;
               si32(this.i0,mstate.esp);
               mstate.esp -= 4;
               FSM_getenv.start();
               break;
            ...
            case 3:
               ...
               {
                  this.i2 = 120;
                  si8(this.i2,mstate.ebp + -5);
                  mstate.esp -= 12;
                  this.i2 = mstate.ebp + -4;
                  this.i3 = mstate.ebp + -5;
                  si32(this.i0,mstate.esp);
                  si32(this.i2,mstate.esp + 4);
            ...
            case 4:
               ...
               break;
            default:
               throw "Invalid state in _jpeg_CreateCompress";
         }
         this.i0 = 0;
         si32(this.i0,this.i1 + 8);
         si32(this.i0,this.i1 + 24);
