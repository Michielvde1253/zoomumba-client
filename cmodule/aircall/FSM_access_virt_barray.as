package cmodule.aircall
{
   ...
   public final class FSM_access_virt_barray extends Machine
   {
      ...
      public function FSM_access_virt_barray()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_access_virt_barray = null;
         _loc1_ = new FSM_access_virt_barray();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
                                 ...
                                 if(this.i8 != 0)
                                 {
                                    ...
                                    if(uint(this.i9) < uint(this.i6))
                                    {
                                       ...
                                       while(true)
                                       {
                                          ...
                                          this.i11 = this.i3;
                                          memset(this.i10,this.i9,this.i11);
                                          this.i5 += 4;
                                          this.i6 += 1;
                                          if(this.i6 == this.i2)
                                          {
            ...
            case 7:
               ...
               break;
            default:
               throw "Invalid state in _access_virt_barray";
         }
         if(this.i4 != 0)
         {
            §§goto(addr881);
