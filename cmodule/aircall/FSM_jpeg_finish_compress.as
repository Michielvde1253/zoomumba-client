package cmodule.aircall
{
   ...
   public final class FSM_jpeg_finish_compress extends Machine
   {
      ...
      public function FSM_jpeg_finish_compress()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_jpeg_finish_compress = null;
         _loc1_ = new FSM_jpeg_finish_compress();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 12:
               ...
               return;
            default:
               throw "Invalid state in _jpeg_finish_compress";
         }
