package cmodule.aircall
{
   ...
   public final class FSM___ratio_D2A extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         cmodule.aircall.mstate.esp -= 40;
         _loc1_ = cmodule.aircall.mstate.ebp + -8;
         cmodule.aircall.mstate.esp -= 8;
         _loc2_ = li32(cmodule.aircall.mstate.ebp + 8);
         si32(_loc2_,cmodule.aircall.mstate.esp);
         si32(_loc1_,cmodule.aircall.mstate.esp + 4);
         cmodule.aircall.mstate.esp -= 4;
         FSM___b2d_D2A.start();
         _loc7_ = Number(cmodule.aircall.mstate.st0);
         cmodule.aircall.mstate.esp += 8;
         cmodule.aircall.mstate.esp -= 8;
         _loc1_ = li32(cmodule.aircall.mstate.ebp + 12);
         _loc3_ = cmodule.aircall.mstate.ebp + -4;
         si32(_loc1_,cmodule.aircall.mstate.esp);
         si32(_loc3_,cmodule.aircall.mstate.esp + 4);
         cmodule.aircall.mstate.esp -= 4;
         FSM___b2d_D2A.start();
         _loc8_ = Number(cmodule.aircall.mstate.st0);
         cmodule.aircall.mstate.esp += 8;
         _loc2_ = li32(_loc2_ + 16);
         _loc1_ = li32(_loc1_ + 16);
         _loc1_ = _loc2_ - _loc1_;
         _loc2_ = li32(cmodule.aircall.mstate.ebp + -8);
         _loc3_ = li32(cmodule.aircall.mstate.ebp + -4);
         sf64(_loc7_,cmodule.aircall.mstate.ebp + -16);
         sf64(_loc8_,cmodule.aircall.mstate.ebp + -24);
         _loc1_ <<= 5;
         _loc2_ -= _loc3_;
         _loc3_ = li32(cmodule.aircall.mstate.ebp + -16);
         _loc4_ = li32(cmodule.aircall.mstate.ebp + -12);
         _loc5_ = li32(cmodule.aircall.mstate.ebp + -24);
         ...
         if(_loc1_ >= 1)
         {
            _loc1_ <<= 20;
            _loc1_ += _loc4_;
            si32(_loc3_,cmodule.aircall.mstate.ebp + -32);
            si32(_loc1_,cmodule.aircall.mstate.ebp + -28);
            _loc7_ = lf64(cmodule.aircall.mstate.ebp + -32);
         }
         else
         {
            _loc1_ <<= 20;
            _loc1_ = _loc6_ - _loc1_;
            si32(_loc5_,cmodule.aircall.mstate.ebp + -40);
            si32(_loc1_,cmodule.aircall.mstate.ebp + -36);
            _loc8_ = lf64(cmodule.aircall.mstate.ebp + -40);
         }
         _loc7_ /= _loc8_;
         cmodule.aircall.mstate.st0 = _loc7_;
