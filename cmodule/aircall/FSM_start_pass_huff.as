package cmodule.aircall
{
   ...
   public final class FSM_start_pass_huff extends Machine
   {
      ...
      public function FSM_start_pass_huff()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_start_pass_huff = null;
         _loc1_ = new FSM_start_pass_huff();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               if(this.i3 != 0)
               {
                  this.i6 = cmodule.aircall._encode_mcu_gather;
                  si32(this.i6,this.i2);
                  this.i2 = cmodule.aircall._finish_pass_gather;
                  si32(this.i2,this.i4 + 8);
                  this.i2 = li32(this.i0 + 240);
                  if(this.i2 <= 0)
                  {
                     §§goto(addr101);
                  }
               ...
               {
                  this.i6 = cmodule.aircall._encode_mcu_huff;
                  si32(this.i6,this.i2);
                  this.i2 = cmodule.aircall._finish_pass_huff;
                  si32(this.i2,this.i4 + 8);
                  this.i2 = li32(this.i0 + 240);
                  if(this.i2 >= 1)
                  {
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        ...
                        memset(this.i12,this.i13,this.i14);
                        this.i12 = li32(this.i11 + 92);
                        this.i11 += 92;
                        if(this.i12 == 0)
                        {
                           this.i12 = 1028;
                        ...
                        this.i11 = 0;
                        this.i13 = 1028;
                        memset(this.i12,this.i11,this.i13);
                        while(true)
                        {
                           this.i11 = 0;
                           this.i12 = this.i1 + this.i10;
            ...
            case 4:
               ...
               this.i11 = 0;
               memset(this.i13,this.i11,this.i12);
               this.i12 = this.i1 + this.i10;
               si32(this.i11,this.i12 + 20);
               §§goto(addr858);
            case 5:
               ...
               state = 6;
               mstate.esp -= 4;
               FSM_jpeg_make_c_derived_tbl.start();
               return;
            case 6:
               mstate.esp += 16;
               §§goto(addr841);
            default:
               throw "Invalid state in _start_pass_huff";
         }
         continue loop0;
      }
   }
