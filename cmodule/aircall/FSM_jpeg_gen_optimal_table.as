package cmodule.aircall
{
   ...
   public final class FSM_jpeg_gen_optimal_table extends Machine
   {
      ...
      public function FSM_jpeg_gen_optimal_table()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_jpeg_gen_optimal_table = null;
         _loc1_ = new FSM_jpeg_gen_optimal_table();
         ...
         switch(state)
         {
            case 0:
               ...
               while(true)
               {
                  ...
                  this.i12 = this.i10 > this.i1 ? 1 : 0;
                  this.i11 |= this.i12;
                  this.i11 &= 1;
                  this.i9 = this.i11 != 0 ? this.i9 : this.i4;
                  this.i1 = this.i11 != 0 ? this.i1 : this.i10;
                  this.i4 += 1;
                  if(this.i4 >= 257)
                  {
                     this.i1 = -1;
                     ...
                     this.i4 = mstate.ebp + -1088;
                     this.i9 <<= 2;
                     this.i10 = this.i1 << 2;
                     this.i10 = this.i3 + this.i10;
                     this.i11 = this.i3 + this.i9;
                     this.i12 = li32(this.i11);
                     ...
                     this.i11 = mstate.ebp + -2128;
                     this.i10 += 1;
                     si32(this.i10,this.i4);
                     this.i4 = this.i11 + this.i9;
                     this.i9 = li32(this.i4);
                     if(this.i9 > -1)
                     {
                        do
                        {
                           this.i9 = mstate.ebp + -1088;
                     ...
                     this.i4 = this.i9 + this.i10;
                     this.i9 = li32(this.i4);
                     this.i11 = mstate.ebp + -2128;
                     this.i9 += 1;
                     si32(this.i9,this.i4);
                     this.i4 = this.i11 + this.i10;
                     this.i4 = li32(this.i4);
                     if(this.i4 > -1)
                     {
                        do
            ...
            case 1:
                  ...
                  while(true)
                  {
                     ...
                     if(this.i1 == 257)
                     {
                           ...
                           if(this.i1 != 0)
                           {
                              ...
                              do
                              {
                                 ...
                                 else
                                 {
                                    ...
                                    do
                                    {
                                       this.i12 = this.i0 + this.i11;
                                       this.i12 = li8(this.i12 + 29);
                                       this.i11 += -1;
                                    }
                                    while(this.i12 == 0);
                                 ...
                                 this.i13 = li8(this.i1 + 1);
                                 this.i13 += 2;
                                 si8(this.i13,this.i1 + 1);
                                 this.i1 = this.i12 + this.i11;
                                 this.i11 = li8(this.i1);
                                 this.i11 += -1;
                                 si8(this.i11,this.i1);
                                 this.i1 = li8(this.i3);
                              }
                              while(this.i1 != 0);
                        ...
                        else
                        {
                           ...
                           do
                           {
                              this.i3 = this.i0 + this.i1;
                              this.i3 = li8(this.i3 + 15);
                              this.i1 += -1;
                           }
                           while(this.i3 == 0);
                        ...
                        this.i1 = this.i7;
                        this.i3 = 17;
                        memcpy(this.i0,this.i1,this.i3);
                        this.i0 = 0;
                        this.i1 = this.i0;
                        do
                        {
               ...
               break;
            default:
               throw "Invalid state in _jpeg_gen_optimal_table";
         }
         continue loop5;
      }
   }
