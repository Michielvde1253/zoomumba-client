package cmodule.aircall
{
   ...
   public final class FSM_prepare_for_pass extends Machine
   {
      ...
      public function FSM_prepare_for_pass()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_prepare_for_pass = null;
         _loc1_ = new FSM_prepare_for_pass();
      ...
      final override public function work() : void
      {
         switch(state)
         {
               ...
               if(this.i2 != 2)
               {
                  if(this.i2 != 1)
                  {
                     if(this.i2 == 0)
                     {
                        ...
                        state = 1;
                        mstate.esp -= 4;
                        FSM_select_scan_parameters.start();
                        return;
                     }
                     this.i2 = 48;
            ...
            case 1:
               ...
               state = 2;
               mstate.esp -= 4;
               FSM_per_scan_setup.start();
               return;
            case 2:
               mstate.esp += 4;
               this.i3 = li32(this.i0 + 172);
               if(this.i3 == 0)
               {
                  this.i3 = 0;
                  this.i2 = li32(this.i0 + 348);
                  this.i2 = li32(this.i2);
                  mstate.esp -= 4;
                  si32(this.i0,mstate.esp);
                  state = 3;
            ...
            case 11:
               mstate.esp += 4;
               this.i2 = li32(this.i0 + 312);
               if(this.i2 == 0)
               {
                  this.i2 = li32(this.i0 + 320);
                  if(this.i2 != 0)
                  {
                     this.i2 = li32(this.i0 + 176);
                     if(this.i2 == 0)
                     {
                        this.i2 = 2;
            ...
            case 20:
               ...
               break;
            default:
               throw "Invalid state in _prepare_for_pass";
         }
         this.i2 = li32(this.i1 + 28);
         this.i3 = li32(this.i1 + 24);
         this.i2 += -1;
         this.i2 = this.i3 == this.i2 ? 1 : 0;
         this.i2 &= 1;
