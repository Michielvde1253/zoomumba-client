package cmodule.aircall
{
   ...
   public final class FSM_encode_mcu_gather extends Machine
   {
      ...
      public function FSM_encode_mcu_gather()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_encode_mcu_gather = null;
         _loc1_ = new FSM_encode_mcu_gather();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               {
                  this.i2 = this.i1 << 2;
                  this.i3 = this.i0 + this.i2;
                  this.i3 = li32(this.i3 + 272);
                  this.i3 <<= 2;
                  this.i6 = this.i0 + this.i3;
                  this.i6 = li32(this.i6 + 244);
                  this.i7 = li32(this.i6 + 24);
                  ...
                  this.i7 = li32(this.i7 + 92);
                  this.i6 = li32(this.i6 + 76);
                  this.i9 = li32(this.i3 + 20);
                  this.i10 = si16(li16(this.i8));
                  this.i3 += 20;
                  ...
                  if(this.i11 >= 0)
                  {
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           ...
                           this.i14 <<= 1;
                           this.i14 = this.i8 + this.i14;
                           this.i14 = li16(this.i14);
                           this.i15 = this.i14 << 16;
                           this.i15 >>= 16;
                           if(this.i14 != 0)
                           {
                              if(this.i6 > 15)
            ...
            case 2:
               ...
               §§goto(addr908);
            default:
               throw "Invalid state in _encode_mcu_gather";
         }
         continue loop1;
      }
   }
