package cmodule.aircall
{
   ...
   public final class FSM_do_sarray_io extends Machine
   {
      ...
      public function FSM_do_sarray_io()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_do_sarray_io = null;
         _loc1_ = new FSM_do_sarray_io();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               if(this.i3 >= 1)
               {
                  ...
                  if(this.i7 != 0)
                  {
                     ...
                     this.i3 = this.i3 <= this.i14 ? this.i3 : this.i14;
                     this.i14 = this.i15 - this.i7;
                     this.i3 = this.i14 <= this.i3 ? this.i14 : this.i3;
                     this.i7 = this.i16 - this.i7;
                     this.i3 = this.i7 <= this.i3 ? this.i7 : this.i3;
                     if(this.i3 >= 1)
                     {
            ...
            case 2:
               ...
               break;
            default:
               throw "Invalid state in _do_sarray_io";
         }
