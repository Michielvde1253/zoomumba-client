package cmodule.aircall
{
   ...
   public final class FSM_encode_mcu_DC_refine extends Machine
   {
      ...
      public function FSM_encode_mcu_DC_refine()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_encode_mcu_DC_refine = null;
         _loc1_ = new FSM_encode_mcu_DC_refine();
         ...
         switch(state)
         {
            ...
            case 1:
               ...
               if(this.i1 >= 1)
               {
                  ...
                  while(true)
                  {
                     this.i9 = li32(this.i2 + 28);
                     this.i10 = li32(this.i2 + 12);
                     this.i11 = this.i2 + 28;
                     if(this.i10 == 0)
                     {
                        this.i10 = this.i1 << 2;
                        ...
                        this.i10 = si16(li16(this.i10));
                        this.i10 >>>= this.i3;
                        this.i12 = 23 - this.i9;
                        this.i10 &= 1;
                        this.i13 = li32(this.i2 + 24);
                        this.i10 <<= this.i12;
                        this.i10 |= this.i13;
                        this.i12 = this.i2 + 24;
                        this.i13 = this.i9 + 1;
            ...
            case 5:
               ...
               §§goto(addr733);
            default:
               throw "Invalid state in _encode_mcu_DC_refine";
         }
         continue loop0;
      }
   }
