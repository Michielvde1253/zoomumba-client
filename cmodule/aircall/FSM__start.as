      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i2 += this.i0;
               this.i2 += 8;
               si32(this.i2,cmodule.aircall._environ);
               if(this.i1 >= 1)
               {
            ...
            case 1:
               mstate.esp += 4;
               mstate.esp -= 4;
               this.i0 = cmodule.aircall.__fini;
            ...
            case 2:
               mstate.esp += 4;
               this.i0 = cmodule.aircall.__2E_str1;
               this.i1 = 4;
               this.i3 = 1;
               log(this.i1,mstate.gworker.stringFromPtr(this.i0));
               si8(this.i3,cmodule.aircall.___mb_cur_max_2E_b);
               mstate.esp -= 8;
               this.i0 = cmodule.aircall._compressSingleSync_;
               si32(this.i2,mstate.esp);
               si32(this.i0,mstate.esp + 4);
               state = 3;
               mstate.esp -= 4;
               mstate.funcs[cmodule.aircall._AS3_Function]();
               return;
            case 3:
               this.i0 = mstate.eax;
               mstate.esp += 8;
               mstate.esp -= 8;
               this.i1 = cmodule.aircall._compressSingleAsync_;
               si32(this.i2,mstate.esp);
               si32(this.i1,mstate.esp + 4);
               state = 4;
               mstate.esp -= 4;
               mstate.funcs[cmodule.aircall._AS3_FunctionAsync]();
               return;
            case 4:
               this.i1 = mstate.eax;
               mstate.esp += 8;
               mstate.esp -= 12;
               this.i4 = cmodule.aircall.__2E_str3102;
               si32(this.i4,mstate.esp);
               si32(this.i0,mstate.esp + 4);
               si32(this.i1,mstate.esp + 8);
               state = 5;
               mstate.esp -= 4;
               mstate.funcs[cmodule.aircall._AS3_Object]();
               return;
            case 5:
               this.i4 = mstate.eax;
               mstate.esp += 12;
