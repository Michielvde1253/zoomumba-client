package cmodule.aircall
{
   ...
   public final class FSM_cmyk_ycck_convert extends Machine
   {
      public function FSM_cmyk_ycck_convert()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         _loc2_ = li32(_loc1_ + 348);
         _loc2_ = li32(_loc2_ + 8);
         _loc1_ = li32(_loc1_ + 28);
         _loc3_ = li32(cmodule.aircall.mstate.ebp + 24);
         ...
         if(_loc7_ >= 0)
         {
            ...
            if(_loc1_ != 0)
            {
               ...
               do
               {
                  ...
                  {
                     _loc17_ = li8(_loc13_);
                     _loc18_ = li8(_loc13_ + 1);
                     _loc19_ = li8(_loc13_ + 2);
                     _loc20_ = li8(_loc13_ + 3);
                     _loc18_ = 255 - _loc18_;
                     _loc17_ = 255 - _loc17_;
                     _loc19_ = 255 - _loc19_;
                     _loc18_ <<= 2;
                     _loc17_ <<= 2;
                     _loc21_ = _loc16_ + _loc11_;
                     _loc19_ <<= 2;
                     si8(_loc20_,_loc21_);
                     _loc18_ += _loc2_;
                     _loc20_ = _loc2_ + _loc17_;
                     _loc19_ += _loc2_;
                     _loc20_ = li32(_loc20_);
                     _loc21_ = li32(_loc18_ + 1024);
                     _loc22_ = li32(_loc19_ + 2048);
                     ...
                     si8(_loc20_,_loc21_);
                     _loc17_ += _loc2_;
                     _loc20_ = li32(_loc17_ + 3072);
                     _loc21_ = li32(_loc18_ + 4096);
                     _loc22_ = li32(_loc19_ + 5120);
                     _loc20_ = _loc21_ + _loc20_;
                     _loc20_ = _loc20_ + _loc22_;
                     _loc21_ = _loc14_ + _loc11_;
                     _loc20_ >>>= 16;
                     si8(_loc20_,_loc21_);
                     _loc17_ = li32(_loc17_ + 5120);
                     _loc18_ = li32(_loc18_ + 6144);
                     _loc19_ = li32(_loc19_ + 7168);
                  ...
                  while(uint(_loc11_) < uint(_loc1_));
