package cmodule.aircall
{
   ...
   public final class FSM_h2v2_downsample extends Machine
   {
      public function FSM_h2v2_downsample()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         _loc3_ = li32(_loc3_ + 232);
         _loc5_ = _loc2_ << 4;
         _loc6_ = li32(cmodule.aircall.mstate.ebp + 16);
         _loc7_ = li32(cmodule.aircall.mstate.ebp + 20);
         _loc5_ -= _loc4_;
         _loc8_ = _loc2_ << 3;
         if(_loc5_ >= 1)
         {
            if(_loc3_ >= 1)
            {
               ...
               if(_loc5_ >= 1)
               {
                  ...
                  while(_loc5_ += 1, _loc5_ < _loc3_);
                  
               }
            }
         }
         _loc2_ = li32(_loc1_ + 12);
         _loc1_ += 12;
         if(_loc8_ != 0)
         {
            if(_loc2_ >= 1)
            {
               ...
               do
               {
                  ...
                  while(uint(_loc10_) < uint(_loc8_));
