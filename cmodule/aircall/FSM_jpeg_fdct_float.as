package cmodule.aircall
{
   ...
   public final class FSM_jpeg_fdct_float extends Machine
   {
      public function FSM_jpeg_fdct_float()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         do
         {
            _loc4_ = 0.707107;
            _loc5_ = lf32(_loc3_);
            _loc6_ = lf32(_loc3_ + 28);
            _loc7_ = lf32(_loc3_ + 4);
            _loc8_ = lf32(_loc3_ + 24);
            _loc9_ = lf32(_loc3_ + 8);
            _loc10_ = lf32(_loc3_ + 20);
            _loc11_ = lf32(_loc3_ + 12);
            _loc12_ = lf32(_loc3_ + 16);
            ...
            sf32(_loc12_,_loc3_);
            _loc5_ = _loc5_;
            _loc4_ = _loc14_ - _loc4_;
            _loc9_ += _loc10_;
            _loc6_ += _loc8_;
            sf32(_loc5_,_loc3_ + 16);
            _loc5_ = _loc13_;
            _loc7_ = _loc7_;
            _loc8_ = _loc11_;
            ...
            _loc9_ = _loc9_;
            _loc6_ = _loc6_;
            sf32(_loc5_,_loc3_ + 8);
            _loc4_ = _loc4_;
            _loc5_ = _loc8_ - _loc7_;
            sf32(_loc4_,_loc3_ + 24);
            _loc4_ = _loc10_;
            _loc7_ = _loc9_;
            _loc6_ = _loc6_;
            _loc8_ = _loc6_ + _loc7_;
            sf32(_loc4_,_loc3_ + 20);
            _loc4_ = _loc5_;
            _loc5_ = _loc6_ - _loc7_;
            sf32(_loc4_,_loc3_ + 12);
            _loc4_ = _loc8_;
            sf32(_loc4_,_loc3_ + 4);
            _loc4_ = _loc5_;
            sf32(_loc4_,_loc3_ + 28);
            _loc3_ += 32;
            _loc1_ += 1;
         }
         while(_loc1_ != 8);
         ...
         do
         {
            _loc4_ = 0.707107;
            _loc5_ = lf32(_loc2_);
            _loc6_ = lf32(_loc2_ + 224);
            _loc7_ = lf32(_loc2_ + 32);
            _loc8_ = lf32(_loc2_ + 192);
            _loc9_ = lf32(_loc2_ + 64);
            _loc10_ = lf32(_loc2_ + 160);
            _loc11_ = lf32(_loc2_ + 96);
            _loc12_ = lf32(_loc2_ + 128);
            _loc13_ = _loc5_ - _loc6_;
            _loc14_ = _loc7_ - _loc8_;
            _loc15_ = _loc9_ - _loc10_;
            _loc16_ = _loc11_ - _loc12_;
            ...
            _loc9_ = _loc9_;
            _loc6_ = _loc6_;
            sf32(_loc5_,_loc2_ + 64);
            _loc4_ = _loc4_;
            _loc5_ = _loc8_ - _loc7_;
            sf32(_loc4_,_loc2_ + 192);
            _loc4_ = _loc10_;
            _loc7_ = _loc9_;
            _loc6_ = _loc6_;
            _loc8_ = _loc6_ + _loc7_;
            sf32(_loc4_,_loc2_ + 160);
            _loc4_ = _loc5_;
            _loc5_ = _loc6_ - _loc7_;
            sf32(_loc4_,_loc2_ + 96);
            _loc4_ = _loc8_;
            sf32(_loc4_,_loc2_ + 32);
            _loc4_ = _loc5_;
            sf32(_loc4_,_loc2_ + 224);
            _loc2_ += 4;
            _loc1_ += 1;
         }
         while(_loc1_ != 8);
