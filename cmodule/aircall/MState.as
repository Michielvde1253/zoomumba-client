package cmodule.aircall
{
   ...
   public class MState extends MemUser
   {
      ...
      public const syms:Object = cmodule.aircall.gstate == null ? {} : cmodule.aircall.gstate.syms;
      
      public const ds:ByteArray = cmodule.aircall.gstate == null || cmodule.aircall.gstate.ds == null ? GLEByteArrayProvider.get() : cmodule.aircall.gstate.ds;
      ...
      public var funcs:Vector.<Object> = cmodule.aircall.gstate == null ? new Vector.<Object>(1) : cmodule.aircall.gstate.funcs;
      
      public var edx:int;
      
      public var system:CSystem = cmodule.aircall.gstate == null ? null : cmodule.aircall.gstate.system;
      ...
      public function MState(param1:Machine)
      {
         ...
         if(cmodule.aircall.gstate == null)
         {
            this.ds.length += cmodule.aircall.gstackSize;
