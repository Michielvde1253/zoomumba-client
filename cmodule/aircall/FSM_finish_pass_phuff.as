package cmodule.aircall
{
   ...
   public final class FSM_finish_pass_phuff extends Machine
   {
      ...
      public function FSM_finish_pass_phuff()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_finish_pass_phuff = null;
         _loc1_ = new FSM_finish_pass_phuff();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               return;
            default:
               throw "Invalid state in _finish_pass_phuff";
         }
      }
   }
}
