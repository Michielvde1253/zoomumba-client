package cmodule.aircall
{
   ...
   public final class FSM_alloc_sarray extends Machine
   {
      ...
      public function FSM_alloc_sarray()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_alloc_sarray = null;
         _loc1_ = new FSM_alloc_sarray();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i3 = uint(999999988) / uint(this.i0);
            ...
            case 3:
               ...
               if(uint(this.i7) < uint(this.i5))
               {
                  ...
                  this.i3 = uint(this.i8) <= uint(this.i3) ? this.i8 : this.i3;
                  mstate.esp -= 12;
                  this.i8 = this.i3 * this.i0;
                  si32(this.i1,mstate.esp);
                  si32(this.i4,mstate.esp + 4);
                  si32(this.i8,mstate.esp + 8);
                  state = 3;
                  mstate.esp -= 4;
                  FSM_alloc_large.start();
                  return;
               }
               addr379:
               mstate.eax = this.i2;
               ...
               break;
            default:
               throw "Invalid state in _alloc_sarray";
         }
         this.i3 = this.i3 < this.i5 ? this.i3 : this.i5;
         si32(this.i3,this.i2 + 80);
         mstate.esp -= 12;
         this.i2 = this.i5 << 2;
         si32(this.i1,mstate.esp);
         si32(this.i4,mstate.esp + 4);
