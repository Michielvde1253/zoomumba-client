package cmodule.aircall
{
   ...
   public final class FSM_mbrtowc extends Machine
   {
      public function FSM_mbrtowc()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         _loc1_ = cmodule.aircall._mbs_2E_1855;
         _loc2_ = li32(cmodule.aircall.mstate.ebp + 20);
         _loc1_ = _loc2_ == 0 ? _loc1_ : _loc2_;
         _loc2_ = li32(_loc1_ + 4);
         _loc3_ = _loc1_ + 4;
         _loc4_ = li32(cmodule.aircall.mstate.ebp + 8);
         _loc5_ = li32(cmodule.aircall.mstate.ebp + 12);
         _loc6_ = li32(cmodule.aircall.mstate.ebp + 16);
         _loc7_ = _loc1_;
         if(uint(_loc2_) >= uint(7))
         {
            _loc1_ = 22;
            addr128:
            si32(_loc1_,cmodule.aircall._val_2E_1440);
            _loc1_ = -1;
            addr179:
         ...
         {
            _loc8_ = cmodule.aircall.__2E_str45;
            _loc8_ = _loc5_ == 0 ? _loc8_ : _loc5_;
            _loc6_ = _loc5_ == 0 ? 1 : _loc6_;
            _loc4_ = _loc5_ == 0 ? 0 : _loc4_;
            if(_loc6_ == 0)
            {
               _loc1_ = -2;
               §§goto(addr179);
               ...
               if(_loc2_ == 0)
               {
                  ...
                  else
                  {
                     ...
                     if(_loc2_ == 0)
                     {
                        ...
                        _loc11_ = uint(_loc6_) <= uint(_loc5_) ? _loc6_ : _loc5_;
                        ...
                        else
                        {
                           ...
                           {
                              _loc11_ = li8(_loc8_);
                              _loc12_ = _loc11_ & 0xC0;
                              if(_loc12_ == 128)
                              {
                                 break;
                              }
                              _loc2_ = 86;
                              si32(_loc2_,cmodule.aircall._val_2E_1440);
                              _loc2_ = -1;
                              cmodule.aircall.mstate.eax = _loc2_;
                           }
                           addr448:
                        }
                        addr521:
