package cmodule.aircall
{
   ...
   public final class FSM_free_pool extends Machine
   {
      ...
      {
         var _loc1_:FSM_free_pool = null;
         _loc1_ = new FSM_free_pool();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i3 = li32(this.i2 + 52);
               si32(this.i0,this.i2 + 52);
               if(this.i3 == 0)
               {
                  break;
               }
            ...
            case 5:
               ...
               break;
            default:
               throw "Invalid state in _free_pool";
         }
