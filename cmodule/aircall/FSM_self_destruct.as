package cmodule.aircall
{
   ...
   public final class FSM_self_destruct extends Machine
   {
      ...
      public function FSM_self_destruct()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_self_destruct = null;
         _loc1_ = new FSM_self_destruct();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               return;
            default:
               throw "Invalid state in _self_destruct";
         }
         mstate.esp -= 8;
