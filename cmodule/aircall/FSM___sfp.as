      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               mstate.esp -= 0;
               this.i0 = li8(cmodule.aircall.___sdidinit_2E_b);
               if(this.i0 == 0)
               {
                  this.i0 = cmodule.aircall._usual;
                  this.i1 = cmodule.aircall._usual_extra;
                  this.i2 = 0;
                  this.i0 += 56;
                  do
                  {
                  ...
                  this.i0 = 1;
                  si8(this.i0,cmodule.aircall.___cleanup_2E_b);
                  si8(this.i0,cmodule.aircall.___sdidinit_2E_b);
                  this.i0 = cmodule.aircall.___sglue;
               }
               else
               {
                  this.i0 = cmodule.aircall.___sglue;
            ...
            case 1:
               ...
               else
               {
                  ...
                  do
                  {
                     this.i2 = cmodule.aircall._empty_2E_3904;
                     this.i5 = this.i0;
                     this.i6 = 88;
                     memcpy(this.i5,this.i2,this.i6);
                     si32(this.i1,this.i0 + 56);
                     this.i2 = this.i1;
                     this.i5 = cmodule.aircall._emptyx_2E_3905;
                     this.i6 = 148;
               ...
               if(this.i3 != 0)
               {
                  this.i4 = li32(cmodule.aircall._lastglue);
                  si32(this.i3,this.i4);
                  si32(this.i3,cmodule.aircall._lastglue);
