package cmodule.aircall
{
   ...
   public final class FSM_rgb_ycc_start extends Machine
   {
      ...
      public function FSM_rgb_ycc_start()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_rgb_ycc_start = null;
         _loc1_ = new FSM_rgb_ycc_start();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 1:
               ...
               return;
            default:
               throw "Invalid state in _rgb_ycc_start";
         }
      }
   }
}
