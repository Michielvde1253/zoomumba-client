      ...
      override protected function createChildren() : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            if(_loc5_)
            {
               ...
               _loc8_ = 0;
               _loc9_ = int(_loc1_.mx_internal::visibleColumns.length);
               _loc10_ = 0;
               while(_loc10_ < _loc9_)
               {
                  _loc12_ = _loc1_.mx_internal::visibleColumns[_loc10_];
                  _loc13_ = _loc1_.mx_internal::getRenderer(_loc12_,_loc7_,true);
                  _loc14_ = _loc12_.itemToLabel(_loc7_);
                  if(_loc1_.mx_internal::_rootModel && _loc12_.mx_internal::colNum == 0 && _loc1_.mx_internal::_rootModel.canHaveChildren(_loc7_))
                  {
                     if(_loc1_.mx_internal::_rootModel is IGroupingCollection && Boolean(IGroupingCollection(_loc1_.mx_internal::_rootModel).grouping))
                     {
                        _loc17_ = IGroupingCollection(_loc1_.mx_internal::_rootModel).grouping.label;
                     }
                     if(_loc1_.mx_internal::_rootModel is IGroupingCollection2 && Boolean(IGroupingCollection2(_loc1_.mx_internal::_rootModel).grouping))
                     {
                        _loc17_ = IGroupingCollection2(_loc1_.mx_internal::_rootModel).grouping.label;
                     }
                     if(_loc1_.groupLabelFunction != null)
                     {
                        _loc14_ = _loc1_.groupLabelFunction(_loc7_,_loc12_);
                     }
                     else if(_loc17_ != null && Boolean(_loc7_.hasOwnProperty(_loc17_)))
                     {
                        _loc14_ = _loc7_[_loc17_];
                     }
                  }
                  _loc15_ = new AdvancedDataGridListData(_loc14_,_loc12_.dataField,_loc12_.mx_internal::colNum,"",_loc1_);
                  ...
                  _loc16_ = _loc1_.mx_internal::getWidthOfItem(_loc13_,_loc12_,_loc10_);
                  _loc13_.setActualSize(_loc16_,_loc5_.height);
                  _loc13_.move(_loc8_,0);
                  _loc8_ += _loc16_;
                  if(_loc1_.rendererProviders.length != 0)
                  {
                     _loc18_ = _loc1_.mx_internal::getRendererDescription(_loc7_,_loc12_,true);
                     if((Boolean(_loc18_)) && Boolean(_loc18_.renderer))
                     {
                        if(_loc18_.columnSpan == 0)
                        {
                           break;
                        }
                        _loc10_ += _loc18_.columnSpan - 1;
                     }
                  }
                  _loc10_++;
               }
