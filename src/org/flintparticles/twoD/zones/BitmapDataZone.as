package org.flintparticles.twoD.zones
{
   ...
   public class BitmapDataZone implements Zone2D
   {
      ...
      public function BitmapDataZone(param1:BitmapData = null, param2:Number = 0, param3:Number = 0, param4:Number = 1, param5:Number = 1)
      {
         super();
      ...
      public function invalidate() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this._bitmapData.width)
         {
            _loc2_ = 0;
            while(_loc2_ < this._bitmapData.height)
            {
               _loc3_ = this._bitmapData.getPixel32(_loc1_,_loc2_);
               _loc4_ = (_loc3_ >> 24 & 0xFF) / 255;
               if(_loc4_ != 0)
               {
                  this._validPoints.add(new Point(_loc1_,_loc2_),_loc4_);
               }
               _loc2_++;
            }
            _loc1_++;
