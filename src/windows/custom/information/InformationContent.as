package windows.custom.information
{
   ...
   public class InformationContent extends Group implements IBindingClient
   {
      ...
      public function InformationContent()
      {
         ...
         super();
         bindings = this._InformationContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_information_InformationContentWatcherSetupUtil");
         ...
         {
            return InformationContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.percentWidth = 100;
         this.percentHeight = 100;
         this.mxmlContent = [this._InformationContent_InnerGroup1_c(),this._InformationContent_OuterGroup1_c()];
         i = 0;
      ...
      {
         InformationContent._watcherSetupUtil = param1;
      }
      ...
      private function _InformationContent_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._InformationContent_Group2_c()];
         if(!_loc1_.document)
         {
      ...
      private function _InformationContent_Group2_c() : Group
      {
         ...
         _loc1_.top = 120;
         _loc1_.bottom = 65;
         _loc1_.mxmlContent = [this._InformationContent_Text1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _InformationContent_Text1_i() : Text
      {
      ...
      private function _InformationContent_OuterGroup1_c() : OuterGroup
      {
         var _loc1_:OuterGroup = new OuterGroup();
         _loc1_.mxmlContent = [this._InformationContent_WindowHeader1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _InformationContent_WindowHeader1_i() : WindowHeader
      {
      ...
      private function _InformationContent_bindingsSetup() : Array
      {
         var result:Array = [];
