package windows.custom.friends
{
   ...
   public class FriendsContent extends Group implements IBindingClient
   {
      ...
      public function FriendsContent()
      {
         ...
         super();
         bindings = this._FriendsContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_friends_FriendsContentWatcherSetupUtil");
         ...
         {
            return FriendsContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._FriendsContent_TabsHGroup1_c()];
         i = 0;
      ...
      {
         FriendsContent._watcherSetupUtil = param1;
      }
      ...
      private function _FriendsContent_TabsHGroup1_c() : TabsHGroup
      {
         var _loc1_:TabsHGroup = new TabsHGroup();
         _loc1_.gap = 2;
         _loc1_.selectedIndex = 1;
         _loc1_.horizontalAlign = "center";
         _loc1_.mxmlContent = [this._FriendsContent_TabButton1_i(),this._FriendsContent_TabButton2_i(),this._FriendsContent_TabButton3_i(),this._FriendsContent_TabButton4_i()];
         if(!_loc1_.document)
         {
      ...
      private function _FriendsContent_TabButton1_i() : TabButton
      {
      ...
      private function _FriendsContent_TabButton2_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 1;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _FriendsContent_TabButton3_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 2;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _FriendsContent_TabButton4_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 3;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _FriendsContent_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():*
         {
            return FriendsContentCardGroup;
         ...
         {
            return SelectFriendInvitationContent;
