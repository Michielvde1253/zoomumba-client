package windows.custom.valentines
{
   ...
   public class ValentineRewardContent extends Group implements IBindingClient
   {
      ...
      public function ValentineRewardContent()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         super();
         bindings = this._ValentineRewardContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_valentines_ValentineRewardContentWatcherSetupUtil");
         ...
         {
            return ValentineRewardContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._ValentineRewardContent_InnerGroup1_c(),this._ValentineRewardContent_OuterGroup1_c()];
         i = 0;
      ...
      {
         ValentineRewardContent._watcherSetupUtil = param1;
      }
      ...
      private function _ValentineRewardContent_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._ValentineRewardContent_StandardImage1_i(),this._ValentineRewardContent_StandardText1_i(),this._ValentineRewardContent_GradientText1_i()];
         if(!_loc1_.document)
         {
      ...
      private function _ValentineRewardContent_StandardImage1_i() : StandardImage
      {
      ...
      private function _ValentineRewardContent_StandardText1_i() : StandardText
      {
      ...
      private function _ValentineRewardContent_GradientText1_i() : GradientText
      {
      ...
      private function _ValentineRewardContent_OuterGroup1_c() : OuterGroup
      {
         var _loc1_:OuterGroup = new OuterGroup();
         _loc1_.mxmlContent = [this._ValentineRewardContent_WindowHeader1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ValentineRewardContent_WindowHeader1_i() : WindowHeader
      {
      ...
      private function _ValentineRewardContent_bindingsSetup() : Array
      {
         var result:Array = [];
