package windows.custom.shop
{
   ...
   public class ShopContent extends Group implements IBindingClient
   {
      ...
      private var _3552067tab8:TabButton;
      ...
      public function ShopContent()
      {
         ...
         super();
         bindings = this._ShopContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_shop_ShopContentWatcherSetupUtil");
         ...
         {
            return ShopContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._ShopContent_TabsHGroup1_c()];
         i = 0;
      ...
      {
         ShopContent._watcherSetupUtil = param1;
      }
      ...
      private function _ShopContent_TabsHGroup1_c() : TabsHGroup
      {
         var _loc1_:TabsHGroup = new TabsHGroup();
         _loc1_.gap = 2;
         _loc1_.selectedIndex = 1;
         _loc1_.mxmlContent = [this._ShopContent_TabButton1_i(),this._ShopContent_TabButton2_i(),this._ShopContent_TabButton3_i(),this._ShopContent_TabButton4_i(),this._ShopContent_TabButton5_i(),this._ShopContent_TabButton6_i(),this._ShopContent_TabButton7_i(),this._ShopContent_TabButton8_i()];
         if(!_loc1_.document)
         {
      ...
      private function _ShopContent_TabButton1_i() : TabButton
      {
      ...
      private function _ShopContent_TabButton2_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 1;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _ShopContent_TabButton3_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 2;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _ShopContent_TabButton4_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 3;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _ShopContent_TabButton5_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 4;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _ShopContent_TabButton6_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 5;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _ShopContent_TabButton7_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 6;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
      ...
      private function _ShopContent_TabButton8_i() : TabButton
      {
         var _loc1_:TabButton = new TabButton();
         _loc1_.index = 7;
         _loc1_.setStyle("skinClass",TabButtonTinySkin);
         ...
         this.tab8 = _loc1_;
         BindingManager.executeBindings(this,"tab8",this.tab8);
         return _loc1_;
      }
      
      private function _ShopContent_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():*
         {
            return ShopContentCardGroup;
      ...
      [Bindable(event="propertyChange")]
      public function get tab8() : TabButton
      {
         return this._3552067tab8;
      }
      
      public function set tab8(param1:TabButton) : void
      {
         var _loc2_:Object = this._3552067tab8;
         if(_loc2_ !== param1)
         {
            this._3552067tab8 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"tab8",_loc2_,param1));
            }
         }
      }
   }
