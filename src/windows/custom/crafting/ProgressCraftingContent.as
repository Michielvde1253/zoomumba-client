package windows.custom.crafting
{
   ...
   public class ProgressCraftingContent extends Group implements IBindingClient
   {
      ...
      private var _2019624170previewBackground:SpriteVisualElement;
      
      private var _1291554719previewIcon:SpriteVisualElement;
      ...
      private var _111576390uschi:StandardImage;
      ...
      public function ProgressCraftingContent()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         this._embed_mxml__general_Decorations_swf_WoodLath_894941931 = ProgressCraftingContent__embed_mxml__general_Decorations_swf_WoodLath_894941931;
         this.mx_internal::_bindings = [];
         this.mx_internal::_watchers = [];
         this.mx_internal::_bindingsByDestination = {};
         this.mx_internal::_bindingsBeginWithWord = {};
         super();
         bindings = this._ProgressCraftingContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_crafting_ProgressCraftingContentWatcherSetupUtil");
         ...
         {
            return ProgressCraftingContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._ProgressCraftingContent_InnerGroup1_c(),this._ProgressCraftingContent_OuterGroup1_c()];
         i = 0;
      ...
      {
         ProgressCraftingContent._watcherSetupUtil = param1;
      }
      ...
      private function _ProgressCraftingContent_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._ProgressCraftingContent_WindowHeader1_i(),this._ProgressCraftingContent_VGroup1_c(),this._ProgressCraftingContent_Group3_c(),this._ProgressCraftingContent_Group4_i(),this._ProgressCraftingContent_Group6_i()];
         if(!_loc1_.document)
         {
      ...
      private function _ProgressCraftingContent_WindowHeader1_i() : WindowHeader
      {
         var _loc1_:WindowHeader = new WindowHeader();
         _loc1_.text = "#Crafting#";
         _loc1_.fontSize = 20;
         _loc1_.bgScale = 1.1;
         _loc1_.bgLeft = -40;
      ...
      private function _ProgressCraftingContent_VGroup1_c() : VGroup
      {
         ...
         _loc1_.right = 55;
         _loc1_.gap = 0;
         _loc1_.mxmlContent = [this._ProgressCraftingContent_VGroup2_c(),this._ProgressCraftingContent_BitmapImage1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_VGroup2_c() : VGroup
      {
         var _loc1_:VGroup = new VGroup();
         ...
         _loc1_.gap = 5;
         _loc1_.height = 120;
         _loc1_.mxmlContent = [this._ProgressCraftingContent_StandardText1_i(),this._ProgressCraftingContent_HGroup1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_StandardText1_i() : StandardText
      {
         var _loc1_:StandardText = new StandardText();
         _loc1_.text = "#You\'re currently carfting!#";
      ...
      private function _ProgressCraftingContent_HGroup1_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.verticalAlign = "middle";
         _loc1_.mxmlContent = [this._ProgressCraftingContent_HGroup2_c(),this._ProgressCraftingContent_VGroup3_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_HGroup2_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.width = 170;
         ...
         _loc1_.mxmlContent = [this._ProgressCraftingContent_Group2_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_Group2_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._ProgressCraftingContent_SpriteVisualElement1_i(),this._ProgressCraftingContent_SpriteVisualElement2_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_SpriteVisualElement1_i() : SpriteVisualElement
      {
         var _loc1_:SpriteVisualElement = new SpriteVisualElement();
         _loc1_.initialized(this,"previewBackground");
         this.previewBackground = _loc1_;
         BindingManager.executeBindings(this,"previewBackground",this.previewBackground);
         return _loc1_;
      }
      
      private function _ProgressCraftingContent_SpriteVisualElement2_i() : SpriteVisualElement
      {
         var _loc1_:SpriteVisualElement = new SpriteVisualElement();
         _loc1_.initialized(this,"previewIcon");
         this.previewIcon = _loc1_;
         BindingManager.executeBindings(this,"previewIcon",this.previewIcon);
         return _loc1_;
      }
      
      private function _ProgressCraftingContent_VGroup3_c() : VGroup
      {
         var _loc1_:VGroup = new VGroup();
         _loc1_.gap = 0;
         _loc1_.horizontalCenter = "center";
         _loc1_.mxmlContent = [this._ProgressCraftingContent_StandardText2_i(),this._ProgressCraftingContent_LabelDisplay1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_StandardText2_i() : StandardText
      {
         var _loc1_:StandardText = new StandardText();
      ...
      private function _ProgressCraftingContent_LabelDisplay1_i() : LabelDisplay
      {
      ...
      private function _ProgressCraftingContent_BitmapImage1_c() : BitmapImage
      {
      ...
      private function _ProgressCraftingContent_Group3_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.x = 109;
         _loc1_.y = 194;
         _loc1_.mxmlContent = [this._ProgressCraftingContent_StandardImage1_i(),this._ProgressCraftingContent_StandardImage2_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_StandardImage1_i() : StandardImage
      {
      ...
      private function _ProgressCraftingContent_StandardImage2_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
      ...
      private function _ProgressCraftingContent_Group4_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.x = 96;
         _loc1_.y = 275;
         _loc1_.width = 350;
         _loc1_.mxmlContent = [this._ProgressCraftingContent_Group5_c(),this._ProgressCraftingContent_GradientText1_i(),this._ProgressCraftingContent_StandardText3_i(),this._ProgressCraftingContent_LabelDisplay2_i(),this._ProgressCraftingContent_Button1_i()];
      ...
      private function _ProgressCraftingContent_Group5_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.x = -56;
         _loc1_.y = -18;
         _loc1_.mxmlContent = [this._ProgressCraftingContent_StandardImage3_i(),this._ProgressCraftingContent_StandardImage4_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_StandardImage3_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
         _loc1_.id = "shadow3";
         if(!_loc1_.document)
      ...
      private function _ProgressCraftingContent_StandardImage4_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
         _loc1_.currentState = "imageFree";
         _loc1_.displayScale = 1;
         _loc1_.y = -25;
         _loc1_.id = "sprite3";
         if(!_loc1_.document)
         {
      ...
      private function _ProgressCraftingContent_GradientText1_i() : GradientText
      {
      ...
      private function _ProgressCraftingContent_StandardText3_i() : StandardText
      {
         var _loc1_:StandardText = new StandardText();
      ...
      private function _ProgressCraftingContent_LabelDisplay2_i() : LabelDisplay
      {
         var _loc1_:LabelDisplay = new LabelDisplay();
         _loc1_.x = 8;
         _loc1_.y = -21;
      ...
      private function _ProgressCraftingContent_Button1_i() : Button
      {
      ...
      private function _ProgressCraftingContent_Group6_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.x = 144;
         _loc1_.y = 0;
         _loc1_.width = 350;
         _loc1_.mxmlContent = [this._ProgressCraftingContent_Group7_c(),this._ProgressCraftingContent_GradientText2_i(),this._ProgressCraftingContent_StandardText4_i(),this._ProgressCraftingContent_Button2_i(),this._ProgressCraftingContent_Counter1_i()];
      ...
      private function _ProgressCraftingContent_Group7_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.x = 150;
         _loc1_.y = 280;
         _loc1_.mxmlContent = [this._ProgressCraftingContent_StandardImage5_i(),this._ProgressCraftingContent_StandardImage6_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_StandardImage5_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
         _loc1_.id = "shadow2";
         if(!_loc1_.document)
      ...
      private function _ProgressCraftingContent_StandardImage6_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
         _loc1_.currentState = "imageFree";
         _loc1_.horizontalCenter = 0;
      ...
      private function _ProgressCraftingContent_GradientText2_i() : GradientText
      {
         var _loc1_:GradientText = new GradientText();
         _loc1_.text = "#Use elixir#";
         _loc1_.x = 178;
      ...
      private function _ProgressCraftingContent_StandardText4_i() : StandardText
      {
         var _loc1_:StandardText = new StandardText();
         _loc1_.text = "#Use elixir to reduce breeding time by 50%#";
         _loc1_.percentWidth = 100;
      ...
      private function _ProgressCraftingContent_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.width = 165;
         _loc1_.x = 174;
      ...
      private function _ProgressCraftingContent_Counter1_i() : Counter
      {
      ...
      private function _ProgressCraftingContent_OuterGroup1_c() : OuterGroup
      {
         var _loc1_:OuterGroup = new OuterGroup();
         _loc1_.mxmlContent = [this._ProgressCraftingContent_StandardImage7_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProgressCraftingContent_StandardImage7_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
         _loc1_.x = 21;
         _loc1_.y = 23;
      ...
      private function _ProgressCraftingContent_bindingsSetup() : Array
      {
         var result:Array = [];
      ...
      [Bindable(event="propertyChange")]
      public function get previewBackground() : SpriteVisualElement
      {
         return this._2019624170previewBackground;
      }
      
      public function set previewBackground(param1:SpriteVisualElement) : void
      {
         var _loc2_:Object = this._2019624170previewBackground;
         if(_loc2_ !== param1)
         {
            this._2019624170previewBackground = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"previewBackground",_loc2_,param1));
            }
         }
      }
      
      [Bindable(event="propertyChange")]
      public function get previewIcon() : SpriteVisualElement
      {
         return this._1291554719previewIcon;
      }
      
      public function set previewIcon(param1:SpriteVisualElement) : void
      {
         var _loc2_:Object = this._1291554719previewIcon;
         if(_loc2_ !== param1)
         {
            this._1291554719previewIcon = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"previewIcon",_loc2_,param1));
            }
         }
      }
      ...
      [Bindable(event="propertyChange")]
      public function get uschi() : StandardImage
      {
         return this._111576390uschi;
      }
      
      public function set uschi(param1:StandardImage) : void
      {
