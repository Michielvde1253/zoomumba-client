package windows.skin
{
   ...
   public class Window40Skin extends Skin implements IBindingClient, IStateClient2
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _Window40Skin_BitmapFill1:BitmapFill;
      
      public var _Window40Skin_HGroup2:HGroup;
      ...
      private var _embed_mxml__windows_Borders_swf_Border40_993269591:Class;
      ...
      public function Window40Skin()
      {
         ...
         this._embed_mxml__windows_Borders_swf_Border40_993269591 = Window40Skin__embed_mxml__windows_Borders_swf_Border40_993269591;
         this._embed_mxml__general_Decorations_swf_LoaderProgress_1407024497 = Window40Skin__embed_mxml__general_Decorations_swf_LoaderProgress_1407024497;
         this.mx_internal::_bindings = [];
         this.mx_internal::_watchers = [];
         this.mx_internal::_bindingsByDestination = {};
         this.mx_internal::_bindingsBeginWithWord = {};
         super();
         bindings = this._Window40Skin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_skin_Window40SkinWatcherSetupUtil");
         ...
         {
            return Window40Skin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._Window40Skin_SpriteVisualElement1_i(),this._Window40Skin_Group1_i()];
      ...
      {
         Window40Skin._watcherSetupUtil = param1;
      }
      ...
      private function _Window40Skin_SpriteVisualElement1_i() : SpriteVisualElement
      {
      ...
      private function _Window40Skin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._Window40Skin_Group2_c(),this._Window40Skin_Group3_i(),this._Window40Skin_BitmapImage1_i(),this._Window40Skin_Group4_i(),this._Window40Skin_HGroup1_i(),this._Window40Skin_Image1_i(),this._Window40Skin_Button1_i(),this._Window40Skin_HGroup2_i(),this._Window40Skin_HGroup3_c()];
         _loc1_.id = "viewport";
         if(!_loc1_.document)
         {
      ...
      private function _Window40Skin_Group2_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._Window40Skin_Path1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _Window40Skin_Path1_c() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.data = "M574 37 583 347 552 390 31 396 0 349 5 55 45 14 532 0 574 37";
         _loc1_.fill = this._Window40Skin_BitmapFill1_i();
         _loc1_.initialized(this,null);
         BindingManager.executeBindings(this,"temp",_loc1_);
         return _loc1_;
      }
      
      private function _Window40Skin_BitmapFill1_i() : BitmapFill
      {
         var _loc1_:BitmapFill = new BitmapFill();
         _loc1_.fillMode = "repeat";
         _loc1_.scaleX = 1;
         _loc1_.scaleY = 1;
         this._Window40Skin_BitmapFill1 = _loc1_;
         BindingManager.executeBindings(this,"_Window40Skin_BitmapFill1",this._Window40Skin_BitmapFill1);
         return _loc1_;
      }
      
      private function _Window40Skin_Group3_i() : Group
      {
         var _loc1_:Group = new Group();
      ...
      private function _Window40Skin_BitmapImage1_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.source = this._embed_mxml__windows_Borders_swf_Border40_993269591;
      ...
      private function _Window40Skin_Group4_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
      ...
      private function _Window40Skin_HGroup1_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.percentWidth = 100;
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalAlign = "top";
         _loc1_.mxmlContent = [this._Window40Skin_UIComponent1_i()];
      ...
      private function _Window40Skin_UIComponent1_i() : UIComponent
      {
      ...
      private function _Window40Skin_Image1_i() : Image
      {
      ...
      private function _Window40Skin_Button1_i() : Button
      {
      ...
      private function _Window40Skin_HGroup2_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalAlign = "top";
         _loc1_.mxmlContent = [this._Window40Skin_LoaderImage1_i()];
         _loc1_.id = "_Window40Skin_HGroup2";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._Window40Skin_HGroup2 = _loc1_;
         BindingManager.executeBindings(this,"_Window40Skin_HGroup2",this._Window40Skin_HGroup2);
         return _loc1_;
      }
      
      private function _Window40Skin_LoaderImage1_i() : LoaderImage
      {
      ...
      private function _Window40Skin_HGroup3_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.y = 386;
         ...
         _loc1_.percentHeight = 100;
         _loc1_.x = 0;
         _loc1_.mxmlContent = [this._Window40Skin_Button2_i(),this._Window40Skin_Button3_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _Window40Skin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
      ...
      private function _Window40Skin_Button3_i() : Button
      {
         var _loc1_:Button = new Button();
      ...
      private function _Window40Skin_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():Number
         {
            return WindowConstants.WIDTH_SKIN_40;
         },null,"viewport.width");
         result[1] = new Binding(this,function():Number
         {
            return WindowConstants.HEIGHT_SKIN_40;
         },null,"viewport.height");
         result[2] = new Binding(this,function():Object
         {
            return hostComponent.backgroundPattern;
         },null,"_Window40Skin_BitmapFill1.source");
         result[3] = new Binding(this,function():Number
         {
            return -header.height / 8;
         },null,"_Window40Skin_HGroup2.y");
         return result;
      }
