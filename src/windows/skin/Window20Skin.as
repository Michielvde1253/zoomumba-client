package windows.skin
{
   ...
   public class Window20Skin extends Skin implements IBindingClient, IStateClient2
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _Window20Skin_BitmapFill1:BitmapFill;
      
      public var _Window20Skin_HGroup2:HGroup;
      ...
      private var _embed_mxml__windows_Borders_swf_Border20_993268881:Class;
      ...
      public function Window20Skin()
      {
         ...
         this._embed_mxml__general_Decorations_swf_LoaderProgress_1407024497 = Window20Skin__embed_mxml__general_Decorations_swf_LoaderProgress_1407024497;
         this._embed_mxml__windows_Borders_swf_Border20_993268881 = Window20Skin__embed_mxml__windows_Borders_swf_Border20_993268881;
         this.mx_internal::_bindings = [];
         this.mx_internal::_watchers = [];
         this.mx_internal::_bindingsByDestination = {};
         this.mx_internal::_bindingsBeginWithWord = {};
         super();
         bindings = this._Window20Skin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_skin_Window20SkinWatcherSetupUtil");
         ...
         {
            return Window20Skin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._Window20Skin_SpriteVisualElement1_i(),this._Window20Skin_Group1_i()];
      ...
      {
         Window20Skin._watcherSetupUtil = param1;
      }
      ...
      private function _Window20Skin_SpriteVisualElement1_i() : SpriteVisualElement
      {
      ...
      private function _Window20Skin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._Window20Skin_Group2_c(),this._Window20Skin_Group3_i(),this._Window20Skin_BitmapImage1_i(),this._Window20Skin_Group4_i(),this._Window20Skin_HGroup1_i(),this._Window20Skin_Image1_i(),this._Window20Skin_Button1_i(),this._Window20Skin_HGroup2_i(),this._Window20Skin_HGroup3_c()];
         _loc1_.id = "viewport";
         if(!_loc1_.document)
         {
      ...
      private function _Window20Skin_Group2_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._Window20Skin_Path1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _Window20Skin_Path1_c() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.data = "M393 22 411 202 402 287 367 310 28 310 8 279 0 132 13 37 46 13 353 0 393 22";
         _loc1_.fill = this._Window20Skin_BitmapFill1_i();
         _loc1_.initialized(this,null);
         BindingManager.executeBindings(this,"temp",_loc1_);
         return _loc1_;
      }
      
      private function _Window20Skin_BitmapFill1_i() : BitmapFill
      {
         var _loc1_:BitmapFill = new BitmapFill();
         _loc1_.fillMode = "repeat";
         _loc1_.scaleX = 1;
         _loc1_.scaleY = 1;
         this._Window20Skin_BitmapFill1 = _loc1_;
         BindingManager.executeBindings(this,"_Window20Skin_BitmapFill1",this._Window20Skin_BitmapFill1);
         return _loc1_;
      }
      
      private function _Window20Skin_Group3_i() : Group
      {
         var _loc1_:Group = new Group();
      ...
      private function _Window20Skin_BitmapImage1_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.source = this._embed_mxml__windows_Borders_swf_Border20_993268881;
      ...
      private function _Window20Skin_Group4_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
      ...
      private function _Window20Skin_HGroup1_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalAlign = "top";
         _loc1_.mxmlContent = [this._Window20Skin_UIComponent1_i()];
      ...
      private function _Window20Skin_UIComponent1_i() : UIComponent
      {
      ...
      private function _Window20Skin_Image1_i() : Image
      {
      ...
      private function _Window20Skin_Button1_i() : Button
      {
      ...
      private function _Window20Skin_HGroup2_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalAlign = "top";
         _loc1_.mxmlContent = [this._Window20Skin_LoaderImage1_i()];
         _loc1_.id = "_Window20Skin_HGroup2";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._Window20Skin_HGroup2 = _loc1_;
         BindingManager.executeBindings(this,"_Window20Skin_HGroup2",this._Window20Skin_HGroup2);
         return _loc1_;
      }
      
      private function _Window20Skin_LoaderImage1_i() : LoaderImage
      {
      ...
      private function _Window20Skin_HGroup3_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         ...
         _loc1_.x = 0;
         _loc1_.y = 294;
         _loc1_.mxmlContent = [this._Window20Skin_Button2_i(),this._Window20Skin_Button3_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _Window20Skin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
      ...
      private function _Window20Skin_Button3_i() : Button
      {
         var _loc1_:Button = new Button();
      ...
      private function _Window20Skin_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():Number
         {
            return WindowConstants.WIDTH_SKIN_20;
         },null,"viewport.width");
         result[1] = new Binding(this,function():Number
         {
            return WindowConstants.HEIGHT_SKIN_20;
         },null,"viewport.height");
         result[2] = new Binding(this,function():Object
         {
            return hostComponent.backgroundPattern;
         },null,"_Window20Skin_BitmapFill1.source");
         result[3] = new Binding(this,function():Number
         {
            return -header.height / 8;
         },null,"_Window20Skin_HGroup2.y");
         return result;
      }
