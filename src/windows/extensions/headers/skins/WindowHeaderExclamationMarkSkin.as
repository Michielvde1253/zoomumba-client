package windows.extensions.headers.skins
{
   ...
   public class WindowHeaderExclamationMarkSkin extends Skin implements IBindingClient
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _WindowHeaderExclamationMarkSkin_Group1:Group;
      ...
      private var _embed_mxml__windows_Headers_swf_ExclamationMark_1098338173:Class;
      ...
      public function WindowHeaderExclamationMarkSkin()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         this._embed_mxml__general_Patterns_swf_HPatternLine_1769938539 = WindowHeaderExclamationMarkSkin__embed_mxml__general_Patterns_swf_HPatternLine_1769938539;
         this._embed_mxml__windows_Headers_swf_ExclamationMark_1098338173 = WindowHeaderExclamationMarkSkin__embed_mxml__windows_Headers_swf_ExclamationMark_1098338173;
         this.mx_internal::_bindings = [];
         this.mx_internal::_watchers = [];
         this.mx_internal::_bindingsByDestination = {};
         this.mx_internal::_bindingsBeginWithWord = {};
         super();
         bindings = this._WindowHeaderExclamationMarkSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_extensions_headers_skins_WindowHeaderExclamationMarkSkinWatcherSetupUtil");
         ...
         {
            return WindowHeaderExclamationMarkSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._WindowHeaderExclamationMarkSkin_Group1_i(),this._WindowHeaderExclamationMarkSkin_BitmapImage1_i(),this._WindowHeaderExclamationMarkSkin_BitmapImage2_i(),this._WindowHeaderExclamationMarkSkin_BitmapImage3_i()];
         i = 0;
      ...
      {
         WindowHeaderExclamationMarkSkin._watcherSetupUtil = param1;
      }
      ...
      private function _WindowHeaderExclamationMarkSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.top = 0;
         _loc1_.right = 0;
         _loc1_.mxmlContent = [this._WindowHeaderExclamationMarkSkin_Text1_i()];
         _loc1_.id = "_WindowHeaderExclamationMarkSkin_Group1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._WindowHeaderExclamationMarkSkin_Group1 = _loc1_;
         BindingManager.executeBindings(this,"_WindowHeaderExclamationMarkSkin_Group1",this._WindowHeaderExclamationMarkSkin_Group1);
         return _loc1_;
      }
      
      private function _WindowHeaderExclamationMarkSkin_Text1_i() : Text
      {
      ...
      private function _WindowHeaderExclamationMarkSkin_BitmapImage1_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.y = -45;
         _loc1_.source = this._embed_mxml__windows_Headers_swf_ExclamationMark_1098338173;
      ...
      private function _WindowHeaderExclamationMarkSkin_BitmapImage2_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.left = 0;
         _loc1_.height = 8;
      ...
      private function _WindowHeaderExclamationMarkSkin_BitmapImage3_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.right = 0;
         _loc1_.height = 8;
      ...
      private function _WindowHeaderExclamationMarkSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():Number
         {
            return WindowHeader.TOP_DISTANCE;
         },null,"_WindowHeaderExclamationMarkSkin_Group1.height");
         result[1] = new Binding(this,function():Object
         {
            return WindowHeader.LEFT_WIDTH + WindowHeader.HORIZONTAL_GAP * 0.75;
         },null,"_WindowHeaderExclamationMarkSkin_Group1.left");
         ...
         {
            return WindowHeader.LEFT_WIDTH - 10;
         },null,"sign.x");
