package windows.extensions.headers.skins
{
   ...
   public class WindowHeaderQuestionMarkSkin extends Skin implements IBindingClient
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _WindowHeaderQuestionMarkSkin_Group1:Group;
      ...
      private var _embed_mxml__windows_Headers_swf_QuestionMark_156708788:Class;
      ...
      public function WindowHeaderQuestionMarkSkin()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         this._embed_mxml__windows_Headers_swf_QuestionMark_156708788 = WindowHeaderQuestionMarkSkin__embed_mxml__windows_Headers_swf_QuestionMark_156708788;
         this._embed_mxml__general_Patterns_swf_HPatternLine_1769938539 = WindowHeaderQuestionMarkSkin__embed_mxml__general_Patterns_swf_HPatternLine_1769938539;
         this.mx_internal::_bindings = [];
         this.mx_internal::_watchers = [];
         this.mx_internal::_bindingsByDestination = {};
         this.mx_internal::_bindingsBeginWithWord = {};
         super();
         bindings = this._WindowHeaderQuestionMarkSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_extensions_headers_skins_WindowHeaderQuestionMarkSkinWatcherSetupUtil");
         ...
         {
            return WindowHeaderQuestionMarkSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._WindowHeaderQuestionMarkSkin_Group1_i(),this._WindowHeaderQuestionMarkSkin_BitmapImage1_i(),this._WindowHeaderQuestionMarkSkin_BitmapImage2_i(),this._WindowHeaderQuestionMarkSkin_BitmapImage3_i()];
         i = 0;
      ...
      {
         WindowHeaderQuestionMarkSkin._watcherSetupUtil = param1;
      }
      ...
      private function _WindowHeaderQuestionMarkSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.top = 0;
         _loc1_.right = 0;
         _loc1_.mxmlContent = [this._WindowHeaderQuestionMarkSkin_Text1_i()];
         _loc1_.id = "_WindowHeaderQuestionMarkSkin_Group1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._WindowHeaderQuestionMarkSkin_Group1 = _loc1_;
         BindingManager.executeBindings(this,"_WindowHeaderQuestionMarkSkin_Group1",this._WindowHeaderQuestionMarkSkin_Group1);
         return _loc1_;
      }
      
      private function _WindowHeaderQuestionMarkSkin_Text1_i() : Text
      {
      ...
      private function _WindowHeaderQuestionMarkSkin_BitmapImage1_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.y = -45;
         _loc1_.source = this._embed_mxml__windows_Headers_swf_QuestionMark_156708788;
      ...
      private function _WindowHeaderQuestionMarkSkin_BitmapImage2_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.left = 0;
         _loc1_.height = 8;
      ...
      private function _WindowHeaderQuestionMarkSkin_BitmapImage3_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.right = 0;
         _loc1_.height = 8;
      ...
      private function _WindowHeaderQuestionMarkSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():Number
         {
            return WindowHeader.TOP_DISTANCE;
         },null,"_WindowHeaderQuestionMarkSkin_Group1.height");
         result[1] = new Binding(this,function():Object
         {
            return WindowHeader.LEFT_WIDTH + WindowHeader.HORIZONTAL_GAP;
         },null,"_WindowHeaderQuestionMarkSkin_Group1.left");
         ...
         {
            return WindowHeader.LEFT_WIDTH - 22;
         },null,"sign.x");
