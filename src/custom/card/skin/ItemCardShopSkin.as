package custom.card.skin
{
   ...
   public class ItemCardShopSkin extends Skin implements IBindingClient
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _ItemCardShopSkin_StandardText1:StandardText;
      ...
      public function ItemCardShopSkin()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         super();
         bindings = this._ItemCardShopSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_custom_card_skin_ItemCardShopSkinWatcherSetupUtil");
         ...
         {
            return ItemCardShopSkin[param1];
         },bindings,watchers);
         ...
         this.height = 170;
         this.maxHeight = 170;
         this.mxmlContent = [this._ItemCardShopSkin_CardBackground1_i(),this._ItemCardShopSkin_CardNail1_i(),this._ItemCardShopSkin_VGroup1_c(),this._ItemCardShopSkin_Group6_c(),this._ItemCardShopSkin_CardBuyButton1_i(),this._ItemCardShopSkin_CardActionButton1_i()];
         i = 0;
      ...
      {
         ItemCardShopSkin._watcherSetupUtil = param1;
      }
      ...
      private function _ItemCardShopSkin_CardBackground1_i() : CardBackground
      {
      ...
      private function _ItemCardShopSkin_CardNail1_i() : CardNail
      {
      ...
      private function _ItemCardShopSkin_VGroup1_c() : VGroup
      {
         ...
         _loc1_.left = 7;
         _loc1_.gap = 0;
         _loc1_.mxmlContent = [this._ItemCardShopSkin_Group1_c(),this._ItemCardShopSkin_Group2_c(),this._ItemCardShopSkin_Group5_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ItemCardShopSkin_Group1_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.minHeight = 20;
         _loc1_.maxHeight = 20;
         _loc1_.mxmlContent = [this._ItemCardShopSkin_CardTop1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ItemCardShopSkin_CardTop1_i() : CardTop
      {
      ...
      private function _ItemCardShopSkin_Group2_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._ItemCardShopSkin_Group3_c(),this._ItemCardShopSkin_Group4_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ItemCardShopSkin_Group3_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.left = 0;
         _loc1_.percentHeight = 100;
      ...
      private function _ItemCardShopSkin_Group4_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.right = 0;
         _loc1_.percentHeight = 100;
         _loc1_.minWidth = 20;
         _loc1_.maxWidth = 20;
         _loc1_.mxmlContent = [this._ItemCardShopSkin_CardRight1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ItemCardShopSkin_CardRight1_i() : CardRight
      {
      ...
      private function _ItemCardShopSkin_Group5_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.minHeight = 20;
      ...
      private function _ItemCardShopSkin_Group6_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.width = 116.5;
         ...
         _loc1_.top = 20;
         _loc1_.left = 7;
         _loc1_.mxmlContent = [this._ItemCardShopSkin_StandardText1_i(),this._ItemCardShopSkin_Group7_i(),this._ItemCardShopSkin_CardBottom1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ItemCardShopSkin_StandardText1_i() : StandardText
      {
         ...
         _loc1_.id = "_ItemCardShopSkin_StandardText1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._ItemCardShopSkin_StandardText1 = _loc1_;
         BindingManager.executeBindings(this,"_ItemCardShopSkin_StandardText1",this._ItemCardShopSkin_StandardText1);
         return _loc1_;
      }
      
      private function _ItemCardShopSkin_Group7_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.verticalCenter = 2;
         _loc1_.horizontalCenter = 0;
         _loc1_.mxmlContent = [this._ItemCardShopSkin_CardDecoBack1_i(),this._ItemCardShopSkin_SpriteVisualElement1_i(),this._ItemCardShopSkin_CardDecoPossible1_i(),this._ItemCardShopSkin_CardDecoLocked1_i(),this._ItemCardShopSkin_CardDecoReady1_i()];
         _loc1_.id = "content";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ItemCardShopSkin_CardDecoBack1_i() : CardDecoBack
      {
      ...
      private function _ItemCardShopSkin_SpriteVisualElement1_i() : SpriteVisualElement
      {
      ...
      private function _ItemCardShopSkin_CardDecoPossible1_i() : CardDecoPossible
      {
      ...
      private function _ItemCardShopSkin_CardDecoLocked1_i() : CardDecoLocked
      {
      ...
      private function _ItemCardShopSkin_CardDecoReady1_i() : CardDecoReady
      {
      ...
      private function _ItemCardShopSkin_CardBottom1_i() : CardBottom
      {
      ...
      private function _ItemCardShopSkin_CardBuyButton1_i() : CardBuyButton
      {
      ...
      private function _ItemCardShopSkin_CardActionButton1_i() : CardActionButton
      {
      ...
      private function _ItemCardShopSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         },null,"_ItemCardShopSkin_StandardText1.text");
         return result;
      }
