package mx.accessibility
{
   ...
   public class AdvancedDataGridAccImpl extends ListBaseAccImpl
   {
      ...
      {
         AdvancedDataGrid.mx_internal::createAccessibilityImplementation = mx_internal::createAccessibilityImplementation;
         return true;
      }
      ...
      override public function get_accRole(param1:uint) : uint
      {
         ...
         if(_loc2_.mx_internal::headerIndex != -1)
         {
            return 25;
         }
         if(_loc2_.selectionMode == "singleCell")
         {
            ...
            if(_loc3_)
            {
               if(_loc2_.dataProvider is IHierarchicalCollectionView && _loc3_.columnIndex == _loc2_.treeColumn.mx_internal::colNum)
               {
      ...
      override public function get_accValue(param1:uint) : String
      {
         ...
         if(param1 != 0 && _loc5_.dataProvider is IHierarchicalCollectionView)
         {
            ...
            _loc2_ = _loc5_.mx_internal::getItemDepth(_loc3_,_loc4_ - _loc5_.verticalScrollPosition) + "";
         }
         return _loc2_;
      }
      ...
      override public function get_accState(param1:uint) : uint
      {
         ...
         var _loc2_:AdvancedDataGrid = AdvancedDataGrid(master);
         var _loc3_:uint = uint(getState(param1));
         if(param1 > 0)
         {
            if(_loc2_.mx_internal::headerIndex != -1)
            {
               return uint(_loc3_ | (STATE_SYSTEM_SELECTABLE | STATE_SYSTEM_SELECTED | STATE_SYSTEM_FOCUSED));
            }
            _loc6_ = int(param1 - 1);
            if(_loc2_.editable.length == 0 || _loc2_.editedItemPosition == null)
            {
               ...
               if(_loc2_.selectionMode == "singleCell")
               {
                  ...
                  if(_loc7_)
                  {
                     _loc4_ = int(_loc7_.rowIndex);
                  }
               }
               if(_loc4_ < _loc2_.verticalScrollPosition || _loc4_ >= _loc2_.verticalScrollPosition + _loc2_.rowCount)
               {
                  _loc3_ |= STATE_SYSTEM_OFFSCREEN | STATE_SYSTEM_INVISIBLE;
               }
               else
               {
                  _loc3_ |= STATE_SYSTEM_SELECTABLE;
                  ...
                  if(_loc2_.dataProvider is IHierarchicalCollectionView)
                  {
                     ...
                     if((Boolean(_loc9_)) && _loc8_.source.canHaveChildren(_loc9_))
                     {
                        if(_loc2_.selectionMode != "singleCell" || _loc7_ && _loc7_.columnIndex == _loc2_.treeColumn.mx_internal::colNum)
                        {
                           if(_loc2_.isItemOpen(_loc9_))
                           {
                              _loc3_ |= STATE_SYSTEM_EXPANDED;
                           }
                           else
                           {
                              _loc3_ |= STATE_SYSTEM_COLLAPSED;
                           }
                        }
                     }
                  }
                  if(_loc2_.selectionMode == "singleCell")
                  {
                     ...
                     {
                        _loc3_ |= STATE_SYSTEM_SELECTED | STATE_SYSTEM_FOCUSED;
                     }
                  }
                  else if(Boolean(_loc10_) && _loc2_.isItemSelected(_loc10_.data))
                  {
                     _loc3_ |= STATE_SYSTEM_SELECTED | STATE_SYSTEM_FOCUSED;
                  }
               }
      ...
      override public function get_accDefaultAction(param1:uint) : String
      {
         ...
         if(!(_loc2_.dataProvider is IHierarchicalCollectionView) || _loc5_ != _loc2_.treeColumn.mx_internal::colNum)
         {
      ...
      override public function accDoDefaultAction(param1:uint) : void
      {
         ...
         if(param1 > 0)
         {
            ...
            if(_loc2_.mx_internal::headerIndex != -1)
            {
               ...
               _loc6_.columnIndex = _loc2_.mx_internal::headerIndex;
               _loc6_.dataField = _loc2_.columns[_loc2_.mx_internal::headerIndex].dataField;
      ...
      override public function getChildIDArray() : Array
      {
         ...
         if(_loc2_.dataProvider)
         {
            ...
            {
               _loc3_ = int(_loc2_.dataProvider.length);
            }
            else
            {
      ...
      override public function accLocation(param1:uint) : *
      {
         ...
         if(_loc2_.mx_internal::headerIndex != -1)
         {
            return _loc2_.mx_internal::selectedHeaderInfo.headerItem;
         }
         if(_loc2_.editable.length == 0 || _loc2_.editedItemPosition == null)
         {
            if(_loc2_.selectionMode == "singleCell" && _loc2_.selectedCells.length > 0)
            {
               ...
               if(_loc6_)
               {
                  _loc4_ = int(_loc6_.rowIndex);
                  _loc5_ = int(_loc6_.columnIndex);
               }
            }
            else
            {
      ...
      override public function get_accSelection() : Array
      {
         ...
         {
            _loc3_ = int(_loc1_.selectedCells.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
      ...
      override public function get_accFocus() : uint
      {
         ...
         var _loc5_:int = 0;
         var _loc1_:AdvancedDataGrid = AdvancedDataGrid(master);
         if(_loc1_.mx_internal::headerIndex != -1)
         {
            if(_loc1_.selectionMode == "singleCell")
            {
               _loc2_ = _loc1_.columns.length * _loc1_.dataProvider.length + _loc1_.mx_internal::headerIndex + 1;
            }
            else
            {
               _loc2_ = _loc1_.dataProvider.length + _loc1_.mx_internal::headerIndex + 1;
            }
            return _loc2_;
         }
      ...
      override protected function getName(param1:uint) : String
      {
         ...
         var _loc2_:AdvancedDataGrid = AdvancedDataGrid(master);
         if(param1 != 0 && _loc2_.mx_internal::headerIndex != -1)
         {
            return this.getValueForHeader(_loc2_);
         }
         ...
         if(param1 > 0)
         {
               ...
               else
               {
                  ...
                  if(_loc2_.selectionMode == "singleCell")
                  {
                     ...
                     if(_loc6_ < 0 || _loc7_ < 0)
                     {
                        ...
                        _loc6_ = int(_loc14_.rowIndex);
                        _loc7_ = int(_loc14_.columnIndex);
                     }
                     _loc13_ = ", Row " + (_loc6_ + 1);
                     ...
                     _loc4_ += _loc9_[_loc7_].headerText + ": " + _loc9_[_loc7_].itemToLabel(_loc8_);
                  }
                  else
                  {
                     ...
                     while(_loc11_ < _loc10_)
                     {
                        ...
                        _loc4_ += " " + _loc9_[_loc11_].headerText + ": " + _loc9_[_loc11_].itemToLabel(_loc8_);
                        _loc11_++;
                     }
                  }
               }
            ...
            else
            {
               ...
               else
               {
                  ...
                  _loc4_ += ", Editing " + _loc16_ + ": " + _loc15_;
               }
            }
            if(_loc2_.dataProvider is IHierarchicalCollectionView)
            {
               ...
               if(Boolean(_loc8_) && _loc17_.source.canHaveChildren(_loc8_))
               {
                  if(_loc12_)
                  {
         ...
         switch(param1.type)
         {
            case "change":
               ...
               if(_loc2_.mx_internal::headerIndex != -1)
               {
                  if(_loc2_.selectionMode == "singleCell")
                  {
                     _loc5_ = _loc2_.columns.length * _loc2_.dataProvider.length + _loc2_.mx_internal::headerIndex + 1;
                  }
                  else
                  {
                     _loc5_ = _loc2_.dataProvider.length + _loc2_.mx_internal::headerIndex + 1;
                  }
                  _loc6_ = true;
               }
      ...
      {
         var _loc2_:IViewCursor = AdvancedDataGrid(master).mx_internal::collectionIterator;
      ...
      private function getMOfN(param1:Object) : String
      {
         ...
         {
            _loc8_ = ICollectionView(_loc2_.mx_internal::collectionIterator.view).createCursor();
      ...
      private function getValueForHeader(param1:AdvancedDataGrid) : String
      {
         ...
         var _loc10_:* = null;
         var _loc3_:AdvancedDataGridHeaderInfo = param1.mx_internal::selectedHeaderInfo;
         ...
         _loc2_ = _loc4_.headerText + ": Column " + (param1.mx_internal::headerIndex + 1);
         if(param1.mx_internal::columnGrouping)
         {
            _loc10_ = "";
            if(_loc3_.children)
            {
