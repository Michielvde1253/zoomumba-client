package mx.collections
{
   ...
   public class HierarchicalCollectionView extends EventDispatcher implements IHierarchicalCollectionView, IXMLNotifiable
   {
      ...
      {
         return new HierarchicalCollectionViewCursor(this,this.mx_internal::treeData,this.hierarchicalData);
      }
      ...
      public function disableAutoUpdate() : void
      {
         ...
         this.mx_internal::treeData.disableAutoUpdate();
      ...
      {
         var _loc1_:Object = null;
         this.mx_internal::treeData.enableAutoUpdate();
         for(_loc1_ in this.childrenMap)
         {
      ...
      public function getNodeDepth(param1:Object) : int
      {
         ...
         _loc2_ = this.hasRoot && !this.showRoot ? _loc2_ - 1 : _loc2_;
      ...
      public function getParentItem(param1:Object) : *
      {
         ...
         if(this.mx_internal::parentMap.hasOwnProperty(_loc2_))
         {
            return this.mx_internal::parentMap[_loc2_];
         }
         return undefined;
      }
      ...
      public function getChildren(param1:Object) : ICollectionView
      {
         ...
         if(_loc3_ is XMLList && Boolean(_loc4_))
         {
            XMLListCollection(_loc4_).mx_internal::dispatchResetEvent = false;
      ...
      public function closeNode(param1:Object) : void
      {
         ...
         if(childrenCollection)
         {
            ...
            while(!cursor.afterLast)
            {
               ...
               delete this.mx_internal::parentMap[uid];
               try
               {
                  cursor.moveNext();
               }
      ...
      public function addChild(param1:Object, param2:Object) : Boolean
      {
         if(param1 == null)
         {
            return this.addChildAt(param1,param2,this.mx_internal::treeData.length);
         }
      ...
      public function removeChild(param1:Object, param2:Object) : Boolean
      {
         ...
         if(parent == null)
         {
            cursor = this.mx_internal::treeData.createCursor();
         }
         else
         {
      ...
      public function removeChildAt(param1:Object, param2:int) : Boolean
      {
         ...
         if(Boolean(cursor.beforeFirst) || Boolean(cursor.afterLast))
         {
            return false;
         }
         cursor.remove();
      ...
      private function initializeCollection(param1:Object, param2:IHierarchicalData, param3:Object = null) : void
      {
         ...
         this.mx_internal::parentMap = {};
         this.childrenMap = new Dictionary(true);
         this.childrenMapCache = new Dictionary(true);
         if(this.mx_internal::treeData)
         {
            this.mx_internal::treeData.removeEventListener(CollectionEvent.COLLECTION_CHANGE,this.collectionChangeHandler,false);
         }
         if(this.hierarchicalData)
         {
            this.hierarchicalData.removeEventListener(CollectionEvent.COLLECTION_CHANGE,this.collectionChangeHandler,false);
         }
         this.mx_internal::treeData = this.getCollection(param1);
         if(this.mx_internal::treeData)
         {
            this._hasRoot = this.mx_internal::treeData.length == 1;
         }
         var _loc4_:Object = param1;
         if(param2 && !this.showRoot && this.hasRoot)
         {
            _loc5_ = this.mx_internal::treeData.createCursor().current;
            if(param2.hasChildren(_loc5_))
            {
               _loc4_ = param2.getChildren(_loc5_);
               this.mx_internal::treeData = this.getCollection(_loc4_);
            }
         }
         this.mx_internal::treeData.addEventListener(CollectionEvent.COLLECTION_CHANGE,this.collectionChangeHandler,false,EventPriority.DEFAULT_HANDLER,true);
      ...
      private function updateParentMapAndLength(param1:ICollectionView, param2:Object) : void
      {
         ...
         this.currentLength += collection.length;
         while(!cursor.afterLast)
         {
            item = cursor.current;
            uid = UIDUtil.getUID(item);
            this.mx_internal::parentMap[uid] = node;
      ...
      public function calculateLength(param1:Object = null, param2:Object = null) : int
      {
         ...
         if(node == null)
         {
            modelCursor = this.mx_internal::treeData.createCursor();
            if(modelCursor.beforeFirst)
            {
               return this.mx_internal::treeData.length;
            }
            while(!modelCursor.afterLast)
            {
               ...
               if(node is XML)
               {
                  if(firstNode)
                  {
                     ...
                     if(parNode != null)
                     {
                        ...
                        this.childrenMap[parNode] = this.mx_internal::treeData;
               ...
               {
                  length += mx_internal::treeData.length - modelOffset;
                  return length;
               }
            }
         }
         else
         {
            ...
            this.mx_internal::parentMap[uid] = parent;
               ...
               if(childNodes != null)
               {
                  ...
                  try
                  {
                     ...
                     while(!childCursor.afterLast)
                     {
                        ...
                        length += this.calculateLength(childCursor.current,node) + 1;
                        modelOffset++;
                        try
                        {
      ...
      private function internalRefresh(param1:Boolean) : Boolean
      {
         ...
         if(!(this.mx_internal::treeData.filterFunction == null && this.filterFunction == null))
         {
            this.mx_internal::treeData.filterFunction = this.filterFunction;
            this.mx_internal::treeData.refresh();
            _loc4_ = true;
         }
         for each(_loc2_ in this.openNodes)
         {
            _loc3_ = this.getChildren(_loc2_);
            if(Boolean(_loc3_) && !(_loc3_.filterFunction == null && this.filterFunction == null))
            {
               _loc3_.filterFunction = this.filterFunction;
               _loc3_.refresh();
               _loc4_ = true;
         ...
         if(this.sortCanBeApplied(this.mx_internal::treeData) && !(this.mx_internal::treeData.sort == null && this.sort == null))
         {
            this.mx_internal::treeData.sort = this.sort;
            this.mx_internal::treeData.refresh();
            param1 = true;
         }
         for each(_loc2_ in this.openNodes)
      ...
      private function getVisibleLocation(param1:int) : int
      {
         ...
         newLocation = 0;
         var modelCursor:IViewCursor = this.mx_internal::treeData.createCursor();
         var i:int = 0;
      ...
      public function collectionChangeHandler(param1:CollectionEvent) : void
      {
         ...
         if(param1 is CollectionEvent)
         {
            ...
            else if(_loc10_.kind == CollectionEventKind.ADD)
            {
               ...
               this.currentLength += _loc9_.items.length;
               ...
               while(_loc2_ < _loc3_)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     if(this._openNodes[UIDUtil.getUID(_loc6_)] != null)
                     {
                        ...
                        this.mx_internal::parentMap[_loc5_] = _loc6_;
                        delete this.mx_internal::parentMap[UIDUtil.getUID(_loc7_)];
                     }
                  }
                  _loc2_++;
               }
               ...
               case "nodeAdded":
                  for(_loc13_ in this.childrenMap)
                  {
                     if(_loc13_ === param1)
                     {
                        ...
                        {
                           if(this.childrenMap[_loc13_] === this.mx_internal::treeData)
                           {
                              _loc9_ = this.mx_internal::treeData as XMLListCollection;
                  ...
                  for(_loc14_ in this.childrenMap)
                  {
                     if(_loc14_ === param1)
                     {
                        ...
                        if((Boolean(_loc12_)) && !_loc12_.busy())
                        {
                           ...
                           if(this.childrenMap[_loc14_] === this.mx_internal::treeData)
                           {
                              _loc9_ = this.mx_internal::treeData as XMLListCollection;
                              if(this.parentNode)
                              {
