package mx.flash
{
   ...
   public dynamic class UIMovieClip extends MovieClip implements IDeferredInstantiationUIComponent, IToolTipManagerClient, IStateClient, IFocusManagerComponent, IConstraintClient, IAutomationObject, IVisualElement, ILayoutElement, IFlexModule
   {
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? super.x : Number(this.mx_internal::_layoutFeatures.layoutX);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? super.y : Number(this.mx_internal::_layoutFeatures.layoutY);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? super.z : Number(this.mx_internal::_layoutFeatures.layoutZ);
      }
      ...
      public function set designLayer(param1:DesignLayer) : void
      {
         ...
         super.visible = !!this._designLayer ? this._visible && Boolean(this._designLayer.effectiveVisibility) : this._visible;
      }
      
      public function get maxHeight() : Number
      {
         return isNaN(this.explicitMaxHeight) ? 10000 : this.explicitMaxHeight;
      }
      ...
      {
         return isNaN(this.explicitMaxWidth) ? 10000 : this.explicitMaxWidth;
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? 1 : Number(this.mx_internal::_layoutFeatures.layoutScaleX);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? 1 : Number(this.mx_internal::_layoutFeatures.layoutScaleY);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? super.scaleZ : Number(this.mx_internal::_layoutFeatures.layoutScaleZ);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? 0 : Number(this.mx_internal::_layoutFeatures.depth);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? 0 : Number(this.mx_internal::_layoutFeatures.transformX);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? 0 : Number(this.mx_internal::_layoutFeatures.transformY);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? 0 : Number(this.mx_internal::_layoutFeatures.transformZ);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? super.rotation : Number(this.mx_internal::_layoutFeatures.layoutRotationZ);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? super.rotationX : Number(this.mx_internal::_layoutFeatures.layoutRotationX);
      }
      ...
      {
         return this.mx_internal::_layoutFeatures == null ? super.rotationY : Number(this.mx_internal::_layoutFeatures.layoutRotationY);
      }
      ...
      {
         return !!this.mx_internal::_layoutFeatures ? Boolean(this.mx_internal::_layoutFeatures.layoutIs3D) : false;
      }
      
      public function get is3D() : Boolean
      {
         return !!this.mx_internal::_layoutFeatures ? Boolean(this.mx_internal::_layoutFeatures.is3D) : false;
      }
      ...
      public function transformAround(param1:Vector3D, param2:Vector3D = null, param3:Vector3D = null, param4:Vector3D = null, param5:Vector3D = null, param6:Vector3D = null, param7:Vector3D = null, param8:Boolean = true) : void
      {
         ...
         if(this.mx_internal::_layoutFeatures == null)
         {
            _loc10_ = param2 != null && (!isNaN(param2.x) && param2.x != 1 || !isNaN(param2.y) && param2.y != 1 || !isNaN(param2.z) && param2.z != 1) || param3 != null && (!isNaN(param3.x) && param3.x != 0 || !isNaN(param3.y) && param3.y != 0 || !isNaN(param3.z) && param3.z != 0) || param4 != null && param4.z != 0 && !isNaN(param4.z) || param5 != null || param6 != null || param7 != null;
            if(_loc10_)
            {
               this.initAdvancedLayoutFeatures();
            }
         ...
         else
         {
            ...
            else
            {
               ...
               xformPt.x = param1.x;
               xformPt.y = param1.y;
               _loc11_ = this.transform.matrix.transformPoint(xformPt);
               if(param4 != null)
               {
                  this.x += param4.x - _loc11_.x;
                  this.y += param4.y - _loc11_.y;
               }
               else
               {
                  _loc12_ = this.transform.matrix.transformPoint(xformPt);
                  this.x += _loc12_.x - _loc11_.x;
                  this.y += _loc12_.y - _loc11_.y;
               }
            }
         }
         if(!param8)
      ...
      public function transformPointToParent(param1:Vector3D, param2:Vector3D, param3:Vector3D) : void
      {
         ...
         else
         {
            ...
            _loc4_ = this.transform.matrix.transformPoint(xformPt);
            if(param2 != null)
            {
               param2.x = _loc4_.x;
               param2.y = _loc4_.y;
      ...
      {
         if(this.boundingBoxName && this.boundingBoxName != "" && this.boundingBoxName in this && Boolean(this[this.boundingBoxName]))
         {
      ...
      public function set currentState(param1:String) : void
      {
         ...
         if(this.stateMap[param1])
         {
            ...
            {
               _loc3_ = Number(this.stateMap[_loc2_].frame);
               _loc4_ = Number(this.stateMap[this._currentState + "-" + param1 + ":end"].frame);
            }
            if(isNaN(_loc3_))
            {
               ...
               {
                  _loc3_ = Number(this.stateMap[_loc2_].frame);
                  _loc4_ = Number(this.stateMap[param1 + "-" + this._currentState + ":start"].frame);
               }
            }
            if(isNaN(_loc3_))
            {
               ...
               {
                  _loc3_ = Number(this.stateMap[_loc2_].frame);
                  _loc4_ = Number(this.stateMap["*-" + param1 + ":end"].frame);
               }
            }
            if(isNaN(_loc3_))
            {
               ...
               {
                  _loc3_ = Number(this.stateMap[_loc2_].frame);
                  _loc4_ = Number(this.stateMap[param1 + "-*:start"].frame);
               }
            }
            if(isNaN(_loc3_))
            {
               ...
               {
                  _loc3_ = Number(this.stateMap[_loc2_].frame);
                  _loc4_ = Number(this.stateMap[this._currentState + "-*:end"].frame);
               }
            }
            if(isNaN(_loc3_))
            {
               ...
               {
                  _loc3_ = Number(this.stateMap[_loc2_].frame);
                  _loc4_ = Number(this.stateMap["*-" + this._currentState + ":start"].frame);
               }
            }
            if(isNaN(_loc3_))
            {
               ...
               {
                  _loc3_ = Number(this.stateMap[_loc2_].frame);
                  _loc4_ = Number(this.stateMap["*-*:end"].frame);
               }
            }
            if(isNaN(_loc3_) && param1 in this.stateMap)
            {
               _loc3_ = Number(this.stateMap[param1].frame);
            }
            if(isNaN(_loc3_))
            {
               return;
            ...
            else
            {
               ...
               this.transitionDirection = _loc4_ > _loc3_ ? 1 : -1;
      ...
      public function setActualSize(param1:Number, param2:Number) : void
      {
         ...
         if(_loc3_ != 1 || _loc4_ != 1 || this.mx_internal::_layoutFeatures != null)
         {
            if(this.mx_internal::_layoutFeatures == null)
            {
               this.initAdvancedLayoutFeatures();
            }
            this.mx_internal::_layoutFeatures.stretchX = _loc3_;
            this.mx_internal::_layoutFeatures.stretchY = _loc4_;
            this.invalidateTransform();
         }
      ...
      protected function autoUpdateMeasuredSizeEnterFrameHandler(param1:Event) : void
      {
         ...
         if(this.mx_internal::_layoutFeatures != null)
         {
            _loc2_.width *= this.mx_internal::_layoutFeatures.stretchX;
            _loc2_.height *= this.mx_internal::_layoutFeatures.stretchY;
         }
      ...
      private function creationCompleteHandler(param1:Event) : void
      {
         ...
         else if(Boolean(this.parentDocument) && Boolean(this.parentDocument.systemManager))
         {
            try
            {
