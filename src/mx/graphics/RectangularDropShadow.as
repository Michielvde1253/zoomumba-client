   ...
   public class RectangularDropShadow
   {
      ...
      public function drawShadow(param1:Graphics, param2:Number, param3:Number, param4:Number, param5:Number) : void
      {
         ...
         if(Boolean(this.leftShadow) || Boolean(this.topShadow))
         {
            ...
            param1.beginBitmapFill(this.shadow,_loc14_);
         ...
         if(this.leftShadow)
         {
            _loc14_.tx = param2 - _loc6_;
            _loc14_.ty = 0;
            param1.beginBitmapFill(this.leftShadow,_loc14_);
         ...
         if(this.rightShadow)
         {
            ...
            _loc14_.ty = 0;
            param1.beginBitmapFill(this.rightShadow,_loc14_);
         ...
         if(this.topShadow)
         {
            _loc14_.tx = 0;
            _loc14_.ty = param3 - _loc8_;
            param1.beginBitmapFill(this.topShadow,_loc14_);
         ...
         if(this.bottomShadow)
         {
            ...
            param1.beginBitmapFill(this.bottomShadow,_loc14_);
