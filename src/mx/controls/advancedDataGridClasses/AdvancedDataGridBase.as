package mx.controls.advancedDataGridClasses
{
   ...
   public class AdvancedDataGridBase extends AdvancedListBase implements IFontContextComponent
   {
      ...
      override protected function makeRowsAndColumns(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:int, param7:Boolean = false, param8:uint = 0) : Point
      {
         ...
         var _loc14_:int = 0;
         if(!this.mx_internal::visibleColumns || this.mx_internal::visibleColumns.length == 0)
         {
      ...
      override protected function adjustListContent(param1:Number = -1, param2:Number = -1) : void
      {
         ...
         this.mx_internal::listSubContent.setActualSize(listContent.width,listContent.height);
      }
      ...
      override protected function createChildren() : void
      {
         ...
         if(!this.mx_internal::listSubContent)
         {
            this.mx_internal::listSubContent = new AdvancedListBaseContentHolder(this);
            this.mx_internal::listSubContent.styleName = this;
            listContent.addChild(this.mx_internal::listSubContent);
         }
      }
      ...
      protected function createHeaders(param1:Number, param2:Number) : void
      {
         ...
         if(!this.headerItems[0] || !this.headerItems[0][0] || param2 < this.headerItems[0][0].y + this.headerItems[0][0].height)
         {
            ...
            _loc11_ = int(this.headerInfos.length);
            _loc10_ = 0;
            ...
            while(this.currentColNum < _loc13_.length)
            {
               ...
               _loc9_ = AdvancedDataGridListData(this.makeListData(_loc8_,uid,-1,_loc8_.mx_internal::colNum,_loc8_));
               ...
               this.headerInfos[_loc8_.mx_internal::colNum].headerItem = _loc6_;
               _loc6_.explicitWidth = _loc4_ = _loc8_.width;
               UIComponentGlobals.mx_internal::layoutManager.validateClient(_loc6_,true);
               this.currentRowHeight = _loc6_.getExplicitOrMeasuredHeight();
               _loc6_.setActualSize(_loc4_,this.mx_internal::_explicitHeaderHeight ? this.mx_internal::_headerHeight - mx_internal::cachedPaddingTop - mx_internal::cachedPaddingBottom : this.currentRowHeight);
               _loc6_.move(_loc3_,this.currentItemTop + mx_internal::cachedPaddingTop);
               _loc3_ += _loc4_;
               _loc5_ = Math.ceil(Math.max(_loc5_,this.mx_internal::_explicitHeaderHeight ? this.mx_internal::_headerHeight : this.currentRowHeight + mx_internal::cachedPaddingBottom + mx_internal::cachedPaddingTop));
               _loc12_ = Math.max(_loc12_,this.mx_internal::_explicitHeaderHeight ? this.mx_internal::_headerHeight - mx_internal::cachedPaddingTop - mx_internal::cachedPaddingBottom : this.currentRowHeight);
               _loc6_.visible = this.mx_internal::headerVisible;
               ++this.currentColNum;
            }
            if(this.headerItems[this.currentRowNum])
            {
               _loc11_ = int(this.headerItems[this.currentRowNum].length);
               _loc10_ = 0;
               while(_loc10_ < _loc11_)
               {
            ...
            if(this.mx_internal::headerVisible)
            {
               this.currentItemTop += !!_loc6_ ? _loc5_ : 0;
            }
            if(!this.mx_internal::_explicitHeaderHeight)
            {
               this.mx_internal::_headerHeight = !!_loc6_ ? _loc5_ : 0;
            }
         }
      }
      ...
      protected function createLockedRows(param1:Number, param2:Number, param3:Number, param4:Number) : void
      {
         ...
         {
            this.currentRowNum = 0;
            if(Boolean(numLocked) && Boolean(iterator))
            {
      ...
      {
         if(Boolean(param1) && this.currentColNum == 0)
         {
      ...
      override protected function moveSelectionVertically(param1:uint, param2:Boolean, param3:Boolean) : void
      {
         ...
         switch(param1)
         {
            ...
            case Keyboard.DOWN:
               ...
               else if(caretIndex == collection.length - 1 && Boolean(_loc9_))
               {
      ...
      {
         var _loc4_:IFactory = this.mx_internal::columnItemRendererFactory(param1,param2,param3);
      ...
      override mx_internal function mouseEventToItemRendererOrEditor(param1:MouseEvent) : IListItemRenderer
      {
         ...
         if(_loc2_ == listContent)
         {
            ...
            _loc4_ = rowInfo.length == 0 ? 0 : Number(rowInfo[0].y);
            ...
            while(_loc6_ < _loc5_)
            {
               if(listItems[_loc6_].length)
               {
                  ...
                  {
                     _loc7_ = 0;
                     _loc8_ = int(listItems[_loc6_].length);
                     _loc9_ = 0;
                     while(_loc9_ < _loc8_)
                     {
                        if(_loc3_.x < _loc7_ + this.mx_internal::visibleColumns[_loc9_].width)
                        {
                           return listItems[_loc6_][_loc9_];
                        }
                        _loc7_ += this.mx_internal::visibleColumns[_loc9_].width;
                        _loc9_++;
                     }
                  }
               }
         ...
         {
            if(_loc2_ is IListItemRenderer && (_loc2_.parent == this.mx_internal::listSubContent || _loc2_.parent == listContent))
            {
               if(_loc2_.visible)
               {
      ...
      private function createRow(param1:Number, param2:Number, param3:Number, param4:Number, param5:Boolean) : void
      {
         ...
         {
            _loc8_ = this.currentRowNum > 1 ? Number(rowInfo[this.currentRowNum - 1].height) : rowHeight;
         }
         ...
         if(listItems[this.currentRowNum])
         {
            _loc22_ = _loc8_ - mx_internal::cachedPaddingTop - mx_internal::cachedPaddingBottom;
            _loc10_ = int(listItems[this.currentRowNum].length);
            _loc9_ = 0;
            while(_loc9_ < _loc10_)
            {
         ...
         if(mx_internal::cachedVerticalAlign != "top")
         {
            if(mx_internal::cachedVerticalAlign == "bottom")
            {
               ...
               while(_loc9_ < this.currentColNum)
               {
                  ...
                  _loc12_.move(_loc12_.x,this.currentItemTop + _loc8_ - mx_internal::cachedPaddingBottom - _loc12_.getExplicitOrMeasuredHeight());
                  _loc9_++;
               }
            }
            else
            {
               ...
               {
                  _loc12_ = listItems[this.currentRowNum][_loc9_];
                  _loc12_.move(_loc12_.x,this.currentItemTop + mx_internal::cachedPaddingTop + (_loc8_ - mx_internal::cachedPaddingBottom - mx_internal::cachedPaddingTop - _loc12_.getExplicitOrMeasuredHeight()) / 2);
                  _loc9_++;
               }
            }
         }
      ...
      private function moveIterator(param1:Boolean) : Boolean
      {
         ...
         if(Boolean(iterator) && more)
         {
            try
            {
               more = Boolean(iterator.moveNext());
            }
      ...
      protected function layoutRow(param1:Boolean, param2:Number, param3:Number) : Number
      {
         ...
         {
            this.currentColNum = 0;
            _loc8_ = this.currentItemTop + mx_internal::cachedPaddingTop;
            _loc9_ = mx_internal::cachedPaddingTop + mx_internal::cachedPaddingBottom;
            ...
            while(this.currentColNum < _loc10_.length)
            {
               ...
               _loc7_ = this.mx_internal::getWidthOfItem(_loc5_,_loc6_,this.currentColNum);
               ...
               _loc5_.setActualSize(_loc7_,variableRowHeight ? this.currentRowHeight : _loc4_ - mx_internal::cachedPaddingTop - mx_internal::cachedPaddingBottom);
               _loc5_.move(param2,_loc8_);
               param2 += _loc6_.width;
               if(variableRowHeight && Boolean(_loc5_.visible))
               {
                  param3 = Math.ceil(Math.max(param3,variableRowHeight ? this.currentRowHeight + _loc9_ : _loc4_));
               }
               ++this.currentColNum;
            }
         }
         ...
         {
            param3 = _loc4_ != 0 ? _loc4_ : this.getRowHeight();
         }
         return param3;
      }
      ...
      protected function getHeaderRenderer(param1:AdvancedDataGridColumn) : IListItemRenderer
      {
         ...
         var _loc3_:IFactory = this.mx_internal::columnItemRendererFactory(param1,true,null);
         if(Boolean(this.freeItemRenderersTable[param1]) && Boolean(this.freeItemRenderersTable[param1][_loc3_]) && Boolean(this.freeItemRenderersTable[param1][_loc3_].length))
         {
            _loc2_ = this.freeItemRenderersTable[param1][_loc3_].pop();
         }
         else
         {
            _loc2_ = this.mx_internal::columnItemRenderer(param1,true,null);
      ...
      {
         var _loc4_:IListItemRenderer = null;
         var _loc5_:IFactory = this.mx_internal::columnItemRendererFactory(param1,false,param2);
         if(Boolean(this.freeItemRenderersTable[param1]) && Boolean(this.freeItemRenderersTable[param1][_loc5_]) && Boolean(this.freeItemRenderersTable[param1][_loc5_].length))
         {
            _loc4_ = this.freeItemRenderersTable[param1][_loc5_].pop();
         }
         else
         {
            _loc4_ = this.mx_internal::columnItemRenderer(param1,false,param2);
      ...
      protected function setupRenderer(param1:Object, param2:String, param3:Boolean = false) : void
      {
         ...
         while(this.currentColNum < _loc8_.length)
         {
            ...
            if(param3)
            {
               _loc5_ = this.mx_internal::getRenderer(_loc4_,param1);
            ...
            _loc6_ = AdvancedDataGridListData(this.makeListData(param1,param2,this.currentRowNum,_loc4_.mx_internal::colNum,_loc4_));
      ...
      {
         if(param2.mx_internal::colNum < lockedColumnCount)
         {
         ...
         else if(param1.parent != this.mx_internal::listSubContent)
         {
            this.mx_internal::listSubContent.addChild(DisplayObject(param1));
         }
      }
      
      protected function getOptimumColumns() : Array
      {
         return this.mx_internal::visibleColumns;
      }
