package mx.controls.advancedDataGridClasses
{
   ...
   public class AdvancedDataGridColumn extends CSSStyleDeclaration implements IIMESupport
   {
      ...
      public function set styleFunction(param1:Function) : void
      {
         ...
         if(this.mx_internal::owner)
         {
            this.mx_internal::owner.invalidateDisplayList();
         }
      }
      ...
      override mx_internal function addStyleToProtoChain(param1:Object, param2:DisplayObject, param3:Object = null) : Object
      {
         ...
         var _loc4_:AdvancedDataGridBaseEx = this.mx_internal::owner;
         var _loc5_:IListItemRenderer = IListItemRenderer(param2);
         param1 = super.mx_internal::addStyleToProtoChain(param1,param2);
         if(Boolean(_loc5_.data) && _loc5_.data is AdvancedDataGridColumn)
         {
         ...
         if(!this.fontPropertiesSet)
         {
            ...
            this.saveFontContext(!!this.mx_internal::owner ? this.mx_internal::owner.moduleFactory : null);
         }
         return param1;
      }
      ...
      override public function setStyle(param1:String, param2:*) : void
      {
         ...
         if(this.mx_internal::owner)
         {
            ...
            if(this.mx_internal::hasFontContextChanged(this.mx_internal::owner.moduleFactory))
            {
               this.mx_internal::owner.mx_internal::columnRendererChanged(this);
            }
            this.mx_internal::owner.invalidateList();
      ...
      private function itemToLabelWithoutFormatting(param1:Object) : String
      {
         ...
         var headerInfo:AdvancedDataGridHeaderInfo = this.mx_internal::owner.mx_internal::getHeaderInfo(this);
      ...
      private function saveFontContext(param1:IFlexModuleFactory) : void
      {
         ...
         this.oldEmbeddedFontContext = noEmbeddedFonts || !embeddedFontRegistry ? null : embeddedFontRegistry.getAssociatedModuleFactory(_loc2_,_loc5_,_loc6_,this,param1,this.mx_internal::owner.systemManager);
      }
      ...
      mx_internal function hasFontContextChanged(param1:IFlexModuleFactory) : Boolean
      {
         ...
         var _loc5_:* = _loc3_ == "bold";
         var _loc6_:* = _loc4_ == "italic";
         var _loc7_:IFlexModuleFactory = noEmbeddedFonts || !embeddedFontRegistry ? null : embeddedFontRegistry.getAssociatedModuleFactory(_loc2_,_loc5_,_loc6_,this,param1,this.mx_internal::owner.systemManager);
