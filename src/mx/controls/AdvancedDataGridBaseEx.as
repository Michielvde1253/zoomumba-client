package mx.controls
{
   ...
   public class AdvancedDataGridBaseEx extends AdvancedDataGridBase implements IIMESupport
   {
      ...
      {
         var _loc1_:Number = 0;
         if(Boolean(border) && border is IBorder)
         {
            _loc1_ = Number(IBorder(border).borderMetrics.top);
         }
      ...
      override public function set horizontalScrollPosition(param1:Number) : void
      {
         ...
         if(_loc2_ != param1)
         {
            ...
            if(getOptimumColumns() == mx_internal::visibleColumns)
            {
               visibleData = {};
      ...
      override public function set focusPane(param1:Sprite) : void
      {
         ...
         if(param1)
         {
            param1.scrollRect = !!mx_internal::listSubContent ? mx_internal::listSubContent.scrollRect : null;
         }
      ...
      override public function set lockedColumnCount(param1:int) : void
      {
         ...
         if(param1 > super.lockedColumnCount)
         {
            ...
            while(_loc2_ < param1)
            {
               _loc4_ = int(listItems.length);
               _loc3_ = 0;
               while(_loc3_ < _loc4_)
               {
                  if(Boolean(listItems[_loc3_]) && Boolean(listItems[_loc3_][_loc2_]))
                  {
      ...
      public function set columns(param1:Array) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            this.mx_internal::columnRendererChanged(_columns[_loc3_]);
            _loc3_++;
         }
      ...
      override protected function findKey(param1:int) : Boolean
      {
         ...
         var _loc5_:Number = Number(mx_internal::_selectedIndex);
         if(_loc3_ - this.previousTime < this.lookAheadDuration)
         {
            ...
            if(mx_internal::_selectedIndex > 0)
            {
               _loc5_ = Number(mx_internal::_selectedIndex);
         ...
         if(!_loc6_ && mx_internal::_selectedIndex != _loc5_)
         {
            mx_internal::_selectedIndex = _loc5_;
         }
         return _loc6_;
      }
      ...
      override protected function measure() : void
      {
         ...
         if(verticalScrollPolicy == ScrollPolicy.AUTO && verticalScrollBar && Boolean(verticalScrollBar.visible))
         {
            measuredWidth -= verticalScrollBar.minWidth;
            measuredMinWidth -= verticalScrollBar.minWidth;
         }
         if(horizontalScrollPolicy == ScrollPolicy.AUTO && horizontalScrollBar && Boolean(horizontalScrollBar.visible))
         {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(horizontalScrollPolicy != ScrollPolicy.OFF && getOptimumColumns() != mx_internal::visibleColumns && !itemsSizeChanged && !mx_internal::bSelectionChanged && !scrollAreaChanged && this.subContentScrolled)
         {
         ...
         if(Boolean(collection) && Boolean(collection.length))
         {
            ...
            if(Boolean(headerInfos) && Boolean(headerInfos.length))
            {
               mx_internal::setColumnCount(headerInfos.length);
            }
            else
            {
         ...
         if(mx_internal::_horizontalScrollPolicy == ScrollPolicy.OFF)
         {
            _loc5_ = borderMetrics;
            _loc6_ = !!headerRowInfo.length ? Number(headerRowInfo[0].height) : headerHeight;
            if(verticalScrollBar != null && Boolean(verticalScrollBar.visible) && Boolean(mx_internal::headerVisible) && Boolean(roomForScrollBar(verticalScrollBar,param1 - _loc5_.left - _loc5_.right,param2 - _loc6_ - _loc5_.top - _loc5_.bottom)))
            {
      ...
      override protected function moveSelectionHorizontally(param1:uint, param2:Boolean, param3:Boolean) : void
      {
         ...
         {
            _loc4_ = Math.max(horizontalScrollPosition - (mx_internal::visibleColumns.length - lockedColumnCount),0);
         ...
         else if(param2 && param1 == Keyboard.PAGE_DOWN)
         {
            ...
            _loc4_ = Math.min(horizontalScrollPosition + (mx_internal::visibleColumns.length - lockedColumnCount),_loc6_);
            if(_loc4_ != horizontalScrollPosition)
            {
               _loc5_ = true;
            }
         ...
         if(_loc5_)
         {
            ...
            if(this.mx_internal::headerIndex != -1)
            {
               this.unselectColumnHeader(this.mx_internal::headerIndex);
            }
         }
      }
      ...
      override protected function makeRowsAndColumns(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:int, param7:Boolean = false, param8:uint = 0) : Point
      {
         ...
         if(Boolean(mx_internal::headerVisible) && itemsSizeChanged)
         {
         ...
         if(this.itemEditorInstance)
         {
            ...
            if(Boolean(_loc13_) && !_loc12_.rendererIsEditor)
            {
         ...
         var _loc11_:Sprite = Sprite(mx_internal::listSubContent.getChildByName("lines"));
         if(_loc11_)
         {
            mx_internal::listSubContent.setChildIndex(_loc11_,mx_internal::listSubContent.numChildren - 1);
         }
      ...
      override protected function calculateRowHeight(param1:Object, param2:Number, param3:Boolean = false) : Number
      {
         ...
         var _loc8_:int = 0;
         if(param3 && mx_internal::visibleColumns.length == _columns.length)
         {
            return param2;
         }
         var _loc9_:Number = Number(getStyle("paddingTop"));
         var _loc10_:Number = Number(getStyle("paddingBottom"));
         ...
         while(_loc7_ < _loc6_)
         {
            if(param3 && _loc8_ < mx_internal::visibleColumns.length && mx_internal::visibleColumns[_loc8_].colNum == this.columns[_loc7_].colNum)
            {
               _loc8_++;
            }
            else
            {
               ...
               if(_loc5_.visible)
               {
                  _loc4_ = this.mx_internal::getMeasuringRenderer(_loc5_,false,param1);
      ...
      override protected function scrollHandler(param1:Event) : void
      {
         ...
         if(param1.target == verticalScrollBar || param1.target == horizontalScrollBar)
         {
            if(param1 is ScrollEvent)
            {
               ...
               _loc3_ = Number(_loc2_.scrollPosition);
      ...
      override protected function configureScrollBars() : void
      {
         ...
         var _loc3_:int = int(listItems.length);
         ...
         var _loc7_:int = 0;
         while(Boolean(_loc3_) && listItems[_loc3_ - 1].length == 0)
         {
            if(!(Boolean(collection) && _loc3_ + _loc6_ >= collection.length))
            {
               break;
            }
            _loc3_--;
         ...
         var _loc8_:int = int(mx_internal::visibleColumns.length);
         var _loc9_:AdvancedDataGridHeaderInfo = this.mx_internal::getHeaderInfo(mx_internal::visibleColumns[mx_internal::visibleColumns.length - 1]);
         var _loc10_:int = int(_loc9_.headerItem.x);
         if(mx_internal::visibleColumns.length - 1 > lockedColumnCount)
         {
            _loc10_ = this.getAdjustedXPos(_loc10_);
         }
         if(_loc8_ > 1 && mx_internal::visibleColumns[_loc8_ - 1] == this.displayableColumns[this.displayableColumns.length - 1] && _loc10_ + mx_internal::visibleColumns[_loc8_ - 1].width > this.displayWidth)
         {
            _loc8_--;
         }
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:Number = !!mx_internal::headerVisible ? headerHeight : 0;
         if(param1 && listItems[param2].length && Boolean(listItems[param2][0]))
         {
      ...
      override protected function drawRowBackgrounds() : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = int(listItems.length);
      ...
      override protected function selectItem(param1:IListItemRenderer, param2:Boolean, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         {
            mx_internal::_selectedItem = null;
         }
         return _loc5_;
      }
      ...
      override mx_internal function addSelectionData(param1:String, param2:ListBaseSelectionData) : void
      {
         ...
         super.mx_internal::addSelectionData(param1,param2);
      }
      ...
      {
         if(!mx_internal::visibleColumns || getOptimumColumns() == mx_internal::visibleColumns)
         {
            mx_internal::listSubContent.scrollRect = null;
            mx_internal::listSubContent.x = 0;
            return;
         }
         var _loc1_:Number = 0;
         var _loc2_:int = 0;
         ...
         {
            _loc1_ += this.displayableColumns[_loc2_].width;
            _loc2_++;
         }
         var _loc3_:Number = 0;
         if(mx_internal::visibleColumns.length > lockedColumnCount)
         {
            _loc2_ = lockedColumnCount;
            while(_loc2_ < lockedColumnCount + horizontalScrollPosition)
            {
               _loc3_ += this.displayableColumns[_loc2_].width;
               _loc2_++;
            }
         }
         ...
         else
         {
            ...
            {
               mx_internal::listSubContent.x = _loc1_;
            }
            else
            {
               mx_internal::listSubContent.x = 0;
            ...
            if(_loc1_ > 0)
            {
               mx_internal::listSubContent.scrollRect = new Rectangle(_loc1_ + _loc3_,0,listContent.width - _loc1_,listContent.height);
            }
            else
            {
               mx_internal::listSubContent.scrollRect = new Rectangle(_loc3_,0,listContent.width,listContent.height);
            }
         }
      }
      ...
      protected function initializeHeaderInfo(param1:Array) : Array
      {
         ...
         var _loc2_:Array = [];
         var _loc3_:int = int(this.columns.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      {
         var _loc4_:IFactory = mx_internal::columnItemRendererFactory(param1,param2,param3);
         var _loc5_:IListItemRenderer = this.measuringObjects[_loc4_];
         if(!_loc5_)
         {
            _loc5_ = mx_internal::columnItemRenderer(param1,param2,param3);
      ...
      {
         var _loc4_:AdvancedDataGridListData = AdvancedDataGridListData(makeListData(param3,itemToUID(param3),0,param1.mx_internal::colNum,param1));
         if(param2 is IDropInListItemRenderer)
         {
            if(param3 != null)
            {
               IDropInListItemRenderer(param2).listData = makeListData(param3,itemToUID(param3),0,param1.mx_internal::colNum,param1);
            }
            else
            {
         ...
         param2.explicitWidth = mx_internal::getWidthOfItem(param2,param1,currentColNum);
      ...
      mx_internal function measureHeightOfItemsUptoMaxHeight(param1:int = -1, param2:int = 0, param3:Number = -1) : Number
      {
         ...
         if(Boolean(mx_internal::headerVisible) && count > 0 && index == -1)
         {
         ...
         if(lockedCount > 0 && Boolean(mx_internal::collectionIterator))
         {
            try
            {
         ...
         for(; i < count; i++)
         {
            if(bMore)
            {
               ...
               while(j < n)
               {
                  ...
                  if(c.visible)
                  {
                     item = this.mx_internal::getMeasuringRenderer(c,false,data);
            ...
            if(iterator)
            {
               try
               {
                  bMore = Boolean(iterator.moveNext());
                  if(lockedCount > 0)
                  {
      ...
      protected function calculateHeaderHeight() : Number
      {
         ...
         var _loc4_:Number = 0;
         var _loc7_:Number = Number(getStyle("paddingTop"));
         var _loc8_:Number = Number(getStyle("paddingBottom"));
         if(!this.measuringObjects)
         {
            this.measuringObjects = new Dictionary(false);
         }
         if(mx_internal::headerVisible)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               ...
               if(_loc2_.visible)
               {
                  _loc1_ = this.mx_internal::getMeasuringRenderer(_loc2_,true,null);
                  _loc3_ = AdvancedDataGridListData(makeListData(_loc2_,uid,0,_loc2_.mx_internal::colNum,_loc2_));
      ...
      {
         if(mx_internal::listSubContent.scrollRect)
         {
            if(mx_internal::listSubContent.x == 0)
            {
               param1 -= mx_internal::listSubContent.scrollRect.x;
            }
            else
            {
               param1 -= mx_internal::listSubContent.scrollRect.x - mx_internal::listSubContent.x;
            }
         }
         return param1;
      }
      ...
      {
         return headerInfos[param1.mx_internal::colNum];
      }
      ...
      {
         if(Boolean(headerItems) && Boolean(headerItems[0]))
         {
      ...
      private function adjustVerticalScrollPositionDownward(param1:int) : Boolean
      {
         ...
         var h:Number = 0;
         var ch:Number = 0;
         var paddingTop:Number = Number(getStyle("paddingTop"));
         var paddingBottom:Number = Number(getStyle("paddingBottom"));
         ...
         try
         {
            ...
            {
               bMore = Boolean(iterator.movePrevious());
            }
         }
         catch(e:ItemPendingError)
         {
      ...
      protected function createDisplayableColumns() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            if(Boolean(this.displayableColumns) && Boolean(_columns[_loc1_].visible))
            {
      ...
      private function calculateColumnSizes() : void
      {
         ...
         if(mx_internal::columnsInvalid)
         {
            ...
            if(horizontalScrollPolicy == ScrollPolicy.OFF)
            {
               ...
               while(_loc3_ < _loc2_)
               {
                  mx_internal::visibleColumns.push(this.displayableColumns[_loc3_]);
                  _loc3_++;
               }
            }
            else
         ...
         if(horizontalScrollPolicy == ScrollPolicy.OFF)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               if(mx_internal::visibleColumns[_loc3_].resizable)
               {
                  ...
                  {
                     _loc10_ += mx_internal::visibleColumns[_loc3_].width;
                  }
                  else
                  {
                     _loc9_++;
                     _loc10_ += mx_internal::visibleColumns[_loc3_].minWidth;
                  }
               }
               else
               {
            ...
            if(this.displayWidth > _loc10_ && Boolean(_loc9_))
            {
               _loc2_ = int(mx_internal::visibleColumns.length);
               _loc3_ = 0;
               while(_loc3_ < _loc2_)
               {
                  if(Boolean(mx_internal::visibleColumns[_loc3_].resizable) && isNaN(mx_internal::visibleColumns[_loc3_].explicitWidth))
                  {
                     ...
                     _loc13_ = Number(mx_internal::visibleColumns[_loc3_].minWidth);
                     mx_internal::visibleColumns[_loc3_].setWidth(_loc8_ > _loc13_ ? _loc8_ : _loc13_);
                  }
                  _loc12_ -= mx_internal::visibleColumns[_loc3_].width;
                  _loc3_++;
               }
               if(Boolean(_loc12_) && Boolean(_loc7_))
               {
                  _loc7_.mx_internal::setWidth(_loc7_.width + _loc12_);
               }
            }
            else
            {
         ...
         else
         {
            ...
            else if(_loc4_ < this.displayWidth && horizontalScrollPosition > 0)
            {
               while(_loc4_ < this.displayWidth && horizontalScrollPosition > 0)
               {
                  ...
                  mx_internal::visibleColumns.splice(lockedColumnCount,0,_loc5_);
                  var _loc14_:* = this;
                  var _loc15_:* = _loc14_.super.horizontalScrollPosition - 1;
                  _loc14_.super.horizontalScrollPosition = _loc15_;
                  _loc4_ += _loc6_;
               }
            }
            ...
            else if(mx_internal::visibleColumns.length == this.displayableColumns.length)
            {
               maxHorizontalScrollPosition = 0;
               super.horizontalScrollPosition = 0;
            }
            else if(lockedColumnCount < mx_internal::visibleColumns.length)
            {
      ...
      mx_internal function resizeColumn(param1:int, param2:Number) : void
      {
         ...
         {
            param2 = Number(this.columns[param1].minWidth);
         }
         ...
         {
            _loc3_ = int(mx_internal::visibleColumns.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               if(param1 == mx_internal::visibleColumns[_loc4_].colNum)
               {
                  break;
               }
               _loc4_++;
            }
            if(_loc4_ >= mx_internal::visibleColumns.length)
            {
               return;
            }
            param1 = _loc4_;
            ...
            while(_loc4_ < _loc3_)
            {
               ...
               {
                  _loc5_ += mx_internal::visibleColumns[_loc4_].width;
               }
               _loc4_++;
            }
            ...
            while(_loc4_ < _loc3_)
            {
               if(_loc8_[_loc4_].resizable)
               {
                  _loc7_ = Math.floor(mx_internal::visibleColumns[_loc4_].width * _loc9_ / _loc5_);
                  if(_loc7_ < mx_internal::visibleColumns[_loc4_].minWidth)
                  {
                     _loc7_ = Number(mx_internal::visibleColumns[_loc4_].minWidth);
                  }
                  _loc8_[_loc4_].setWidth(_loc7_);
                  _loc10_ += _loc8_[_loc4_].width;
            ...
            if(_loc10_ > _loc9_)
            {
               ...
               {
                  _loc7_ = Number(_loc8_[param1].minWidth);
               }
               _loc8_[param1].setWidth(_loc7_);
            }
            else if(_loc6_)
            {
               _loc6_.mx_internal::setWidth(_loc6_.width - _loc10_ + _loc9_);
            }
         }
         itemsSizeChanged = true;
         this.updateSubContent();
      ...
      protected function drawHeaderBackground(param1:UIComponent) : void
      {
         ...
         if(verticalScrollBar != null && mx_internal::_horizontalScrollPolicy == ScrollPolicy.OFF && Boolean(mx_internal::headerVisible))
         {
            _loc9_ = borderMetrics;
            maskShape.width = _loc2_ = unscaledWidth - (_loc9_.left + _loc9_.right);
         }
         var _loc3_:Number = !!headerRowInfo.length ? Number(headerRowInfo[0].height) : headerHeight;
      ...
      private function drawHeaderBackgroundSkin(param1:IFlexDisplayObject) : void
      {
         ...
         if(verticalScrollBar != null && mx_internal::_horizontalScrollPolicy == ScrollPolicy.OFF && Boolean(mx_internal::headerVisible))
         {
            ...
            maskShape.width = _loc2_ = unscaledWidth - (_loc4_.left + _loc4_.right);
         }
         var _loc3_:Number = !!headerRowInfo.length ? Number(headerRowInfo[0].height) : headerHeight;
      ...
      protected function drawColumnBackground(param1:Sprite, param2:int, param3:uint, param4:AdvancedDataGridColumn) : void
      {
         ...
         var _loc8_:AdvancedDataGridHeaderInfo = this.mx_internal::getHeaderInfo(getOptimumColumns()[param2]);
         var _loc9_:Number = Number(_loc8_.headerItem.x);
         if(param2 >= lockedColumnCount)
         {
            _loc9_ = this.getAdjustedXPos(_loc9_);
         }
         var _loc10_:Number = Number(headerRowInfo[0].y);
         if(mx_internal::headerVisible)
         {
            _loc10_ += headerRowInfo[0].height;
         }
      ...
      private function drawHorizontalSeparator(param1:Sprite, param2:int, param3:uint, param4:Number) : void
      {
         ...
         if(_loc13_)
         {
            _loc16_ = !isNaN(_loc13_.measuredHeight) ? Number(_loc13_.measuredHeight) : 1;
      ...
      private function drawVerticalSeparator(param1:Sprite, param2:int, param3:uint, param4:Number, param5:Number) : void
      {
         ...
         if(_loc14_)
         {
            _loc17_ = !isNaN(_loc14_.measuredWidth) ? Number(_loc14_.measuredWidth) : 1;
      ...
      protected function drawVerticalLine(param1:Sprite, param2:int, param3:uint, param4:Number) : void
      {
         ...
         if(mx_internal::headerVisible)
         {
            ...
            {
               _loc6_ = Number(headerItems[0][param2].height);
            }
         }
      ...
      protected function drawLinesAndColumnBackgrounds() : void
      {
         ...
         var _loc2_:uint = uint(this.getNumColumns());
         _loc2_ = _loc2_ != -1 ? _loc2_ : uint(mx_internal::visibleColumns.length);
         ...
         if(headerInfos && this.hasHeaderItemsCreated(0) && this.hasHeaderItemsCreated(_loc2_ - 1))
         {
            ...
            if(Boolean(_loc4_) && Boolean(_loc4_.numChildren))
            {
      ...
      protected function drawHorizontalSeparators() : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc1_:uint = uint(getStyle("horizontalGridLineColor"));
         ...
         if(Boolean(getStyle("horizontalGridLines")) || lockedRowCount > 0 && lockedRowCount < listItems.length)
         {
            if(!_loc3_)
            {
      ...
      protected function drawVerticalSeparators() : void
      {
         ...
         var _loc5_:Number = mx_internal::headerVisible && headerRowInfo && Boolean(headerRowInfo[0]) ? Number(headerRowInfo[0].height) : 0;
         var _loc6_:uint = Math.min(!!mx_internal::visibleColumns ? Number(mx_internal::visibleColumns.length) : 0,Math.max(0,lockedColumnCount));
         var _loc7_:Boolean = Boolean(getStyle("verticalGridLines"));
         var _loc8_:uint = uint(getStyle("verticalGridLineColor"));
         if(_loc7_ && Boolean(_loc6_))
         {
            _loc11_ = 0;
            while(_loc11_ < _loc6_)
            {
               this.drawVerticalSeparator(_loc3_,_loc11_,_loc8_,this.mx_internal::getHeaderInfo(mx_internal::visibleColumns[_loc11_]).headerItem.x + mx_internal::visibleColumns[_loc11_].width,_loc5_);
               _loc11_++;
            }
         }
         ...
         _loc6_ = uint(mx_internal::visibleColumns.length);
         if(_loc6_ > mx_internal::visibleColumns.length)
         {
            _loc6_ = uint(mx_internal::visibleColumns.length);
         }
         _loc7_ = Boolean(getStyle("verticalGridLines"));
         _loc8_ = uint(getStyle("verticalGridLineColor"));
         if(_loc7_ && headerInfos && this.hasHeaderItemsCreated(0) && this.hasHeaderItemsCreated(_loc6_ - 1))
         {
            _loc11_ = _loc12_ = Math.max(0,lockedColumnCount);
            while(_loc11_ < _loc6_ - 1)
            {
               _loc13_ = this.mx_internal::getHeaderInfo(mx_internal::visibleColumns[_loc11_]);
               this.drawVerticalSeparator(_loc9_,this.absoluteToVisibleColumnIndex(mx_internal::visibleColumns[_loc11_].colNum),_loc8_,_loc13_.headerItem.x + mx_internal::visibleColumns[_loc11_].width,_loc5_);
               _loc11_++;
            }
         }
         if(!_loc7_ && lockedColumnCount > 0 && lockedColumnCount < _loc6_)
         {
            this.drawVerticalSeparator(_loc9_,lockedColumnCount - 1,_loc8_,this.mx_internal::getHeaderInfo(mx_internal::visibleColumns[lockedColumnCount - 1]).headerItem.x + mx_internal::visibleColumns[lockedColumnCount - 1].width,0);
         }
      }
      ...
      private function getLines() : Sprite
      {
         ...
         if(!_loc1_)
         {
            ...
            _loc1_.cacheAsBitmap = true;
            _loc1_.mouseEnabled = false;
            mx_internal::listSubContent.addChild(_loc1_);
         }
         mx_internal::listSubContent.setChildIndex(_loc1_,mx_internal::listSubContent.numChildren - 1);
         return _loc1_;
      }
      ...
      protected function drawSeparators() : void
      {
         ...
         _loc1_ = Sprite(mx_internal::listSubContent.getChildByName("lines"));
         var _loc3_:int = 0;
         var _loc4_:* = false;
      ...
      protected function createHeaderSeparators(param1:int, param2:Array, param3:UIComponent) : void
      {
         ...
         while(_loc5_ < param1)
         {
            _loc6_ = lockedColumnCount > 0 && param2 != this.lockedSeparators ? _loc5_ + lockedColumnCount - 1 : _loc5_;
            ...
            else
            {
               ...
               _loc7_.y = 0;
               _loc8_.setActualSize(_loc8_.measuredWidth,!!headerRowInfo.length ? Number(headerRowInfo[0].height) : headerHeight);
      ...
      private function updateSortIndexAndDirection() : void
      {
         ...
         var _loc5_:int = int(_columns.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            if(_columns[_loc6_].dataField == _loc4_.name)
            {
               this.sortIndex = !!_columns[_loc6_].sortable ? _loc6_ : -1;
      ...
      private function commitEditedItemPosition(param1:Object) : void
      {
         ...
         {
            _loc16_ = int(this.displayableColumns.length);
            _loc17_ = 0;
         ...
         var _loc9_:uint = uint(mx_internal::visibleColumns.length);
         var _loc10_:int = horizontalScrollPosition + _loc9_ - 1;
         var _loc11_:AdvancedDataGridHeaderInfo = this.mx_internal::getHeaderInfo(mx_internal::visibleColumns[mx_internal::visibleColumns.length - 1]);
         ...
         if(_loc3_ > lockedColumnCount)
         {
            ...
            else
            {
               while(_loc3_ > _loc10_ || _loc3_ == _loc10_ && _loc3_ > horizontalScrollPosition + lockedColumnCount && _loc12_)
               {
                  ...
                  _loc10_ = horizontalScrollPosition + mx_internal::visibleColumns.length - 1;
                  _loc11_ = this.mx_internal::getHeaderInfo(mx_internal::visibleColumns[mx_internal::visibleColumns.length - 1]);
         ...
         if(Boolean(listItems[this.actualRowIndex]) && Boolean(listItems[this.actualRowIndex][this.actualColIndex]))
         {
            _loc13_ = listItems[this.actualRowIndex][this.actualColIndex];
         }
         if(!_loc13_)
      ...
      public function createItemEditor(param1:int, param2:int) : void
      {
         ...
         if(this.displayableColumns.length != _columns.length)
         {
            _loc6_ = int(this.displayableColumns.length);
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
         ...
         {
            param1 -= horizontalScrollPosition;
         }
         ...
         if(!_loc3_.rendererIsEditor)
         {
            ...
            if(!this.itemEditorInstance)
            {
               ...
               if(_loc13_ == AdvancedDataGridColumn.mx_internal::defaultItemEditorFactory)
               {
                  ...
                  if(_loc14_)
                  {
                     ...
                     _loc20_ = mx_internal::getFontContext(_loc15_,_loc18_,_loc19_);
      ...
      private function findNextItemRenderer(param1:Boolean) : Boolean
      {
         ...
         while(!_loc4_)
         {
            ...
            _loc9_ = int(_loc8_.rowIndex);
            _loc10_ = int(_loc8_.columnIndex);
            if(_loc10_ > -1)
            {
               ...
               _loc7_ = null;
               if(Boolean(listItems[_loc9_]) && Boolean(listItems[_loc9_][_loc10_]))
               {
      ...
      mx_internal function columnRendererChanged(param1:AdvancedDataGridColumn) : void
      {
         var _loc2_:IListItemRenderer = null;
         var _loc4_:Array = null;
         var _loc3_:IFactory = mx_internal::columnItemRendererFactory(param1,true,null);
         if(this.measuringObjects)
         {
            ...
            _loc3_ = mx_internal::columnItemRendererFactory(param1,false,null);
            _loc2_ = this.measuringObjects[_loc3_];
            if(_loc2_)
            {
               _loc2_.parent.removeChild(DisplayObject(_loc2_));
      ...
      protected function getPossibleDropPositions(param1:AdvancedDataGridColumn) : Array
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc3_.push(this.mx_internal::getHeaderInfo(mx_internal::visibleColumns[_loc4_]));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      protected function hasHeaderItemsCreated(param1:int = -1) : Boolean
      {
         if(param1 == -1)
         {
            return Boolean(headerItems) && Boolean(headerItems[0]) && Boolean(headerItems[0][0]);
         }
         return Boolean(headerItems) && Boolean(headerItems[0]) && Boolean(headerItems[0][param1]);
      }
      ...
      protected function columnDraggingMouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         var _loc16_:AdvancedDataGridListData = null;
         var _loc17_:Number = NaN;
         var _loc18_:Number = NaN;
         var _loc19_:Number = NaN;
         var _loc20_:EdgeMetrics = null;
         var _loc21_:Number = NaN;
         var _loc22_:AdvancedDataGridHeaderInfo = null;
         var _loc23_:Graphics = null;
         var _loc24_:EdgeMetrics = null;
         var _loc25_:Class = null;
         var _loc26_:AdvancedDataGridEvent = null;
         var _loc27_:AdvancedDataGridHeaderInfo = null;
         ...
         if(isNaN(this.startX))
         {
            ...
            _loc15_ = mx_internal::columnItemRenderer(_loc3_,true,null);
            _loc15_.name = "headerDragProxy";
            _loc16_ = AdvancedDataGridListData(makeListData(_loc3_,null,0,_loc3_.mx_internal::colNum,_loc3_));
            if(_loc15_ is IDropInListItemRenderer)
            {
               IDropInListItemRenderer(_loc15_).listData = _loc16_;
            }
            listContent.addChild(DisplayObject(_loc15_));
            _loc6_ = int(this.orderedHeadersList.length);
            _loc5_ = 0;
            while(_loc5_ < _loc6_)
            {
               _loc2_ = this.orderedHeadersList[_loc5_].headerItem;
               if(Boolean(_loc2_) && _loc2_.data == this.movingColumn)
               {
                  break;
               }
               _loc5_++;
            }
            _loc17_ = _loc2_.height + mx_internal::cachedPaddingBottom + mx_internal::cachedPaddingTop;
            _loc18_ = Number(_loc2_.getExplicitOrMeasuredWidth());
            _loc19_ = Number(_loc2_.x);
            if(this.orderedHeadersList[_loc5_].actualColNum >= lockedColumnCount)
            {
               _loc19_ = this.getAdjustedXPos(_loc2_.x);
               if(horizontalScrollPosition > 0 && this.orderedHeadersList[_loc5_].actualColNum - horizontalScrollPosition < lockedColumnCount)
               {
                  _loc21_ = 0;
                  if(lockedColumnCount > 0)
                  {
                     _loc22_ = this.mx_internal::getHeaderInfo(this.columns[lockedColumnCount - 1]);
                     _loc21_ = _loc22_.headerItem.x + this.columns[lockedColumnCount - 1].width;
                  }
                  else
                  {
                     _loc21_ = 0;
                  }
                  _loc18_ -= _loc21_ - _loc19_;
                  _loc19_ = _loc21_;
               }
            }
            _loc15_.data = _loc3_;
            ...
            _loc15_.setActualSize(_loc18_,!!mx_internal::_explicitHeaderHeight ? headerHeight : Number(_loc15_.getExplicitOrMeasuredHeight()));
            _loc15_.move(_loc19_,_loc2_.y);
            _loc4_ = new FlexSprite();
            ...
            _loc20_ = viewMetrics;
            _loc4_.x = _loc19_;
            _loc4_.y = _loc2_.y - mx_internal::cachedPaddingTop;
            if(_loc18_ > 0)
            {
               _loc23_ = _loc4_.graphics;
               _loc23_.beginFill(getStyle("disabledColor"));
               _loc23_.drawRect(0,0,_loc18_,unscaledHeight - _loc20_.bottom - _loc4_.y);
               _loc23_.endFill();
            }
            ...
            if(!listContent.mask)
            {
               _loc24_ = borderMetrics;
               listContent.scrollRect = new Rectangle(0,0,unscaledWidth - _loc24_.left - _loc24_.right,unscaledHeight - _loc24_.top - _loc24_.bottom);
            }
            return;
         }
         ...
         if(_loc2_)
         {
            _loc2_.move(_loc2_.x + _loc7_,_loc2_.y);
         }
         this.startX += _loc7_;
         var _loc8_:Point = new Point(param1.stageX,param1.stageY);
         _loc8_ = listContent.globalToLocal(_loc8_);
         this.lastPt = _loc8_;
         var _loc9_:Array = this.getPossibleDropPositions(this.movingColumn);
         _loc6_ = int(_loc9_.length);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = Number(_loc9_[0].headerItem.x);
         var _loc13_:Boolean = false;
         this.dropIndexFound = false;
         var _loc14_:int = 0;
         while(_loc14_ < _loc6_)
         {
            _loc10_ = _loc9_[_loc14_];
            if(_loc10_.actualColNum >= lockedColumnCount)
            {
               _loc13_ = true;
            }
            _loc12_ += _loc10_.column.width;
            if(_loc13_ && _loc10_.actualColNum + _loc10_.columnSpan - horizontalScrollPosition <= lockedColumnCount)
            {
               _loc11_ = _loc12_;
            }
            else
            {
               if(_loc13_)
               {
                  _loc11_ = this.getAdjustedXPos(_loc11_);
               }
               if(_loc8_.x >= _loc11_ && _loc8_.x < _loc11_ + _loc10_.column.width)
               {
                  this.dropIndexFound = true;
                  this.isHeaderDragOutside = false;
                  if(_loc8_.x > _loc11_ + _loc10_.column.width / 2 || _loc13_ && _loc10_.actualColNum - horizontalScrollPosition < lockedColumnCount)
                  {
                     _loc11_ += _loc10_.column.width;
                     _loc14_++;
                  }
                  if(this.dropColumnIndex != _loc14_)
                  {
                     this.dropColumnIndex = _loc14_;
                     if(!this.mx_internal::columnDropIndicator)
                     {
                        _loc25_ = getStyle("columnDropIndicatorSkin");
                        if(!_loc25_)
                        {
                           _loc25_ = DataGridColumnDropIndicator;
                        }
                        this.mx_internal::columnDropIndicator = IFlexDisplayObject(new _loc25_());
                        ...
                        listContent.addChild(DisplayObject(this.mx_internal::columnDropIndicator));
                     }
                     listContent.setChildIndex(DisplayObject(this.mx_internal::columnDropIndicator),listContent.numChildren - 1);
                     this.mx_internal::columnDropIndicator.x = _loc11_ - 2;
                     this.mx_internal::columnDropIndicator.y = _loc2_.y;
                     this.mx_internal::columnDropIndicator.setActualSize(3,listContent.height - _loc2_.y);
                  }
         ...
         if(!this.dropIndexFound && this.isHeaderDragOutside == false)
         {
            ...
            _loc26_ = new AdvancedDataGridEvent(AdvancedDataGridEvent.HEADER_DRAG_OUTSIDE,false,true);
            _loc27_ = this.mx_internal::getHeaderInfo(this.movingColumn);
            _loc26_.column = this.movingColumn;
            _loc26_.columnIndex = -1;
            _loc26_.itemRenderer = _loc27_.headerItem;
            _loc26_.triggerEvent = param1;
            dispatchEvent(_loc26_);
         }
      }
      ...
      protected function columnDraggingMouseUpHandler(param1:Event) : void
      {
         ...
         var _loc2_:int = this.movingColumn.mx_internal::colNum;
         if(this.dropColumnIndex >= 0)
         {
            if(this.dropColumnIndex >= mx_internal::visibleColumns.length)
            {
               this.dropColumnIndex = mx_internal::visibleColumns.length - 1;
            }
            else if(_loc2_ < mx_internal::visibleColumns[this.dropColumnIndex].colNum)
            {
               --this.dropColumnIndex;
            }
            this.dropColumnIndex = mx_internal::visibleColumns[this.dropColumnIndex].colNum;
         }
         this.mx_internal::shiftColumns(_loc2_,this.dropColumnIndex,param1 as MouseEvent);
      ...
      public function getFieldSortInfo(param1:AdvancedDataGridColumn) : SortInfo
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 && collection && Boolean(collection.sort))
         {
            if(!param1.dataField)
            {
      ...
      {
         var _loc1_:int = int(this.orderedHeadersList.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      protected function findSortField(param1:String) : int
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         if(Boolean(collection) && Boolean(collection.sort))
         {
            _loc2_ = int(collection.sort.fields.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
      ...
      protected function addSortField(param1:String, param2:int, param3:ICollectionView) : void
      {
         ...
         var _loc5_:AdvancedDataGridHeaderInfo = this.mx_internal::getHeaderInfo(_loc4_);
      ...
      protected function removeSortField(param1:String, param2:int, param3:ICollectionView) : void
      {
         ...
         var _loc5_:int = -1;
         var _loc6_:int = int(param3.sort.fields.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
      ...
      private function findRenderer(param1:Point, param2:Array, param3:Array, param4:Number = 0) : IListItemRenderer
      {
         ...
         while(_loc10_ < _loc8_)
         {
            if(param2[_loc10_].length)
            {
               ...
               {
                  _loc7_ = int(param2[_loc10_].length);
                  if(_loc7_ == 1)
                  {
      ...
      private function findHeaderRenderer(param1:Point) : IListItemRenderer
      {
         ...
         while(_loc8_ < _loc6_)
         {
            if(headerItems[_loc8_].length)
            {
               ...
               {
                  _loc5_ = int(headerItems[_loc8_].length);
                  if(_loc5_ == 1)
                  {
            ...
            _loc3_ += headerRowInfo[_loc8_].height;
            _loc8_++;
         }
         return _loc2_;
      }
         ...
         if(itemsNeedMeasurement)
         {
            ...
            if(isNaN(explicitRowHeight))
            {
               if(Boolean(iterator) && this.columns.length > 0)
               {
                  ...
                  _loc2_ = Number(getStyle("paddingBottom"));
                  _loc3_ = iterator.current;
                  _loc6_ = 0;
                  _loc7_ = int(this.columns.length);
                  _loc8_ = 0;
                  while(_loc8_ < _loc7_)
                  {
                     ...
                     if(_loc5_.visible)
                     {
                        _loc4_ = this.mx_internal::getMeasuringRenderer(_loc5_,false,_loc3_);
                        this.mx_internal::setupRendererFromData(_loc5_,_loc4_,_loc3_);
      ...
      {
         if(!mx_internal::headerVisible || this.mx_internal::headerIndex != -1)
         {
            return;
         }
         if(mx_internal::visibleColumns.length > 0)
         {
            if(param1 == -1)
            {
               param1 = int(mx_internal::visibleColumns[0].colNum);
            }
            this.mx_internal::selectedHeaderInfo = this.mx_internal::getHeaderInfo(this.columns[param1]);
            this.mx_internal::headerIndex = param1;
            this.selectColumnHeader(this.mx_internal::headerIndex);
         }
      }
      ...
      protected function selectColumnHeader(param1:int) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(mx_internal::visibleColumns[_loc4_].colNum == param1)
            {
               _loc2_ = _loc4_;
               break;
            }
         ...
         {
            _loc2_ = 0;
            this.mx_internal::headerIndex = mx_internal::visibleColumns[0].colNum;
         }
         ...
         _loc6_ = this.mx_internal::selectedHeaderInfo.headerItem;
         if(_loc6_)
         {
            _loc7_ = _loc5_.graphics;
            _loc7_.clear();
            _loc7_.beginFill(Boolean(mx_internal::isPressed) || this.isKeyPressed ? uint(getStyle("selectionColor")) : uint(getStyle("rollOverColor")));
            _loc7_.drawRect(0,0,mx_internal::visibleColumns[_loc2_].width,_loc6_.height + mx_internal::cachedPaddingTop + mx_internal::cachedPaddingBottom - 0.5);
            _loc7_.endFill();
            _loc5_.x = this.getAdjustedXPos(_loc6_.x);
            _loc5_.y = _loc6_.y - mx_internal::cachedPaddingTop;
            caretIndex = -1;
            mx_internal::isPressed = false;
            this.selectItem(this.mx_internal::selectedHeaderInfo.headerItem,false,false);
         }
      }
      ...
      protected function unselectColumnHeader(param1:int, param2:Boolean = false) : void
      {
         ...
         this.mx_internal::selectedHeaderInfo = null;
         if(param2)
         {
            caretIndex = 0;
            mx_internal::isPressed = false;
      ...
      protected function isColumnFullyVisible(param1:int, param2:int = -1) : Boolean
      {
         ...
         if(_loc6_)
         {
            if(listItems.length >= 1 && mx_internal::visibleColumns.length >= 1)
            {
               _loc7_ = Number(listItems[_loc4_][_loc5_].x);
      ...
      protected function viewDisplayableColumnAtOffset(param1:int, param2:int, param3:int = -1, param4:Boolean = true) : int
      {
         ...
         while(true)
         {
            ...
            if(!(Boolean(_loc10_) && !_loc10_.visible))
            {
               break;
            }
            _loc7_ += param2;
      ...
      protected function absoluteToVisibleIndices(param1:int, param2:int) : Object
      {
         ...
         if(_loc3_ > -1)
         {
            _loc5_ = mx_internal::visibleColumns;
            ...
            else if(_loc2_.kind == CollectionEventKind.REMOVE)
            {
               if(this.editedItemPosition)
               {
                  ...
                  else if(_loc2_.location <= this.editedItemPosition.rowIndex)
                  {
                     ...
                     if(_loc2_.location == this.editedItemPosition.rowIndex && Boolean(this.itemEditorInstance))
                     {
                        this.endEdit(AdvancedDataGridEventReason.CANCELLED);
                     }
                     if(this.inEndEdit)
      ...
      override protected function mouseOverHandler(param1:MouseEvent) : void
      {
         ...
         if(enabled && mx_internal::headerVisible && this.getNumColumns() && !mx_internal::isPressed)
         {
            _loc2_ = this.mouseEventToItemRenderer(param1);
            _loc3_ = int(this.orderedHeadersList.length);
            _loc6_ = 0;
            while(_loc6_ < _loc3_ && Boolean(_loc2_))
            {
               ...
               if(_loc4_ == _loc2_)
               {
                  ...
                  if(this.orderedHeadersList[_loc6_].column.sortable)
                  {
                     ...
                     _loc8_ = _loc2_.height + mx_internal::cachedPaddingBottom + mx_internal::cachedPaddingTop;
                     _loc9_ = Number(_loc2_.getExplicitOrMeasuredWidth());
                     _loc10_ = Number(_loc2_.x);
                     if(_loc5_.actualColNum >= lockedColumnCount)
                     {
                        ...
                        if(horizontalScrollPosition > 0 && _loc5_.actualColNum - horizontalScrollPosition < lockedColumnCount)
                        {
                           ...
                           if(lockedColumnCount > 0)
                           {
                              _loc13_ = this.mx_internal::getHeaderInfo(this.columns[lockedColumnCount - 1]);
                     ...
                     _loc11_.endFill();
                     _loc7_.x = _loc10_;
                     _loc7_.y = _loc2_.y - mx_internal::cachedPaddingTop;
                  }
                  return;
               }
               _loc6_++;
      ...
      override protected function mouseOutHandler(param1:MouseEvent) : void
      {
         ...
         if(enabled && Boolean(mx_internal::headerVisible) && Boolean(listItems.length))
         {
            _loc2_ = this.mouseEventToItemRenderer(param1);
            if(!_loc2_)
            {
               ...
               while(_loc6_ < _loc4_)
               {
                  ...
                  {
                     _loc2_ = this.mx_internal::getHeaderInfo(_loc3_[_loc6_]).headerItem;
                  }
                  _loc6_++;
               }
            }
            _loc4_ = int(this.orderedHeadersList.length);
            _loc6_ = 0;
            while(_loc6_ < _loc4_ && Boolean(_loc2_))
            {
      ...
      override protected function mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         _loc2_ = this.mouseEventToItemRenderer(param1);
         var _loc4_:Array = getOptimumColumns();
         if(enabled && (this.sortableColumns || this.draggableColumns) && Boolean(mx_internal::headerVisible) && this.hasHeaderItemsCreated())
         {
            _loc6_ = int(this.orderedHeadersList.length);
            _loc8_ = 0;
            while(_loc8_ < _loc6_ && Boolean(_loc2_))
            {
               ...
               if(_loc7_ == _loc2_)
               {
                  ...
                  if(this.sortableColumns && _loc10_.sortable)
                  {
                     ...
                     _loc11_ = _loc2_.height + mx_internal::cachedPaddingBottom + mx_internal::cachedPaddingTop;
                     _loc12_ = Number(_loc2_.getExplicitOrMeasuredWidth());
                     _loc13_ = Number(_loc2_.x);
                     if(_loc9_.actualColNum >= lockedColumnCount)
                     {
                        ...
                        if(horizontalScrollPosition > 0 && _loc9_.actualColNum - horizontalScrollPosition < lockedColumnCount)
                        {
                           ...
                           if(lockedColumnCount > 0)
                           {
                              _loc16_ = this.mx_internal::getHeaderInfo(this.columns[lockedColumnCount - 1]);
                     ...
                     _loc14_.endFill();
                     _loc3_.x = _loc13_;
                     _loc3_.y = _loc2_.y - mx_internal::cachedPaddingTop;
                  }
         ...
         if(!_loc5_)
         {
            ...
            if(this.mx_internal::headerIndex != -1)
            {
               ...
               if(_loc20_)
               {
                  this.unselectColumnHeader(this.mx_internal::headerIndex,true);
                  this.mx_internal::headerIndex = -1;
            ...
            if(_loc2_)
            {
               if(Boolean(_loc18_) && Boolean(this.displayableColumns[_loc18_.x].rendererIsEditor))
               {
      ...
      override protected function mouseUpHandler(param1:MouseEvent) : void
      {
         ...
         if(enabled && (this.sortableColumns || this.draggableColumns) && collection && mx_internal::headerVisible && this.hasHeaderItemsCreated())
         {
            _loc5_ = int(this.orderedHeadersList.length);
            _loc6_ = 0;
            while(_loc6_ < _loc5_)
            {
               if(_loc3_ == this.orderedHeadersList[_loc6_].headerItem && Boolean(_loc3_))
               {
                  ...
                  if(this.sortableColumns && _loc8_.sortable && this.lastItemDown == _loc3_)
                  {
                     ...
                     if(_loc8_.mx_internal::colNum == -1 || isNaN(_loc8_.mx_internal::colNum))
                     {
                        _loc2_.columnIndex = -1;
                     }
                     else
                     {
                        _loc2_.columnIndex = _loc8_.mx_internal::colNum;
                     }
         ...
         if(_loc3_ && _loc3_.data && _loc3_ != this.itemEditorInstance && this.lastItemDown == _loc3_ && _loc3_.visible && this.isDataEditable(_loc3_.data))
         {
            ...
            if((_loc7_) && _loc7_.y >= 0 && Boolean(this.displayableColumns[_loc7_.x].editable) && !this.dontEdit)
            {
      ...
      override protected function focusInHandler(param1:FocusEvent) : void
      {
         ...
         if(Boolean(this.editable.length) && !mx_internal::isPressed)
         {
            this._editedItemPosition = this.lastEditedItemPosition;
            ...
            if(!this._editedItemPosition)
            {
               ...
               {
                  if(Boolean(_columns[this._editedItemPosition.columnIndex].editable) && Boolean(_columns[this._editedItemPosition.columnIndex].visible))
                  {
                     _loc3_ = listItems[this._editedItemPosition.rowIndex];
                     if(Boolean(_loc3_) && Boolean(_loc3_[this._editedItemPosition.columnIndex]))
                     {
                        _loc2_ = true;
                        break;
                     }
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(Boolean(mx_internal::headerVisible) && selectedIndex == 0 && caretIndex == 0 && param1.keyCode == Keyboard.UP && !param1.ctrlKey && !param1.shiftKey)
         {
      ...
      {
         if(this.isKeyPressed && this.mx_internal::headerIndex != -1)
         {
            this.isKeyPressed = false;
            this.mx_internal::selectedHeaderInfo = this.mx_internal::getHeaderInfo(this.columns[this.mx_internal::headerIndex]);
            this.selectColumnHeader(this.mx_internal::headerIndex);
         }
      }
      ...
      private function columnResizeMouseDownHandler(param1:MouseEvent) : void
      {
         ...
         _loc5_ = this.mx_internal::getHeaderInfo(_loc4_[_loc3_]).headerItem;
         if(_loc3_ > lockedColumnCount)
         {
         ...
         this.minX += this.resizingColumn.minWidth;
         mx_internal::isPressed = true;
      ...
      private function columnResizingHandler(param1:MouseEvent) : void
      {
         ...
         this.lastPt = _loc3_;
         _loc4_ = 0;
         if(Boolean(this.lockedSeparators) && this.lockedSeparators.length > 0)
         {
            _loc4_ = Number(this.lockedSeparators[0].width);
         }
         else if(Boolean(this.separators) && this.separators.length > 0)
         {
            _loc4_ = Number(this.separators[0].width);
         }
         _loc5_ = unscaledWidth - _loc4_ - _loc2_;
         if(getOptimumColumns() == mx_internal::visibleColumns)
         {
            _loc6_ = this.absoluteToVisibleColumnIndex(this.resizingColumn.mx_internal::colNum);
         }
         else
         {
            _loc6_ = this.absoluteToDisplayColumnIndex(this.resizingColumn.mx_internal::colNum);
         }
      ...
      private function columnResizeMouseUpHandler(param1:Event) : void
      {
         ...
         if(Boolean(this.lockedSeparators) && this.lockedSeparators.length > 0)
         {
            _loc7_ = Number(this.lockedSeparators[0].width);
         }
         else if(Boolean(this.separators) && this.separators.length > 0)
         {
            _loc7_ = Number(this.separators[0].width);
         }
         _loc8_ = unscaledWidth - _loc7_ - _loc4_;
         _loc9_ = Math.min(Math.max(this.minX,_loc6_.x),_loc8_) - this.startX;
         this.mx_internal::resizeColumn(_loc3_.mx_internal::colNum,Math.floor(_loc3_.width + _loc9_));
         _loc10_ = new AdvancedDataGridEvent(AdvancedDataGridEvent.COLUMN_STRETCH);
         _loc10_.columnIndex = _loc3_.mx_internal::colNum;
      ...
      {
         if(param1 is MouseEvent && Boolean(owns(DisplayObject(param1.target))))
         {
            return;
         }
         this.endEdit(AdvancedDataGridEventReason.OTHER);
      ...
      {
         if(Boolean(param1.relatedObject) && Boolean(contains(param1.relatedObject)))
         {
            return;
         }
      ...
      private function itemEditorItemEditEndHandler(param1:AdvancedDataGridEvent) : void
      {
         ...
         if(!param1.isDefaultPrevented())
         {
            ...
            if(Boolean(this.itemEditorInstance) && param1.reason != AdvancedDataGridEventReason.CANCELLED)
            {
      ...
      protected function sortHandler(param1:AdvancedDataGridEvent) : void
      {
         ...
         if(this.mx_internal::headerIndex != -1)
         {
            this.mx_internal::selectedHeaderInfo = this.mx_internal::getHeaderInfo(this.columns[param1.columnIndex]);
            this.mx_internal::headerIndex = param1.columnIndex;
            this.selectColumnHeader(this.mx_internal::headerIndex);
         }
         this.invalidateHeaders();
      }
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:AdvancedDataGridEvent = null;
         if(this.mx_internal::headerIndex == -1)
         {
            return;
         }
         ...
         {
            _loc2_ = this.viewDisplayableColumnAtOffset(this.mx_internal::headerIndex,-1);
            if(_loc2_ != -1)
            {
               this.unselectColumnHeader(this.mx_internal::headerIndex);
               this.mx_internal::selectedHeaderInfo = this.mx_internal::getHeaderInfo(this.columns[_loc2_]);
               this.mx_internal::headerIndex = _loc2_;
               this.selectColumnHeader(this.mx_internal::headerIndex);
            }
         }
         ...
         {
            if(this.sortableColumns && Boolean(this.columns[this.mx_internal::headerIndex].sortable))
            {
               this.isKeyPressed = true;
               this.mx_internal::selectedHeaderInfo = this.mx_internal::getHeaderInfo(this.columns[this.mx_internal::headerIndex]);
               this.selectColumnHeader(this.mx_internal::headerIndex);
               _loc3_ = new AdvancedDataGridEvent(AdvancedDataGridEvent.SORT,false,true);
               _loc3_.columnIndex = this.mx_internal::headerIndex;
               _loc3_.dataField = this.columns[this.mx_internal::headerIndex].dataField;
               _loc3_.multiColumnSort = param1.ctrlKey;
               _loc3_.removeColumnFromSort = param1.shiftKey;
