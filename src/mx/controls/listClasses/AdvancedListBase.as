   ...
   public class AdvancedListBase extends ScrollControlBase implements IDataRenderer, IFocusManagerComponent, IListItemRenderer, IDropInListItemRenderer, IEffectTargetHost
   {
      ...
      override public function set horizontalScrollPosition(param1:Number) : void
      {
         ...
         if(_loc2_ != param1)
         {
            ...
            if(this.mx_internal::bColumnScrolling && _loc3_ >= this.columnCount - this.lockedColumnCount)
            {
      ...
      {
         return this.mx_internal::_selectedItem;
      }
      ...
      public function set selectedItem(param1:Object) : void
      {
         if(!this.collection || this.collection.length == 0)
         {
            this.mx_internal::_selectedItem = param1;
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = Boolean(this.collection) && this.collection.length > 0;
         if(_loc4_)
         {
         ...
         {
            _loc6_ = int(this.listItems.length - 1);
      ...
      protected function itemRendererToIndices(param1:IListItemRenderer) : Point
      {
         ...
         return new Point(_loc4_ < this.lockedColumnCount ? _loc4_ : _loc4_ + this.horizontalScrollPosition,_loc2_ < this.lockedRowCount ? _loc2_ : _loc2_ + this.verticalScrollPosition + this.offscreenExtraRowsTop);
      }
      ...
      public function itemRendererToIndex(param1:IListItemRenderer) : int
      {
         ...
         if(param1.name in this.rowMap)
         {
            ...
            return _loc2_ < this.lockedRowCount ? _loc2_ : int(_loc2_ + this.verticalScrollPosition);
         }
      ...
      protected function drawItem(param1:IListItemRenderer, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc9_ = this.runningDataEffect ? param1.y - this.mx_internal::cachedPaddingTop : Number(this.rowInfo[_loc8_.rowIndex].y);
         ...
         {
            if(Boolean(_loc8_) && Boolean(this.selectionIndicators[_loc8_.uid]))
            {
               if(this.selectionTweens[_loc8_.uid])
               {
                  ...
                  {
                     Tween.mx_internal::removeTween(this.selectionTweens[_loc8_.uid]);
                  }
      ...
      mx_internal function addClipMask(param1:Boolean) : void
      {
         ...
         var _loc2_:int = int(this.listItems.length - 1);
         ...
         var _loc6_:Number = Number(_loc3_.y);
         var _loc7_:Number = Number(this.listContent.width);
      ...
      mx_internal function removeClipMask() : void
      {
         ...
         var _loc1_:int = int(this.listItems.length - 1);
         if(_loc1_ < 0)
         {
            return;
         }
      ...
      private function calculateSelectedIndexAndItem() : void
      {
         ...
         if(!_loc1_)
         {
            ...
            this.mx_internal::_selectedItem = null;
            return;
         }
         this.mx_internal::_selectedIndex = this.selectedData[_loc2_].index;
         this.mx_internal::_selectedItem = this.selectedData[_loc2_].data;
      }
      ...
      protected function selectItem(param1:IListItemRenderer, param2:Boolean, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         if(!this.allowMultipleSelection || !shiftKey && !ctrlKey)
         {
            ...
            else if(this.mx_internal::_selectedIndex != index || this.mx_internal::bSelectedIndexChanged || this.allowMultipleSelection && numSelected != 1)
            {
               selectionChange = true;
               this.clearSelected(transition);
               this.mx_internal::addSelectionData(uid,new ListBaseSelectionData(item.data,index,this.approximate));
               this.drawItem(this.visibleData[uid],true,uid == this.highlightUID,true,transition);
               this.mx_internal::_selectedIndex = index;
               this.mx_internal::_selectedItem = item.data;
      ...
      private function shiftSelectionLoop(param1:Boolean, param2:int, param3:Object, param4:Boolean, param5:CursorBookmark) : void
      {
         ...
         try
         {
            do
            {
               ...
               this.mx_internal::addSelectionData(uid,new ListBaseSelectionData(data,index,this.approximate));
      ...
      protected function moveSelectionVertically(param1:uint, param2:Boolean, param3:Boolean) : void
      {
         ...
         switch(param1)
         {
            ...
            case Keyboard.DOWN:
               ...
               else if(this.caretIndex == this.collection.length - 1 && Boolean(_loc10_))
               {
            ...
            case Keyboard.END:
               if(this.caretIndex < this.collection.length - 1)
               {
                  ...
                  this.bSelectItem = true;
                  _loc4_ = Number(maxVerticalScrollPosition);
               }
         }
         if(_loc11_)
         {
      ...
      protected function selectData(param1:String, param2:Object, param3:int, param4:CursorBookmark) : void
      {
         if(!this.selectedData[param1])
         {
            ...
            {
               this.clearSelected();
               this.mx_internal::addSelectionData(param1,new ListBaseSelectionData(param2,param3,this.approximate));
               this.mx_internal::_selectedIndex = param3;
               this.caretIndex = param3;
               this.caretBookmark = param4;
               this.anchorIndex = param3;
               this.anchorBookmark = param4;
               this.mx_internal::_selectedItem = param2;
            }
         }
      }
      ...
      private function setSelectionIndicesLoop(param1:int, param2:Array, param3:Boolean = false) : void
      {
         ...
         while(indices.length)
         {
            ...
            {
               this.mx_internal::_selectedIndex = index;
               this.mx_internal::_selectedItem = data;
               firstTime = false;
            }
            this.mx_internal::addSelectionData(this.itemToUID(data),new ListBaseSelectionData(data,index,false));
         }
         if(initialized)
         {
            this.updateList();
      ...
      private function setSelectionDataLoop(param1:Array, param2:int, param3:Boolean = true) : void
      {
         ...
         if(useFind)
         {
            while(items.length)
            {
               ...
               index = int(bookmark.getViewIndex());
               if(index < 0)
               {
                  try
                  {
               ...
               this.mx_internal::addSelectionData(uid,new ListBaseSelectionData(item,index,true));
               if(items.length == 0)
               {
                  this.mx_internal::_selectedIndex = index;
                  this.mx_internal::_selectedItem = item;
                  this.caretIndex = index;
         ...
         else
         {
            while(Boolean(items.length) && !this.mx_internal::collectionIterator.afterLast)
            {
               ...
               while(i < n)
               {
                  ...
                  {
                     uid = this.itemToUID(data);
                     this.mx_internal::addSelectionData(uid,new ListBaseSelectionData(data,index,false));
                     items.splice(i,1);
                     if(items.length == 0)
                     {
                        this.mx_internal::_selectedIndex = index;
      ...
      mx_internal function addSelectionData(param1:String, param2:ListBaseSelectionData) : void
      {
         ...
         {
            this.firstSelectionData.mx_internal::prevSelectionData = param2;
         }
         param2.mx_internal::nextSelectionData = this.firstSelectionData;
      ...
      protected function applySelectionEffect(param1:Sprite, param2:String, param3:IListItemRenderer) : void
      {
         ...
         var _loc4_:Number = Number(getStyle("selectionDuration"));
         if(_loc4_ != 0)
         {
            param1.alpha = 0;
      ...
      protected function scrollVertically(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         columnCount = int(this.listItems[0].length);
         moveBlockDistance = 0;
         visibleY = this.lockedRowCount > 0 ? this.rowInfo[this.lockedRowCount - 1].y + this.rowInfo[this.lockedRowCount - 1].height : Number(this.rowInfo[0].y);
         if(scrollUp)
         {
            ...
            {
               moveBlockDistance += this.rowInfo[i].height;
               try
               {
            ...
            while(i < rowCount)
            {
               ...
               else if(deltaPos > 0)
               {
                  ...
                  while(j < numCols)
                  {
                     ...
                     if(Boolean(r.data) && r is IDropInListItemRenderer)
                     {
            ...
            if(Boolean(this.rowInfo) && this.rowInfo.length > 0)
            {
         ...
         else
         {
            ...
            while(i < actual.y)
            {
               moveBlockDistance += this.rowInfo[this.lockedRowCount + i].height;
               i++;
            }
            ...
            while(i < this.listItems.length)
            {
               ...
               if(row.length)
               {
                  ...
                  while(j < row.length)
                  {
                     ...
                     if(!deleteRow)
                     {
                        this.rowMap[item.name].rowIndex += deltaPos;
                     }
                     j++;
                  }
               }
               ...
               if(deleteRow)
               {
                  ...
                  if(Boolean(oldRow.length) && Boolean(oldRow[0].data))
                  {
                  ...
                  {
                     if(Boolean(oldRow[j]) && Boolean(oldRow[j].data))
                     {
      ...
      protected function dragScroll() : void
      {
         ...
         if(DragManager.isDragging && this.mx_internal::lastDragEvent && _loc3_ != this.verticalScrollPosition)
         {
      ...
      public function calculateDropIndex(param1:DragEvent = null) : int
      {
         ...
         if(param1)
         {
            ...
            _loc3_ = this.listContent.globalToLocal(_loc3_);
            _loc4_ = int(this.listItems.length);
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
      ...
      protected function calculateDropIndicatorY(param1:Number, param2:int) : Number
      {
         var _loc3_:int = 0;
         var _loc4_:Number = 0;
         if(param1 && this.listItems[param2].length && Boolean(this.listItems[param2][0]))
         {
      ...
      public function showDropFeedback(param1:DragEvent) : void
      {
         ...
         if(!this.mx_internal::dropIndicator)
         {
            ...
            this.mx_internal::dropIndicator = IFlexDisplayObject(new _loc4_());
            _loc5_ = viewMetrics;
            drawFocus(true);
         ...
         this.mx_internal::dropIndicator.y = this.calculateDropIndicatorY(_loc3_,_loc2_);
      }
      ...
      public function hideDropFeedback(param1:DragEvent) : void
      {
         if(this.mx_internal::dropIndicator)
         {
            this.listContent.removeChild(DisplayObject(this.mx_internal::dropIndicator));
      ...
      public function findString(param1:String) : Boolean
      {
         ...
         if(this.selectedIndex == -1)
         {
            ...
            stopIndex = int(this.collection.length);
            i = 0;
         }
         else
         {
            ...
            try
            {
               bMovedNext = Boolean(this.iterator.moveNext());
            }
      ...
      private function findStringLoop(param1:String, param2:CursorBookmark, param3:int, param4:int) : Boolean
      {
         ...
         while(i != stopIndex)
         {
            ...
            more = Boolean(this.iterator.moveNext());
      ...
      protected function initiateDataChangeEffect(param1:Number, param2:Number) : void
      {
         ...
         var _loc6_:int = int(this.listItems.length);
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         while(_loc8_ < _loc6_)
         {
         ...
         _loc6_ = int(this.listItems.length);
         _loc8_ = 0;
         while(_loc8_ < _loc6_)
         {
            _loc11_ = this.listItems[_loc8_];
            if((Boolean(_loc11_)) && _loc11_.length > 0)
            {
               ...
               {
                  _loc13_ = _loc11_[_loc12_];
                  if((Boolean(_loc13_)) && !_loc5_[_loc13_])
                  {
      ...
      {
         var _loc3_:IListItemRenderer = null;
         var _loc1_:int = int(this.trackedRenderers.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function adjustSelectionSettings(param1:Boolean) : void
      {
         if(this.mx_internal::bSelectionChanged)
         {
            ...
            if(this.bSelectedItemChanged && (param1 || this.mx_internal::_selectedItem == null))
            {
               this.bSelectedItemChanged = false;
               this.mx_internal::bSelectedIndexChanged = false;
               this.commitSelectedItem(this.mx_internal::_selectedItem);
            }
      ...
      protected function collectionChangeHandler(param1:Event) : void
      {
         ...
         if(event is CollectionEvent)
         {
            ...
            if(ce.kind == CollectionEventKind.ADD)
            {
               ...
               if(this.mx_internal::_selectedIndex >= ce.location)
               {
                  this.mx_internal::_selectedIndex += len;
                  dispatchEvent(new FlexEvent(FlexEvent.VALUE_COMMIT));
               }
            }
            else if(ce.kind == CollectionEventKind.REPLACE)
            {
               ...
               while(i < n)
               {
                  ...
                  if(sd)
                  {
                     ...
                     {
                        this.mx_internal::_selectedItem = sd.data;
                        dispatchEvent(new FlexEvent(FlexEvent.VALUE_COMMIT));
                     }
                  }
                  i++;
            ...
            else if(ce.kind == CollectionEventKind.REMOVE)
            {
               ...
               if(Boolean(this.listItems.length) && Boolean(this.listItems[this.lockedRowCount].length))
               {
         ...
         while(_loc3_ < _loc2_)
         {
            if(this.listItems[_loc3_])
            {
               ...
               if(_loc4_)
               {
                  _loc5_ = _loc4_.data;
                  _loc1_.push(_loc5_);
                  _loc7_ = int(this.listItems[_loc3_].length);
                  _loc8_ = 0;
                  while(_loc8_ < _loc7_)
                  {
      ...
      protected function prepareDataEffect(param1:CollectionEvent) : void
      {
         ...
         if(Boolean(this.cachedDataChangeEffect) && this.iteratorValid)
         {
            _loc4_ = int(this.iterator.bookmark.getViewIndex());
      ...
      protected function adjustAfterRemove(param1:Array, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(this.mx_internal::_selectedIndex > param2)
         {
            this.mx_internal::_selectedIndex -= _loc7_;
            _loc5_ = true;
         }
         if(_loc6_ > 0 && this.mx_internal::_selectedIndex == -1)
         {
            this.mx_internal::_selectedIndex = _loc4_.index;
            this.mx_internal::_selectedItem = _loc4_.data;
            _loc5_ = true;
         }
         if(_loc6_ == 0)
         {
      ...
      protected function mouseOverHandler(param1:MouseEvent) : void
      {
         ...
         var _loc4_:Point = this.itemRendererToIndices(_loc3_);
         if(!_loc3_)
         {
            return;
         }
         var _loc5_:String = this.itemToUID(_loc3_.data);
      ...
      protected function mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         if(this.mx_internal::isPressed && this.mouseDownPoint && (Math.abs(this.mouseDownPoint.x - _loc2_.x) > mx_internal::DRAG_THRESHOLD || Math.abs(this.mouseDownPoint.y - _loc2_.y) > mx_internal::DRAG_THRESHOLD))
         {
      ...
      protected function dragEnterHandler(param1:DragEvent) : void
      {
         ...
         if(enabled && this.iteratorValid && (Boolean(param1.dragSource.hasFormat("items")) || Boolean(param1.dragSource.hasFormat("itemsByIndex"))))
         {
