package buttons.simpleButton
{
   ...
   public class InInventoryButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _embed_mxml__components_ComponentIcons_swf_CardIcoInInventory_1872280451:Class = InInventoryButtonSkin__embed_mxml__components_ComponentIcons_swf_CardIcoInInventory_1872280451;
      
      private var _213507019hostComponent:Button;
      
      public function InInventoryButtonSkin()
      {
         super();
         this.width = 30;
         this.height = 30;
         this.mxmlContent = [this._InInventoryButtonSkin_HGroup1_c(),this._InInventoryButtonSkin_HGroup2_i()];
         this.currentState = "up";
         this.addEventListener("creationComplete",this.___InInventoryButtonSkin_SparkSkin1_creationComplete);
         states = [new State({
            "name":"up",
            "overrides":[]
         }),new State({
      ...
      private function _InInventoryButtonSkin_HGroup1_c() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._InInventoryButtonSkin_Image1_c()];
         if(!_loc1_.document)
         {
      ...
      private function _InInventoryButtonSkin_Image1_c() : Image
      {
         var _loc1_:Image = new Image();
         _loc1_.source = this._embed_mxml__components_ComponentIcons_swf_CardIcoInInventory_1872280451;
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _InInventoryButtonSkin_HGroup2_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.verticalAlign = "middle";
         _loc1_.horizontalAlign = "center";
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._InInventoryButtonSkin_Ellipse1_i()];
      ...
      private function _InInventoryButtonSkin_Ellipse1_i() : Ellipse
      {
         var _loc1_:Ellipse = new Ellipse();
         _loc1_.width = 30;
         _loc1_.height = 30;
         _loc1_.fill = this._InInventoryButtonSkin_SolidColor1_c();
      ...
      private function _InInventoryButtonSkin_SolidColor1_c() : SolidColor
      {
      ...
      public function ___InInventoryButtonSkin_SparkSkin1_creationComplete(param1:FlexEvent) : void
      {
         this.config(param1);
      }
