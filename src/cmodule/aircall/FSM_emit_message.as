package cmodule.aircall
{
   ...
   public final class FSM_emit_message extends Machine
   {
      ...
      public function FSM_emit_message()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_emit_message = null;
         _loc1_ = new FSM_emit_message();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               break;
            default:
               throw "Invalid state in _emit_message";
         }
