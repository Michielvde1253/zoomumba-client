package cmodule.aircall
{
   ...
   public final class FSM___quorem_D2A extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc2_ = li32(cmodule.aircall.mstate.ebp + 12);
         ...
         else
         {
            ...
            if(_loc11_ != 0)
            {
               ...
               while(true)
               {
                  ...
                  cmodule.aircall.mstate.esp -= 16;
                  _loc21_ = li32(_loc21_);
                  si32(_loc21_,cmodule.aircall.mstate.esp);
                  si32(_loc20_,cmodule.aircall.mstate.esp + 4);
                  si32(_loc17_,cmodule.aircall.mstate.esp + 8);
                  si32(_loc13_,cmodule.aircall.mstate.esp + 12);
                  cmodule.aircall.mstate.esp -= 4;
                  cmodule.aircall.mstate.funcs[cmodule.aircall.___muldi3]();
                  _loc21_ = int(cmodule.aircall.mstate.eax);
                  _loc22_ = int(cmodule.aircall.mstate.edx);
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     si32(_loc1_,_loc5_);
                     cmodule.aircall.mstate.eax = _loc6_;
                  }
               }
            }
            _loc3_ = _loc4_;
