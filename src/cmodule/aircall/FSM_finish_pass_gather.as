package cmodule.aircall
{
   ...
   public final class FSM_finish_pass_gather extends Machine
   {
      ...
      public function FSM_finish_pass_gather()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_finish_pass_gather = null;
         _loc1_ = new FSM_finish_pass_gather();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 4:
               ...
               §§goto(addr607);
            default:
               throw "Invalid state in _finish_pass_gather";
         }
         this.i10 = 1;
         this.i8 <<= 2;
