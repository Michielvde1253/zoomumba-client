package cmodule.aircall
{
   ...
   public final class FSM___fixunssfdi extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc6_ = lf32(cmodule.aircall.mstate.ebp + 8);
         _loc5_ = _loc5_ = _loc5_;
         _loc7_ = _loc6_;
         if(_loc7_ < _loc5_)
         {
            _loc5_ = _loc5_ = _loc5_ = 0;
            _loc7_ = _loc6_;
            if(_loc7_ >= _loc5_)
            {
               _loc1_ = 0;
               ...
               _loc2_ = int(uint(_loc6_));
               si32(_loc1_,cmodule.aircall.mstate.esp);
               si32(_loc2_,cmodule.aircall.mstate.esp + 4);
               cmodule.aircall.mstate.esp -= 4;
               cmodule.aircall.mstate.funcs[cmodule.aircall.___floatdidf]();
               _loc6_ = Number(cmodule.aircall.mstate.st0);
               _loc5_ -= _loc6_;
               _loc6_ = 0;
