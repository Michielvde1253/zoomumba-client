package cmodule.aircall
{
   ...
   public final class FSM_realize_virt_arrays extends Machine
   {
      ...
      public function FSM_realize_virt_arrays()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_realize_virt_arrays = null;
         _loc1_ = new FSM_realize_virt_arrays();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
                  ...
                  if(this.i2 != 0)
                  {
                     ...
                     while(true)
                     {
                        ...
                        if(this.i5 == 0)
                        {
                           ...
                           this.i9 = this.i5 + -1;
                           this.i9 = uint(this.i9) / uint(this.i8);
                           this.i9 += 1;
                           if(this.i9 <= 1000000000)
                           {
                  ...
                  if(this.i2 != 0)
                  {
                     ...
                     while(true)
                     {
                        ...
                        if(this.i4 == 0)
                        {
                           ...
                           this.i7 = this.i4 + -1;
                           this.i7 = uint(this.i7) / uint(this.i6);
                           this.i7 += 1;
                           if(this.i7 <= 1000000000)
                           {
            ...
            case 1:
               mstate.esp += 4;
               this.i5 = 1;
               si32(this.i5,this.i2 + 40);
               addr395:
               this.i5 = 1;
               this.i8 = li32(this.i2 + 16);
               this.i9 = li32(this.i2 + 8);
               mstate.esp -= 16;
               si32(this.i0,mstate.esp);
            ...
            case 2:
               ...
               si32(this.i5,this.i2 + 20);
               this.i5 = 0;
               si32(this.i5,this.i2 + 24);
            ...
            case 4:
               ...
               §§goto(addr804);
            default:
               throw "Invalid state in _realize_virt_arrays";
         }
         this.i4 = 1;
