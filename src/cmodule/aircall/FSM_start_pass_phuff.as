package cmodule.aircall
{
   ...
   public final class FSM_start_pass_phuff extends Machine
   {
      ...
      public function FSM_start_pass_phuff()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_start_pass_phuff = null;
         _loc1_ = new FSM_start_pass_phuff();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               this.i1 = li32(this.i0 + 360);
               this.i2 = li32(mstate.ebp + 12);
               si32(this.i0,this.i1 + 32);
               si32(this.i2,this.i1 + 12);
               this.i3 = li32(this.i0 + 312);
               this.i4 = li32(this.i0 + 320);
               ...
               if(this.i4 == 0)
               {
                  if(this.i3 == 0)
                  {
                     this.i4 = cmodule.aircall._encode_mcu_DC_first;
                     this.i10 = cmodule.aircall._finish_pass_phuff;
                     this.i11 = cmodule.aircall._finish_pass_gather_phuff;
                     si32(this.i4,this.i6);
                     this.i6 = this.i2 == 0 ? this.i10 : this.i11;
                     si32(this.i6,this.i1 + 8);
                     this.i6 = li32(this.i0 + 240);
                     if(this.i6 <= 0)
                     {
                     }
                  }
                  ...
                  {
                     this.i4 = cmodule.aircall._encode_mcu_AC_first;
                     this.i10 = cmodule.aircall._finish_pass_phuff;
                     this.i11 = cmodule.aircall._finish_pass_gather_phuff;
                     si32(this.i4,this.i6);
                     this.i6 = this.i2 == 0 ? this.i10 : this.i11;
               ...
               if(this.i3 == 0)
               {
                  this.i4 = cmodule.aircall._encode_mcu_DC_refine;
                  this.i10 = cmodule.aircall._finish_pass_phuff;
                  this.i11 = cmodule.aircall._finish_pass_gather_phuff;
                  si32(this.i4,this.i6);
                  this.i6 = this.i2 == 0 ? this.i10 : this.i11;
               ...
               {
                  this.i4 = cmodule.aircall._encode_mcu_AC_refine;
                  si32(this.i4,this.i6);
                  this.i4 = cmodule.aircall._finish_pass_phuff;
                  this.i6 = cmodule.aircall._finish_pass_gather_phuff;
                  this.i10 = li32(this.i1 + 64);
                  this.i4 = this.i2 == 0 ? this.i4 : this.i6;
                  this.i6 = this.i1 + 8;
                  this.i11 = this.i1 + 64;
                  if(this.i10 == 0)
                  {
            ...
            case 2:
               ...
               while(true)
               {
                  ...
                  this.i16 = 0;
                  this.i17 = 1028;
                  memset(this.i15,this.i16,this.i17);
                  while(true)
                  {
            ...
            case 3:
               ...
               this.i16 = 0;
               memset(this.i17,this.i16,this.i15);
               §§goto(addr801);
            case 4:
               mstate.esp += 16;
               §§goto(addr801);
            default:
               throw "Invalid state in _start_pass_phuff";
         }
         continue loop0;
      }
   }
