package cmodule.aircall
{
   ...
   public final class FSM_emit_dqt extends Machine
   {
      ...
      {
         var _loc1_:FSM_emit_dqt = null;
         _loc1_ = new FSM_emit_dqt();
      ...
      final override public function work() : void
      {
         switch(state)
         {
               ...
               if(this.i2 != 0)
               {
                  ...
                  while(this.i3 <= 63)
                  {
                     while(true)
                     {
                        ...
                        this.i4 = uint(this.i5) > uint(255) ? 1 : this.i4;
                        this.i3 += 1;
                        continue loop0;
                     }
                  }
                  this.i3 = li32(this.i2 + 128);
                  this.i5 = this.i2 + 128;
                  if(this.i3 == 0)
                  {
                     this.i3 = 219;
            ...
            case 3:
               ...
               if(this.i4 != 0)
               {
                  this.i7 = cmodule.aircall._jpeg_natural_order;
                  this.i8 = 0;
                  loop3:
                  while(true)
                  {
            ...
            case 11:
               ...
               §§goto(addr1090);
            default:
               throw "Invalid state in _emit_dqt";
         }
         mstate.eax = this.i4;
