package cmodule.aircall
{
   ...
   public final class FSM_emit_2bytes extends Machine
   {
      ...
      public function FSM_emit_2bytes()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_emit_2bytes = null;
         _loc1_ = new FSM_emit_2bytes();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 4:
               ...
               break;
            default:
               throw "Invalid state in _emit_2bytes";
         }
