      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 1:
               ...
               this.i2 = li32(cmodule.aircall._fpi_2E_3615);
               this.i1 -= this.i2;
               ...
               else if(this.i2 == 53)
               {
                  if(this.i5 != 0)
                  {
                     this.i6 = li32(cmodule.aircall._fpi_2E_3615 + 12);
                     if(this.i6 != 1)
                     {
                     }
                     §§goto(addr228);
                     ...
                     if(this.i6 >= 0)
                     {
                        if(this.i1 == 1)
                        {
                           if(this.i5 != 0)
                           {
                              ...
                              this.i10 = this.i1;
                              this.i1 = li32(cmodule.aircall._fpi_2E_3615 + 4);
                              ...
                              if(this.i1 <= this.i11)
                              {
                                 ...
                                 this.i6 = this.i10;
                                 addr824:
                                 this.i5 = li32(cmodule.aircall._fpi_2E_3615 + 8);
                                 if(this.i5 >= this.i1)
                                 {
                                    break;
                                 }
                                 ...
                                 this.i6 = 34;
                                 si32(this.i6,cmodule.aircall._val_2E_1440);
                                 this.i6 = 0;
                              ...
                              if(this.i1 <= this.i2)
                              {
                                 this.i9 = li32(cmodule.aircall._fpi_2E_3615 + 16);
                                 if(this.i9 == 0)
                                 {
                                    this.i9 = this.i1 + -1;
                                    if(this.i9 >= 1)
            ...
            case 5:
               ...
               this.i1 += 1;
               si32(this.i1,mstate.ebp + -4);
               this.i9 = li32(cmodule.aircall._fpi_2E_3615 + 4);
               this.i6 &= 1;
               if(this.i9 <= this.i1)
               {
                  this.i6 = 32;
         ...
         if(this.i0 != 0)
         {
            this.i6 = cmodule.aircall._freelist;
