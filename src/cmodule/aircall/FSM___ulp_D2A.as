package cmodule.aircall
{
   ...
   public final class FSM___ulp_D2A extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         {
            _loc1_ = 0;
            si32(_loc1_,cmodule.aircall.mstate.ebp + -8);
            si32(_loc2_,cmodule.aircall.mstate.ebp + -4);
            _loc4_ = lf64(cmodule.aircall.mstate.ebp + -8);
         }
         else
         {
            ...
            if(_loc1_ <= 19)
            {
               ...
               si32(_loc3_,cmodule.aircall.mstate.ebp + -16);
               si32(_loc1_,cmodule.aircall.mstate.ebp + -12);
               _loc4_ = lf64(cmodule.aircall.mstate.ebp + -16);
            }
            else
            {
               _loc2_ = _loc1_ + -20;
               if(_loc2_ <= 30)
               {
                  ...
                  _loc3_ = 0;
                  _loc1_ = _loc2_ << _loc1_;
                  si32(_loc1_,cmodule.aircall.mstate.ebp + -24);
                  si32(_loc3_,cmodule.aircall.mstate.ebp + -20);
                  _loc4_ = lf64(cmodule.aircall.mstate.ebp + -24);
               }
               else
               {
                  _loc4_ = 4.9e-324;
         ...
         cmodule.aircall.mstate.st0 = _loc4_;
