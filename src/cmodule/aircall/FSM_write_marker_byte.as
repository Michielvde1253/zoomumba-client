package cmodule.aircall
{
   ...
   public final class FSM_write_marker_byte extends Machine
   {
      ...
      public function FSM_write_marker_byte()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_write_marker_byte = null;
         _loc1_ = new FSM_write_marker_byte();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               break;
            default:
               throw "Invalid state in _write_marker_byte";
         }
