package cmodule.aircall
{
   ...
   public final class FSM_compress_output3 extends Machine
   {
      ...
      public function FSM_compress_output3()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_compress_output3 = null;
         _loc1_ = new FSM_compress_output3();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i2 = li32(this.i1 + 340);
               this.i3 = li32(this.i1 + 240);
               this.i4 = this.i1 + 240;
               this.i5 = this.i2;
               this.i6 = this.i1;
               if(this.i3 < 1)
               {
                  ...
                  if(this.i7 > this.i3)
                  {
                     this.i7 = 0;
                     this.i10 = this.i5 + 24;
                     this.i11 = this.i1 + 360;
                     this.i12 = this.i1 + 260;
                     this.i13 = this.i5 + 12;
                     this.i14 = this.i3;
                     loop0:
                     while(true)
                     {
                        ...
                        if(uint(this.i16) > uint(this.i15))
                        {
                           this.i16 = 0;
                           this.i17 = this.i15;
                           §§goto(addr369);
            ...
            case 1:
               ...
               if(this.i11 > this.i3)
               {
                  addr97:
                  this.i11 = 0;
                  this.i12 = this.i6 + this.i10;
                  this.i12 = li32(this.i12 + 244);
            ...
            case 2:
               ...
               if(this.i18 != 0)
               {
                  ...
                  this.i16 += 128;
                  this.i17 += 1;
                  if(uint(this.i18) <= uint(this.i17))
                  {
                     §§goto(addr771);
                  }
                  addr369:
                  ...
                  if(this.i18 >= 1)
                  {
                     ...
                     do
                     {
                        this.i21 = this.i6 + this.i19;
                        this.i21 = li32(this.i21 + 244);
                        this.i22 = li32(this.i21 + 52);
                        this.i23 = li32(this.i21 + 56);
                        this.i24 = this.i21 + 56;
                        this.i21 += 52;
                        if(this.i23 > 0)
                        {
                           this.i23 = 0;
                           this.i25 = this.i3 << 2;
                           this.i25 = this.i7 + this.i25;
                           this.i26 = this.i0 + this.i19;
                           this.i27 = this.i22;
                           do
                           {
                              ...
                              if(this.i27 > 0)
                              {
                                 ...
                                 this.i29 = this.i15 << 7;
                                 this.i30 = this.i18 << 2;
                                 this.i29 = this.i16 + this.i29;
                                 this.i30 = this.i2 + this.i30;
                                 this.i29 = this.i22 * this.i29;
                                 this.i28 += this.i29;
                                 this.i29 = this.i30 + 24;
                                 do
                                 {
                                    si32(this.i28,this.i29);
                                    this.i30 = li32(this.i21);
                                    this.i28 += 128;
                                    this.i29 += 4;
                                    this.i27 += 1;
                                 }
                              ...
                              this.i28 = li32(this.i24);
                              this.i25 += 4;
                              this.i23 += 1;
                           }
                           while(this.i28 > this.i23);
            ...
            case 3:
               break;
            default:
               throw "Invalid state in _compress_output3";
         }
         mstate.esp += 4;
         mstate.eax = this.i0;
         addr718:
