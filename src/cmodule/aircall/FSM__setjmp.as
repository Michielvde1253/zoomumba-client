package cmodule.aircall
{
   ...
   public class FSM__setjmp extends Machine
   {
      ...
      {
         cmodule.aircall.gstate.gworker = new FSM__setjmp();
      ...
      override public function work() : void
      {
         ...
         if(_loc2_)
         {
            delete cmodule.aircall.gsetjmpMachine2ESPMap[_loc2_];
         }
         cmodule.aircall.gsetjmpMachine2ESPMap[caller] = mstate.esp;
