package cmodule.aircall
{
   ...
   public final class FSM_argb_ycc_start extends Machine
   {
      ...
      public function FSM_argb_ycc_start()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_argb_ycc_start = null;
         _loc1_ = new FSM_argb_ycc_start();
         ...
         switch(state)
         {
            ...
            case 1:
               ...
               do
               {
                  ...
                  si32(this.i4,this.i0 + 1024);
                  si32(this.i1,this.i0 + 2048);
                  si32(this.i8,this.i0 + 3072);
                  si32(this.i6,this.i0 + 4096);
                  si32(this.i2,this.i0 + 5120);
                  si32(this.i5,this.i0 + 6144);
                  si32(this.i9,this.i0 + 7168);
                  this.i4 += 38470;
                  this.i2 += 32768;
                  this.i5 += -27439;
                  this.i6 += -21709;
               ...
               return;
            default:
               throw "Invalid state in _argb_ycc_start";
         }
      }
   }
}
