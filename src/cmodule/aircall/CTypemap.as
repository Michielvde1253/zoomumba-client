package cmodule.aircall
{
   ...
   internal class CTypemap
   {
      ...
      public function writeValue(param1:int, param2:*) : void
      {
         ...
         cmodule.aircall.mstate.ds.position = param1;
         _loc4_ = 0;
         while(_loc4_ < _loc3_.length)
         {
            cmodule.aircall.mstate.ds.writeInt(_loc3_[_loc4_]);
            _loc4_++;
         }
      }
      ...
      public function readValue(param1:int) : *
      {
         ...
         {
            _loc2_.push(cmodule.aircall.mstate.ds.readInt());
            _loc3_++;
         }
