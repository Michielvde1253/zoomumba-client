package cmodule.aircall
{
   ...
   public final class FSM_request_virt_sarray extends Machine
   {
      ...
      public function FSM_request_virt_sarray()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_request_virt_sarray = null;
         _loc1_ = new FSM_request_virt_sarray();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               return;
            default:
               throw "Invalid state in _request_virt_sarray";
         }
         this.i7 = 128;
         mstate.esp -= 12;
         si32(this.i0,mstate.esp);
