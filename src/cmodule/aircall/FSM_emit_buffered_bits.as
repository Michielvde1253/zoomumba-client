package cmodule.aircall
{
   ...
   public final class FSM_emit_buffered_bits extends Machine
   {
      ...
      public function FSM_emit_buffered_bits()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_emit_buffered_bits = null;
         _loc1_ = new FSM_emit_buffered_bits();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 4:
               ...
               §§goto(addr585);
            default:
               throw "Invalid state in _emit_buffered_bits";
         }
         continue loop0;
      }
   }
