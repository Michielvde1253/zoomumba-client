package cmodule.aircall
{
   ...
   public final class FSM_emit_eobrun extends Machine
   {
      ...
      public function FSM_emit_eobrun()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_emit_eobrun = null;
         _loc1_ = new FSM_emit_eobrun();
         ...
         switch(state)
         {
            ...
            case 1:
               ...
               else
               {
                  this.i3 <<= 2;
                  this.i3 = this.i0 + this.i3;
                  this.i3 = li32(this.i3 + 76);
                  this.i4 = this.i6 << 2;
                  this.i6 = this.i3 + this.i6;
                  this.i6 = li8(this.i6 + 1024);
                  this.i3 += this.i4;
                  this.i4 = this.i6 << 24;
                  ...
                  {
                     this.i9 = 40;
                     this.i10 = li32(this.i0 + 32);
                     this.i10 = li32(this.i10);
                     si32(this.i9,this.i10 + 20);
                     this.i9 = li32(this.i0 + 32);
            ...
            case 9:
               ...
               addr1515:
               this.i9 = li32(this.i10);
               si32(this.i9,this.i8);
               this.i9 = li32(this.i10 + 4);
               si32(this.i9,this.i5);
               §§goto(addr1537);
               break;
            case 10:
            ...
            case 11:
               ...
               return;
            default:
               throw "Invalid state in _emit_eobrun";
         }
         continue loop2;
      }
   }
