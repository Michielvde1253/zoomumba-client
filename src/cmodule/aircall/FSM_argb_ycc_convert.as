package cmodule.aircall
{
   ...
   public final class FSM_argb_ycc_convert extends Machine
   {
      public function FSM_argb_ycc_convert()
      {
         super();
      }
            ...
            if(_loc1_ != 0)
            {
               ...
               do
               {
                  ...
                  do
                  {
                     ...
                     _loc18_ = _loc15_ | 0x0100;
                     _loc19_ = _loc17_ | 0x0200;
                     _loc18_ <<= 2;
                     _loc20_ = _loc16_ << 2;
                     _loc19_ <<= 2;
                     _loc18_ = _loc2_ + _loc18_;
                     _loc20_ = _loc2_ + _loc20_;
                     _loc20_ = li32(_loc20_);
                     _loc18_ = li32(_loc18_);
                     _loc19_ = _loc2_ + _loc19_;
                     _loc19_ = li32(_loc19_);
                     _loc18_ += _loc20_;
                     _loc20_ = _loc15_ | 0x0400;
                     _loc21_ = _loc16_ | 0x0300;
                     _loc18_ += _loc19_;
                     _loc19_ = _loc17_ | 0x0500;
                     _loc20_ <<= 2;
                     _loc21_ <<= 2;
                     _loc22_ = _loc11_ + _loc10_;
                     _loc18_ >>>= 16;
                     _loc19_ <<= 2;
                     si8(_loc18_,_loc22_);
                     _loc18_ = _loc2_ + _loc20_;
                     _loc20_ = _loc2_ + _loc21_;
                     _loc19_ = _loc2_ + _loc19_;
                     _loc20_ = li32(_loc20_);
                     _loc18_ = li32(_loc18_);
                     _loc19_ = li32(_loc19_);
                     ...
                     _loc15_ <<= 2;
                     _loc16_ <<= 2;
                     _loc19_ = _loc13_ + _loc10_;
                     _loc18_ >>>= 16;
                     _loc17_ <<= 2;
                     si8(_loc18_,_loc19_);
                     _loc15_ = _loc2_ + _loc15_;
                     _loc16_ = _loc2_ + _loc16_;
                     _loc17_ = _loc2_ + _loc17_;
                     _loc16_ = li32(_loc16_);
                     _loc15_ = li32(_loc15_);
                     _loc17_ = li32(_loc17_);
                     _loc15_ += _loc16_;
                     _loc15_ = _loc15_ + _loc17_;
                  ...
                  while(uint(_loc10_) < uint(_loc1_));
