package cmodule.aircall
{
   ...
   public final class FSM___divdi3 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc9_ = int(__adde(_loc3_,_loc7_));
         ...
         si32(_loc9_,cmodule.aircall.mstate.esp + 12);
         si32(_loc1_,cmodule.aircall.mstate.esp + 16);
         cmodule.aircall.mstate.esp -= 4;
         FSM___qdivrem.start();
         _loc1_ = int(cmodule.aircall.mstate.eax);
         _loc4_ = int(cmodule.aircall.mstate.edx);
         cmodule.aircall.mstate.esp += 20;
         _loc2_ >>>= 31;
         _loc3_ >>>= 31;
         if(_loc2_ != _loc3_)
         {
            ...
            _loc4_ = int(__sube(_loc2_,_loc4_));
         }
         cmodule.aircall.mstate.edx = _loc4_;
