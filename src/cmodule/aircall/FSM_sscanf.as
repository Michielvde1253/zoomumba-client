package cmodule.aircall
{
   ...
   public final class FSM_sscanf extends Machine
   {
      ...
      {
         var _loc1_:FSM_sscanf = null;
         _loc1_ = new FSM_sscanf();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i0 = this.i1;
               this.i1 = cmodule.aircall._eofread;
               this.i0 -= this.i2;
               si32(this.i0,mstate.ebp + -92);
               si32(this.i0,mstate.ebp + -76);
               si32(this.i1,mstate.ebp + -60);
               this.i0 = 0;
            ...
            case 1:
               ...
               return;
            default:
               throw "Invalid state in _sscanf";
         }
      }
   }
}
