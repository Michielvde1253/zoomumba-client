package cmodule.aircall
{
   ...
   public final class FSM_start_pass_coef2 extends Machine
   {
      ...
      public function FSM_start_pass_coef2()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_start_pass_coef2 = null;
         _loc1_ = new FSM_start_pass_coef2();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 1:
               ...
               if(this.i0 != 3)
               {
                  if(this.i0 != 2)
                  {
                     ...
                     addr177:
                     this.i1 = cmodule.aircall._compress_data;
                  }
                  else
                  {
                     this.i0 = li32(this.i2 + 64);
                     ...
                     addr378:
                     this.i1 = cmodule.aircall._compress_output3;
                  }
               }
               else
               {
                  ...
                  addr261:
                  this.i1 = cmodule.aircall._compress_first_pass;
               }
            ...
            case 5:
               ...
               break;
            default:
               throw "Invalid state in _start_pass_coef2";
         }
