package cmodule.aircall
{
   ...
   public final class FSM_pass_startup extends Machine
   {
      ...
      public function FSM_pass_startup()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_pass_startup = null;
         _loc1_ = new FSM_pass_startup();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               return;
            default:
               throw "Invalid state in _pass_startup";
         }
      }
   }
}
