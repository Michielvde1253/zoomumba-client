package cmodule.aircall
{
   ...
   public final class FSM_forward_DCT_float extends Machine
   {
      ...
      public function FSM_forward_DCT_float()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_forward_DCT_float = null;
         _loc1_ = new FSM_forward_DCT_float();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i2 = li32(this.i2 + 356);
               this.i1 <<= 2;
               this.i1 = this.i2 + this.i1;
               this.i2 = li32(this.i2 + 28);
               this.i1 = li32(this.i1 + 32);
            ...
            case 1:
               ...
               {
                  this.f0 = 16384.5;
                  this.i13 = this.i1 + this.i11;
                  this.i14 = this.i0 + this.i11;
                  this.f1 = lf32(this.i14);
                  this.f2 = lf32(this.i13);
                  this.f1 *= this.f2;
                  this.f1 = this.f1;
                  this.f0 = this.f0;
                  this.f0 = this.f0;
               ...
               if(uint(this.i8) < uint(this.i7))
               {
                  ...
                  do
                  {
                     ...
                     this.i21 = this.i20 + this.i6;
                     this.i21 = li8(this.i21);
                     this.i21 += -128;
                     this.f0 = Number(this.i21);
                     ...
                     this.i21 = this.i20 + this.i17;
                     this.i21 = li8(this.i21);
                     this.i21 += -128;
                     this.f0 = Number(this.i21);
                     sf32(this.f0,this.i19 + 8);
                     this.i21 = this.i20 + this.i16;
                     this.i21 = li8(this.i21);
                     this.i21 += -128;
                     this.f0 = Number(this.i21);
                     sf32(this.f0,this.i19 + 12);
                     this.i21 = this.i20 + this.i15;
                     this.i21 = li8(this.i21);
                     this.i21 += -128;
                     this.f0 = Number(this.i21);
                     sf32(this.f0,this.i19 + 16);
                     this.i21 = this.i20 + this.i14;
                     this.i21 = li8(this.i21);
                     this.i21 += -128;
                     this.f0 = Number(this.i21);
                     sf32(this.f0,this.i19 + 20);
                     this.i21 = this.i20 + this.i13;
                     this.i21 = li8(this.i21);
                     this.i21 += -128;
                     this.f0 = Number(this.i21);
                     sf32(this.f0,this.i19 + 24);
                     this.i20 += this.i12;
                     this.i20 = li8(this.i20);
                     this.i20 += -128;
                     this.f0 = Number(this.i20);
                     sf32(this.f0,this.i19 + 28);
                     this.i19 += 32;
                     this.i11 += 4;
                     this.i10 += 1;
                  }
               ...
               break;
            default:
               throw "Invalid state in _forward_DCT_float";
         }
