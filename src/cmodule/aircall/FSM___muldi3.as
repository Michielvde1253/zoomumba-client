package cmodule.aircall
{
   ...
   public final class FSM___muldi3 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc8_ = int(__adde(_loc2_,_loc6_));
         _loc1_ >>>= 31;
         _loc7_ ^= _loc4_;
         _loc3_ ^= _loc4_;
         _loc2_ >>>= 31;
         ...
         if(_loc7_ == 0)
         {
            if(_loc4_ == 0)
            {
               ...
               si32(_loc5_,cmodule.aircall.mstate.esp + 4);
               cmodule.aircall.mstate.esp -= 4;
               FSM___lmulq.start();
               ...
               if(_loc1_ != _loc2_)
               {
                  ...
                  cmodule.aircall.mstate.eax = _loc3_;
               }
               §§goto(addr453);
            }
            §§goto(addr439);
         ...
         cmodule.aircall.mstate.esp -= 4;
         FSM___lmulq.start();
         _loc5_ = int(cmodule.aircall.mstate.eax);
         _loc6_ = int(cmodule.aircall.mstate.edx);
         _loc3_ += _loc4_;
         _loc3_ += _loc5_;
         cmodule.aircall.mstate.esp += 8;
