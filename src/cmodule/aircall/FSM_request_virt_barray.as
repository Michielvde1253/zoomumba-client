package cmodule.aircall
{
   ...
   public final class FSM_request_virt_barray extends Machine
   {
      ...
      public function FSM_request_virt_barray()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_request_virt_barray = null;
         _loc1_ = new FSM_request_virt_barray();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 2:
               ...
               this.i2 = li32(this.i1 + 72);
               si32(this.i2,this.i0 + 44);
               si32(this.i0,this.i1 + 72);
               mstate.eax = this.i0;
               ...
               return;
            default:
               throw "Invalid state in _request_virt_barray";
         }
         this.i7 = 128;
         mstate.esp -= 12;
         si32(this.i0,mstate.esp);
