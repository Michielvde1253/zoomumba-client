package cmodule.aircall
{
   ...
   public final class FSM_sep_downsample extends Machine
   {
      ...
      public function FSM_sep_downsample()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_sep_downsample = null;
         _loc1_ = new FSM_sep_downsample();
         ...
         switch(state)
         {
            ...
            case 1:
               ...
               if(this.i10 > this.i3)
               {
                  ...
                  this.i11 = this.i1 + this.i9;
                  this.i12 = this.i5 + this.i9;
                  this.i13 = this.i4 + this.i9;
                  this.i10 *= this.i8;
               ...
               break;
            default:
               throw "Invalid state in _sep_downsample";
         }
