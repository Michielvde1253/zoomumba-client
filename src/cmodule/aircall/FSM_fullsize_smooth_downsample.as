package cmodule.aircall
{
   ...
   public final class FSM_fullsize_smooth_downsample extends Machine
   {
      public function FSM_fullsize_smooth_downsample()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         if(_loc9_ >= 1)
         {
            if(_loc4_ >= 1)
            {
               ...
               if(_loc9_ >= 1)
               {
                  ...
                  while(_loc9_ += 1, _loc9_ < _loc4_);
                  
               }
            }
         }
         _loc2_ = li32(_loc3_ + 188);
         ...
         if(_loc3_ >= 1)
         {
            ...
            do
            {
               ...
               _loc14_ = li8(_loc11_ + 1);
               _loc16_ = li8(_loc12_ + 1);
               _loc17_ = _loc13_ << 1;
               _loc18_ = li8(_loc10_ + 1);
               _loc14_ = _loc16_ + _loc14_;
               _loc16_ = _loc17_ - _loc15_;
               _loc14_ += _loc18_;
               _loc16_ += _loc14_;
               _loc16_ = _loc16_ * _loc2_;
               _loc15_ *= _loc4_;
               ...
               _loc15_ = _loc15_ >>> 16;
               si8(_loc15_,_loc16_);
               _loc15_ = li8(_loc10_ + 1);
               _loc17_ = _loc16_;
               while(true)
               {
                  _loc18_ = _loc14_;
                  _loc14_ = _loc15_;
                  _loc15_ = _loc12_ + _loc9_;
                  _loc19_ = _loc11_ + _loc9_;
                  _loc19_ = li8(_loc19_ + 2);
                  _loc15_ = li8(_loc15_ + 2);
                  _loc20_ = _loc10_ + _loc9_;
                  _loc21_ = li8(_loc20_ + 2);
                  _loc15_ += _loc19_;
                  _loc13_ += _loc18_;
                  _loc13_ = _loc13_ - _loc14_;
                  _loc15_ += _loc21_;
                  _loc13_ += _loc15_;
                  _loc13_ = _loc13_ * _loc2_;
                  _loc14_ *= _loc4_;
                  _loc13_ = _loc14_ + _loc13_;
                  _loc13_ = _loc13_ + 32768;
                  _loc13_ = _loc13_ >>> 16;
                  _loc14_ = _loc16_ + _loc9_;
                  si8(_loc13_,_loc14_ + 1);
               ...
               _loc10_ = _loc15_ << 1;
               _loc11_ = _loc18_ - _loc19_;
               _loc10_ = _loc11_ + _loc10_;
               _loc10_ = _loc10_ * _loc2_;
               _loc11_ = _loc19_ * _loc4_;
               _loc10_ = _loc11_ + _loc10_;
               _loc10_ = _loc10_ + 32768;
               _loc9_ += _loc17_;
               _loc10_ >>>= 16;
               si8(_loc10_,_loc9_ + 1);
               _loc9_ = li32(_loc1_);
               _loc6_ += 4;
               _loc3_ += 1;
            }
