package cmodule.aircall
{
   ...
   public final class FSM_emit_restart extends Machine
   {
      ...
      public function FSM_emit_restart()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_emit_restart = null;
         _loc1_ = new FSM_emit_restart();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 6:
               ...
               §§goto(addr533);
            default:
               throw "Invalid state in _emit_restart";
         }
