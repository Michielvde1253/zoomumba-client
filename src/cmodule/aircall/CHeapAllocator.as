package cmodule.aircall
{
   internal class CHeapAllocator implements ICAllocator
   {
      ...
      public function free(param1:int) : void
      {
         if(this.pfree == null)
         {
            this.pfree = new CProcTypemap(CTypemap.VoidType,[CTypemap.PtrType]).fromC([cmodule.aircall._free]);
         }
         this.pfree(param1);
      }
      ...
      public function alloc(param1:int) : int
      {
         ...
         {
            this.pmalloc = new CProcTypemap(CTypemap.PtrType,[CTypemap.IntType]).fromC([cmodule.aircall._malloc]);
         }
