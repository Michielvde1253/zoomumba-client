package cmodule.aircall
{
   ...
   public final class FSM_jpeg_fdct_islow extends Machine
   {
      public function FSM_jpeg_fdct_islow()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         do
         {
            ...
            _loc14_ = _loc10_ + _loc4_;
            _loc15_ = _loc12_ + _loc11_;
            _loc17_ *= 6270;
            _loc9_ *= 4433;
            _loc17_ += _loc9_;
            ...
            _loc8_ *= -16069;
            _loc12_ = _loc13_ * 9633;
            _loc13_ = _loc14_ * -7373;
            _loc10_ *= 2446;
            _loc14_ = _loc15_ << 2;
            _loc15_ = _loc17_ + 1024;
         ...
         {
            _loc3_ = li32(_loc2_);
            _loc4_ = li32(_loc2_ + 224);
            _loc5_ = li32(_loc2_ + 32);
            _loc6_ = li32(_loc2_ + 192);
            _loc7_ = li32(_loc2_ + 64);
            _loc8_ = li32(_loc2_ + 160);
            _loc9_ = li32(_loc2_ + 96);
            _loc10_ = li32(_loc2_ + 128);
            _loc11_ = _loc10_ + _loc9_;
            _loc12_ = _loc4_ + _loc3_;
            _loc13_ = _loc8_ + _loc7_;
            _loc14_ = _loc6_ + _loc5_;
            _loc15_ = _loc14_ - _loc13_;
            _loc16_ = _loc12_ - _loc11_;
            _loc13_ += _loc14_;
            _loc11_ += _loc12_;
            _loc9_ -= _loc10_;
            _loc5_ -= _loc6_;
            ...
            _loc9_ *= 2446;
            _loc4_ >>= 2;
            _loc14_ = _loc16_ + 16384;
            _loc10_ = _loc15_ + _loc10_;
            _loc7_ *= -3196;
            si32(_loc4_,_loc2_);
            _loc4_ = _loc11_ >> 2;
            _loc9_ += _loc13_;
            _loc8_ = _loc12_ + _loc8_;
            _loc11_ = _loc17_ * -20995;
            _loc6_ *= 16819;
            _loc10_ += 16384;
            _loc9_ += _loc8_;
            _loc5_ *= 25172;
            si32(_loc4_,_loc2_ + 128);
            _loc4_ = _loc14_ >> 15;
            _loc6_ += _loc11_;
            _loc7_ = _loc12_ + _loc7_;
            _loc9_ += 16384;
            _loc6_ += _loc7_;
            _loc5_ += _loc11_;
            _loc3_ *= 12299;
            si32(_loc4_,_loc2_ + 64);
            _loc4_ = _loc10_ >> 15;
            _loc6_ += 16384;
            _loc5_ += _loc8_;
            _loc3_ += _loc13_;
            si32(_loc4_,_loc2_ + 192);
            _loc4_ = _loc9_ >> 15;
            _loc5_ += 16384;
            _loc3_ += _loc7_;
            si32(_loc4_,_loc2_ + 224);
            _loc4_ = _loc6_ >> 15;
            _loc3_ += 16384;
            si32(_loc4_,_loc2_ + 160);
            _loc4_ = _loc5_ >> 15;
            si32(_loc4_,_loc2_ + 96);
            _loc3_ >>= 15;
            si32(_loc3_,_loc2_ + 32);
            _loc2_ += 4;
            _loc1_ += 1;
         }
         while(_loc1_ != 8);
