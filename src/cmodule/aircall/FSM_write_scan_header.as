package cmodule.aircall
{
   ...
   public final class FSM_write_scan_header extends Machine
   {
      ...
      public function FSM_write_scan_header()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_write_scan_header = null;
         _loc1_ = new FSM_write_scan_header();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
               ...
               if(this.i1 >= 1)
               {
                  ...
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        ...
                        this.i11 = li32(this.i13 + 4);
                        this.i11 += -1;
                        si32(this.i11,this.i13 + 4);
                        if(this.i11 == 0)
                        {
                           this.i11 = li32(this.i13 + 12);
                           mstate.esp -= 4;
                           si32(this.i0,mstate.esp);
                           state = 14;
                           mstate.esp -= 4;
            ...
            case 21:
               ...
               break;
            default:
               throw "Invalid state in _write_scan_header";
         }
