package cmodule.aircall
{
   ...
   public final class FSM_init_destination extends Machine
   {
      ...
      public function FSM_init_destination()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_init_destination = null;
         _loc1_ = new FSM_init_destination();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 1:
               ...
               return;
            default:
               throw "Invalid state in _init_destination";
         }
      }
   }
}
