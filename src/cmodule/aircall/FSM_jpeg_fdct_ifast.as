package cmodule.aircall
{
   ...
   public final class FSM_jpeg_fdct_ifast extends Machine
   {
      public function FSM_jpeg_fdct_ifast()
      {
         super();
      }
