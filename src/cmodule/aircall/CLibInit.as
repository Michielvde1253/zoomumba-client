package cmodule.aircall
{
   ...
   public class CLibInit
   {
      ...
      public function init() : *
      {
         ...
         cmodule.aircall.mstate.copyTo(saveState);
         try
         {
            try
            {
         ...
         {
            saveState.copyTo(cmodule.aircall.mstate);
            if(!regged)
            {
      ...
      {
         cmodule.aircall.gfiles[param1] = param2;
      }
      
      public function putEnv(param1:String, param2:String) : void
      {
         cmodule.aircall.genv[param1] = param2;
      }
      
      public function setSprite(param1:Sprite) : void
      {
         cmodule.aircall.gsprite = param1;
      }
   }
}
