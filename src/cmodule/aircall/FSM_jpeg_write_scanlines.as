package cmodule.aircall
{
   ...
   public final class FSM_jpeg_write_scanlines extends Machine
   {
      ...
      public function FSM_jpeg_write_scanlines()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_jpeg_write_scanlines = null;
         _loc1_ = new FSM_jpeg_write_scanlines();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 5:
               ...
               return;
            default:
               throw "Invalid state in _jpeg_write_scanlines";
         }
         this.i2 = 0;
         ...
         mstate.esp -= 16;
         this.i3 = this.i3 == this.i4 ? this.i6 : 1;
