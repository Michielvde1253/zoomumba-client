package cmodule.aircall
{
   ...
   internal class CStrUTF8Buffer extends CBuffer
   {
      ...
      public function CStrUTF8Buffer(param1:int, param2:Boolean = true, param3:ICAllocator = null)
      {
         super(param1,param3);
      ...
      override protected function computeValue() : *
      {
         var _loc1_:int = 0;
         _loc1_ = 0;
         var _loc2_:int = int(this.size);
         cmodule.aircall.mstate.ds.position = this.ptr;
         while(Boolean(_loc2_--) && cmodule.aircall.mstate.ds.readByte() != 0)
         {
            _loc1_++;
         }
         cmodule.aircall.mstate.ds.position = this.ptr;
         return cmodule.aircall.mstate.ds.readUTFBytes(_loc1_);
      }
      ...
      override protected function setValue(param1:*) : void
      {
         ...
         _loc2_.position = 0;
         _loc2_.readBytes(cmodule.aircall.mstate.ds,this.ptr);
      }
   }
}
