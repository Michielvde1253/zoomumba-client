package cmodule.aircall
{
   ...
   public final class FSM___b2d_D2A extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc8_ <<= _loc9_;
         _loc9_ = li32(cmodule.aircall.mstate.ebp + 12);
         if(_loc8_ > -1)
         {
            _loc8_ &= 1073741824;
            _loc7_ += 1;
         ...
         _loc2_ = _loc4_;
         _loc1_ |= 1072693248;
         si32(_loc2_,cmodule.aircall.mstate.ebp + -8);
         si32(_loc1_,cmodule.aircall.mstate.ebp + -4);
         _loc11_ = lf64(cmodule.aircall.mstate.ebp + -8);
         cmodule.aircall.mstate.st0 = _loc11_;
