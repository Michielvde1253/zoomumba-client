package cmodule.aircall
{
   ...
   public final class FSM_jpeg_set_defaults extends Machine
   {
      ...
      public function FSM_jpeg_set_defaults()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_jpeg_set_defaults = null;
         _loc1_ = new FSM_jpeg_set_defaults();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 3:
               mstate.esp += 16;
               mstate.esp -= 16;
               this.i1 = cmodule.aircall._std_chrominance_quant_tbl_2E_3096;
               this.i5 = 1;
               si32(this.i0,mstate.esp);
               si32(this.i5,mstate.esp + 4);
               si32(this.i1,mstate.esp + 8);
            ...
            case 4:
               mstate.esp += 16;
               mstate.esp -= 16;
               this.i1 = cmodule.aircall._bits_dc_luminance_2E_3139;
               this.i2 = cmodule.aircall._val_dc_luminance_2E_3140;
               this.i5 = this.i0 + 84;
               si32(this.i0,mstate.esp);
               si32(this.i5,mstate.esp + 4);
               si32(this.i1,mstate.esp + 8);
               ...
               state = 5;
               mstate.esp -= 4;
               FSM_add_huff_table.start();
               return;
            case 5:
               mstate.esp += 16;
               mstate.esp -= 16;
               this.i1 = cmodule.aircall._bits_ac_luminance_2E_3143;
               this.i5 = cmodule.aircall._val_ac_luminance_2E_3144;
               this.i6 = this.i0 + 100;
               si32(this.i0,mstate.esp);
            ...
            case 6:
               mstate.esp += 16;
               mstate.esp -= 16;
               this.i1 = cmodule.aircall._bits_dc_chrominance_2E_3141;
               this.i5 = this.i0 + 88;
               si32(this.i0,mstate.esp);
               si32(this.i5,mstate.esp + 4);
               si32(this.i1,mstate.esp + 8);
            ...
            case 7:
               mstate.esp += 16;
               mstate.esp -= 16;
               this.i1 = cmodule.aircall._bits_ac_chrominance_2E_3145;
               this.i2 = cmodule.aircall._val_ac_chrominance_2E_3146;
               this.i5 = this.i0 + 104;
               si32(this.i0,mstate.esp);
               si32(this.i5,mstate.esp + 4);
               si32(this.i1,mstate.esp + 8);
            ...
            case 8:
               ...
               do
               {
                  ...
                  si8(this.i4,this.i5 + 116);
                  this.i4 = 1;
                  si8(this.i4,this.i5 + 132);
                  this.i4 = 5;
                  si8(this.i4,this.i5 + 148);
                  this.i2 += 1;
               }
               while(this.i2 != 16);
               ...
               si32(this.i2,this.i0 + 164);
               si32(this.i2,this.i0 + 172);
               ...
               si32(this.i1,this.i0 + 196);
               si32(this.i1,this.i0 + 200);
               this.i2 = 1;
               si8(this.i2,this.i0 + 208);
               si8(this.i2,this.i0 + 209);
               si8(this.i1,this.i0 + 210);
               si16(this.i2,this.i0 + 212);
               si16(this.i2,this.i0 + 214);
            ...
            case 10:
               ...
               return;
            default:
               throw "Invalid state in _jpeg_set_defaults";
         }
         this.i1 = 8;
         si32(this.i1,this.i0 + 52);
         mstate.esp -= 16;
         this.i1 = cmodule.aircall._std_luminance_quant_tbl_2E_3095;
         this.i2 = 50;
         this.i4 = 0;
         si32(this.i0,mstate.esp);
