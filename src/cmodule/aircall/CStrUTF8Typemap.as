package cmodule.aircall
{
   ...
   {
      public function CStrUTF8Typemap(param1:ICAllocator = null)
      {
         if(!param1)
         {
      ...
      override public function readValue(param1:int) : *
      {
         ...
         _loc2_ = 0;
         while(cmodule.aircall.mstate.ds.readByte() != 0)
         {
            _loc2_++;
         }
         cmodule.aircall.mstate.ds.position = param1;
         return cmodule.aircall.mstate.ds.readUTFBytes(_loc2_);
      }
      ...
      {
         this.ByteArrayForString(String(param2)).readBytes(cmodule.aircall.mstate.ds,param1);
      }
   }
}
