package cmodule.aircall
{
   ...
   public final class FSM_process_data_simple_main extends Machine
   {
      ...
      public function FSM_process_data_simple_main()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_process_data_simple_main = null;
         _loc1_ = new FSM_process_data_simple_main();
         ...
         switch(state)
         {
            case 0:
               ...
               if(uint(this.i2) < uint(this.i3))
               {
                  ...
                  this.i3 = this.i0 + 340;
                  this.i9 = this.i1 + 24;
                  this.i10 = this.i0 + 336;
                  this.i1 += 12;
                  addr129:
                  this.i11 = li32(this.i1);
                  if(uint(this.i11) <= uint(7))
                  {
                     this.i11 = 8;
            ...
            case 2:
               ...
               else
               {
                  ...
                  if(uint(this.i11) < uint(this.i12))
                  {
                     §§goto(addr129);
                  }
               }
               §§goto(addr414);
            default:
               throw "Invalid state in _process_data_simple_main";
         }
         this.i11 = li32(this.i1);
         if(this.i11 == 8)
         {
