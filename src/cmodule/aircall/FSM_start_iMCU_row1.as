package cmodule.aircall
{
   ...
   public final class FSM_start_iMCU_row1 extends Machine
   {
      public function FSM_start_iMCU_row1()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         _loc2_ = li32(_loc1_ + 340);
         _loc3_ = li32(_loc1_ + 240);
         if(_loc3_ >= 2)
         {
            _loc1_ = 1;
         ...
         {
            _loc3_ = li32(_loc1_ + 236);
            _loc4_ = li32(_loc2_ + 8);
            _loc1_ = li32(_loc1_ + 244);
            _loc5_ = _loc2_ + 16;
            _loc6_ = _loc2_ + 12;
            _loc3_ += -1;
