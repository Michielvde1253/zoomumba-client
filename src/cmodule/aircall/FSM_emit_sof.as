package cmodule.aircall
{
   ...
   public final class FSM_emit_sof extends Machine
   {
      ...
      {
         var _loc1_:FSM_emit_sof = null;
         _loc1_ = new FSM_emit_sof();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 2:
               ...
               if(this.i1 <= 65535)
               {
                  ...
                  if(this.i1 < 65536)
                  {
                     ...
                     this.i5 = li8(this.i0 + 52);
                     si8(this.i5,this.i4);
                     this.i4 += 1;
                     si32(this.i4,this.i1);
                     this.i4 = li32(this.i1 + 4);
                     this.i4 += -1;
                     si32(this.i4,this.i1 + 4);
                     this.i5 = this.i0 + 24;
                     if(this.i4 == 0)
                     {
            ...
            case 15:
               ...
               §§goto(addr1239);
            default:
               throw "Invalid state in _emit_sof";
         }
         continue loop1;
      }
   }
