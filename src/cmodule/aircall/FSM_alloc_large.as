package cmodule.aircall
{
   ...
   public final class FSM_alloc_large extends Machine
   {
      ...
      public function FSM_alloc_large()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_alloc_large = null;
         _loc1_ = new FSM_alloc_large();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            ...
            case 4:
               ...
               addr380:
               this.i0 = 0;
               this.i7 = li32(this.i1 + 76);
               this.i2 <<= 2;
               this.i5 += this.i7;
               si32(this.i5,this.i1 + 76);
               this.i1 += this.i2;
               this.i2 = li32(this.i1 + 60);
               si32(this.i2,this.i4);
               si32(this.i3,this.i6 + 4);
               si32(this.i0,this.i6 + 8);
               si32(this.i6,this.i1 + 60);
               this.i0 = this.i4 + 12;
               mstate.eax = this.i0;
               ...
               return;
            default:
               throw "Invalid state in _alloc_large";
         }
         this.i4 = 0;
         mstate.esp -= 8;
         this.i5 = this.i3 + 12;
