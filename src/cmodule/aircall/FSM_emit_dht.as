package cmodule.aircall
{
   ...
   public final class FSM_emit_dht extends Machine
   {
      ...
      {
         var _loc1_:FSM_emit_dht = null;
         _loc1_ = new FSM_emit_dht();
         ...
         switch(state)
         {
            case 0:
               ...
               if(this.i2 != 0)
               {
                  ...
                  this.i2 = li32(this.i2 + 100);
                  this.i1 += 16;
                  if(this.i2 != 0)
                  {
                     addr186:
                     this.i3 = li32(this.i2 + 276);
                     this.i4 = this.i2 + 276;
                     if(this.i3 == 0)
                     {
                        this.i3 = 196;
                     ...
                     if(this.i1 == 16)
                     {
                        if(this.i7 > 0)
                        {
                           ...
                           while(true)
                           {
                              ...
                              this.i1 = this.i2 + this.i6;
                              this.i10 = li32(this.i7);
                              this.i1 = li8(this.i1 + 17);
                              si8(this.i1,this.i10);
                              this.i1 = this.i10 + 1;
                              si32(this.i1,this.i7);
                              this.i1 = li32(this.i7 + 4);
                              this.i1 += -1;
            ...
            case 9:
               ...
               §§goto(addr904);
            default:
               throw "Invalid state in _emit_dht";
         }
