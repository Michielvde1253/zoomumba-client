package cmodule.aircall
{
   ...
   public final class FSM_flush_bits extends Machine
   {
      ...
      public function FSM_flush_bits()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_flush_bits = null;
         _loc1_ = new FSM_flush_bits();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            ...
            case 2:
               ...
               return;
            default:
               throw "Invalid state in _flush_bits";
         }
         continue loop0;
      }
   }
