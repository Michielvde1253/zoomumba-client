package cmodule.aircall
{
   ...
   public final class FSM___fixsfdi extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc4_ = 0;
         _loc5_ = lf32(cmodule.aircall.mstate.ebp + 8);
         _loc4_ = _loc4_ = _loc4_;
         _loc6_ = _loc5_;
         if(_loc6_ < _loc4_)
         {
            _loc4_ = _loc4_ = _loc4_ = -9223370000000000000;
            _loc6_ = _loc5_;
            if(_loc6_ <= _loc4_)
            {
               _loc1_ = -2147483648;
            ...
            else
            {
               ...
               cmodule.aircall.mstate.esp -= 4;
               _loc5_ = _loc4_;
               sf32(_loc5_,cmodule.aircall.mstate.esp);
               cmodule.aircall.mstate.esp -= 4;
               cmodule.aircall.mstate.funcs[cmodule.aircall.___fixunssfdi]();
               _loc2_ = int(cmodule.aircall.mstate.eax);
               _loc3_ = int(cmodule.aircall.mstate.edx);
               cmodule.aircall.mstate.esp += 4;
               _loc2_ = int(__subc(_loc1_,_loc2_));
               _loc1_ = int(__sube(_loc1_,_loc3_));
            }
            addr240:
