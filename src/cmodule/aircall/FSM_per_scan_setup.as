package cmodule.aircall
{
   ...
   public final class FSM_per_scan_setup extends Machine
   {
      ...
      public function FSM_per_scan_setup()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_per_scan_setup = null;
         _loc1_ = new FSM_per_scan_setup();
      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               this.i1 = li32(this.i0 + 240);
               this.i2 = this.i0 + 240;
               this.i3 = this.i0;
               if(this.i1 == 1)
               {
                  this.i1 = 1;
                  this.i2 = li32(this.i0 + 244);
                  this.i3 = li32(this.i2 + 28);
                  si32(this.i3,this.i0 + 260);
                  this.i3 = li32(this.i2 + 32);
                  si32(this.i3,this.i0 + 264);
                  si32(this.i1,this.i2 + 52);
                  si32(this.i1,this.i2 + 56);
                  si32(this.i1,this.i2 + 60);
                  this.i3 = 8;
                  si32(this.i3,this.i2 + 64);
                  si32(this.i1,this.i2 + 68);
                  this.i3 = li32(this.i2 + 32);
                  this.i4 = li32(this.i2 + 12);
                  this.i3 = uint(this.i3) % uint(this.i4);
                  this.i3 = this.i3 == 0 ? this.i4 : this.i3;
                  si32(this.i3,this.i2 + 72);
                  si32(this.i1,this.i0 + 268);
                  this.i1 = 0;
                  si32(this.i1,this.i0 + 272);
                  this.i1 = li32(this.i0 + 200);
                  if(this.i1 > 0)
                  {
                     addr758:
                     this.i1 = li32(this.i0 + 200);
                     ...
                     this.i1 = this.i1 < 65536 ? this.i1 : 65535;
            ...
            case 2:
               ...
               return;
            default:
               throw "Invalid state in _per_scan_setup";
         }
         continue loop0;
      }
   }
