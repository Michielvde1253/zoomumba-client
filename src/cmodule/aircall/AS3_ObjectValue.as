package cmodule.aircall
{
   ...
   function AS3_ObjectValue(param1:Object, param2:String, param3:int) : void
   {
      ...
      var _loc4_:Array = param2.split(/\s*[,\:]\s*/);
      var _loc5_:int = 0;
      while(_loc5_ < _loc4_.length)
      {
         _loc6_ = _loc4_[_loc5_];
         _loc7_ = CTypemap.getTypeByName(_loc4_[_loc5_ + 1]);
         cmodule.aircall.mstate.ds.position = param3;
         _loc8_ = int(cmodule.aircall.mstate.ds.readInt());
         param3 += 4;
         _loc9_ = _loc7_.createC(param1[_loc6_]);
         cmodule.aircall.mstate.ds.position = _loc8_;
         _loc10_ = 0;
         while(_loc10_ < _loc9_.length)
         {
            cmodule.aircall.mstate.ds.writeInt(_loc9_[_loc10_]);
            _loc10_++;
         }
         _loc5_ += 2;
      }
