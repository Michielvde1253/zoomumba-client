package cmodule.aircall
{
   ...
   public final class FSM_jpeg_add_quant_table extends Machine
   {
      ...
      public function FSM_jpeg_add_quant_table()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_jpeg_add_quant_table = null;
         _loc1_ = new FSM_jpeg_add_quant_table();
         ...
         switch(state)
         {
            ...
            case 3:
               ...
               while(true)
               {
                  ...
                  this.i4 += 50;
                  this.i5 = this.i4 / 100;
                  this.i4 = this.i4 < 100 ? 1 : this.i5;
                  this.i5 = li32(this.i1);
                  this.i4 = this.i4 > 32767 ? 32767 : this.i4;
                  this.i6 = this.i0 << 1;
                  this.i4 = this.i4 > 255 ? 255 : this.i4;
                  this.i5 += this.i6;
                  si16(this.i4,this.i5);
                  this.i0 += 1;
                  break loop3;
               }
               break;
            default:
               throw "Invalid state in _jpeg_add_quant_table";
         }
         continue loop0;
      }
   }
