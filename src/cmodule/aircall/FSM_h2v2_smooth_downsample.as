package cmodule.aircall
{
   ...
   public final class FSM_h2v2_smooth_downsample extends Machine
   {
      public function FSM_h2v2_smooth_downsample()
      {
         super();
      }
      ...
      public static function start() : void
      {
         ...
         _loc6_ = _loc2_ << 4;
         _loc7_ = li32(cmodule.aircall.mstate.ebp + 16);
         _loc8_ = li32(cmodule.aircall.mstate.ebp + 20);
         _loc6_ -= _loc5_;
         _loc4_ += 2;
         if(_loc6_ >= 1)
         {
         ...
         if(_loc4_ >= 1)
         {
            ...
            do
            {
               ...
               _loc10_ = li8(_loc9_);
               _loc11_ = li8(_loc9_ + 1);
               _loc12_ = li32(_loc6_ + 8);
               _loc13_ = li8(_loc12_);
               _loc11_ += _loc10_;
               _loc14_ = li32(_loc6_);
               _loc15_ = li8(_loc12_ + 1);
               _loc11_ += _loc13_;
               _loc16_ = li8(_loc14_);
               _loc11_ += _loc15_;
               _loc15_ = li32(_loc6_ + 4);
               _loc17_ = li8(_loc14_ + 2);
               _loc11_ += _loc16_;
               _loc18_ = li8(_loc15_);
               _loc11_ += _loc17_;
               _loc17_ = li8(_loc15_ + 2);
               _loc11_ += _loc18_;
               _loc11_ = _loc11_ + _loc17_;
               _loc11_ = _loc11_ << 1;
               _loc17_ = li8(_loc14_ + 1);
               _loc19_ = li8(_loc9_ + 2);
               _loc10_ = _loc11_ + _loc10_;
               _loc10_ = _loc10_ + _loc19_;
               _loc11_ = _loc17_ + _loc16_;
               _loc16_ = li8(_loc15_ + 1);
               _loc11_ += _loc18_;
               _loc17_ = li8(_loc12_ + 2);
               _loc10_ += _loc13_;
               ...
               {
                  _loc20_ = _loc17_;
                  _loc17_ = _loc9_ + _loc20_;
                  _loc18_ = li8(_loc17_ + 2);
                  _loc21_ = li8(_loc17_ + 3);
                  _loc17_ = _loc12_ + _loc20_;
                  _loc19_ = _loc14_ + _loc20_;
                  _loc22_ = li8(_loc19_ + 2);
                  _loc23_ = li8(_loc19_ + 3);
                  _loc24_ = li8(_loc17_ + 2);
                  _loc18_ = _loc21_ + _loc18_;
                  _loc25_ = _loc15_ + _loc20_;
                  _loc26_ = li8(_loc25_ + 2);
                  _loc22_ = _loc23_ + _loc22_;
                  _loc27_ = li8(_loc17_ + 3);
                  _loc17_ = _loc18_ + _loc24_;
                  _loc24_ = _loc11_ + _loc8_;
                  _loc25_ = li8(_loc25_ + 3);
                  _loc18_ = li8(_loc19_ + 1);
                  _loc17_ += _loc27_;
                  _loc19_ = _loc22_ + _loc26_;
                  _loc17_ += _loc18_;
                  _loc22_ = _loc20_ + 1;
                  _loc18_ = _loc19_ + _loc25_;
                  _loc19_ = _loc24_ + 1;
                  if(_loc8_ == _loc2_)
                  {
                     break;
                  ...
                  _loc21_ = li8(_loc21_ + 4);
                  _loc22_ = _loc15_ + _loc20_;
                  _loc23_ = li8(_loc22_ + 1);
                  _loc17_ = _loc21_ + _loc17_;
                  _loc21_ = li8(_loc22_ + 4);
                  _loc17_ += _loc23_;
                  _loc17_ = _loc17_ + _loc21_;
                  _loc21_ = _loc9_ + _loc20_;
                  _loc22_ = li8(_loc21_ + 1);
                  _loc17_ <<= 1;
                  _loc21_ = li8(_loc21_ + 4);
                  _loc17_ += _loc22_;
               ...
               _loc9_ = _loc10_ + _loc22_;
               _loc9_ = li8(_loc9_);
               _loc8_ += _loc21_;
               _loc8_ = _loc8_ + _loc9_;
               _loc8_ = _loc8_ + _loc27_;
               _loc8_ = _loc8_ * _loc3_;
               _loc9_ = _loc18_ * _loc5_;
               _loc8_ = _loc9_ + _loc8_;
               _loc8_ = _loc8_ + 32768;
               _loc8_ = _loc8_ >>> 16;
               si8(_loc8_,_loc19_);
