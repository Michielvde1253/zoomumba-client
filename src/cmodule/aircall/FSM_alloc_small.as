package cmodule.aircall
{
   ...
   public final class FSM_alloc_small extends Machine
   {
      ...
      public function FSM_alloc_small()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_alloc_small = null;
         _loc1_ = new FSM_alloc_small();
      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               if(uint(this.i3) >= uint(999999989))
               {
                  this.i4 = 54;
               ...
               if(uint(this.i2) >= uint(2))
               {
                  ...
                  si32(this.i5,this.i6 + 20);
                  this.i5 = li32(this.i0);
                  si32(this.i2,this.i5 + 24);
                  this.i5 = li32(this.i0);
               ...
               this.i5 = 999999988 - this.i3;
               this.i7 = this.i3 + 12;
               if(this.i6 == 0)
               {
                  this.i8 = cmodule.aircall._first_pool_slop;
                  this.i2 <<= 2;
               ...
               {
                  this.i8 = cmodule.aircall._extra_pool_slop;
                  this.i2 <<= 2;
                  this.i2 = this.i8 + this.i2;
                  this.i2 = li32(this.i2);
                  if(uint(this.i5) >= uint(this.i2))
            ...
            case 3:
               ...
               if(this.i8 != 0)
               {
                  ...
                  addr688:
                  this.i8 = 0;
                  this.i9 = li32(this.i1 + 76);
                  this.i7 = this.i0 + this.i7;
                  this.i7 += this.i9;
                  si32(this.i7,this.i1 + 76);
               ...
               si32(this.i2,this.i9 + 20);
               this.i2 = li32(this.i5);
               this.i9 = 2;
               si32(this.i9,this.i2 + 24);
               this.i2 = li32(this.i5);
               this.i2 = li32(this.i2);
               mstate.esp -= 4;
               si32(this.i0,mstate.esp);
            ...
            default:
               throw "Invalid state in _alloc_small";
         }
         this.i1 = li32(this.i0 + 4);
         this.i2 = this.i1 + this.i3;
