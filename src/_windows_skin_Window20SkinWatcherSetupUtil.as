package
{
   ...
   public class _windows_skin_Window20SkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      public function _windows_skin_Window20SkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         Window20Skin.watcherSetupUtil = new _windows_skin_Window20SkinWatcherSetupUtil();
      }
