package
{
   ...
   public class _buttons_tabs_TabButtonSmallSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      public function _buttons_tabs_TabButtonSmallSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         TabButtonSmallSkin.watcherSetupUtil = new _buttons_tabs_TabButtonSmallSkinWatcherSetupUtil();
      }
