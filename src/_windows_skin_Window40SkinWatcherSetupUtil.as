package
{
   ...
   public class _windows_skin_Window40SkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      public function _windows_skin_Window40SkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         Window40Skin.watcherSetupUtil = new _windows_skin_Window40SkinWatcherSetupUtil();
      }
