package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class BreedingLabCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "BreedingLabCardMediator_";
      
      public var cardData:BreedingLabShopData;
      
      public function BreedingLabCardMediator(param1:BreedingLabShopData)
      {
