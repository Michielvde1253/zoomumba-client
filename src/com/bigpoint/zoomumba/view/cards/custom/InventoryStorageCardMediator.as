package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class InventoryStorageCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "InventoryStorageCardMediator_";
      
      public var cardData:StorageShopData;
      
      public var datas:Array;
      
      public function InventoryStorageCardMediator(param1:Array)
      {
         this.cardData = param1[0];
         this.datas = param1;
         _inventoryMode = true;
         super(getNameFromPrefix(NAME,Categories.STORAGE,this.cardData.itemId),param1[0],new ItemCard());
      }
      ...
      override protected function handleSellItem(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_.push(StorageShopData(this.datas[_loc5_]).uniqueId);
            _loc5_++;
         }
      ...
      override public function handleNotification(param1:INotification) : void
      {
         ...
         switch(param1.getName())
         {
            case CARDS.CHANGE_INVENTORY_AMOUNT:
               ...
               if(_loc2_[0] != this.cardData.categoryId || _loc2_[1][0] != StorageShopData(this.datas[0]).uniqueId)
               {
                  return;
               }
               _loc3_ = int(_loc2_[1].length);
               _loc4_ = card.topGroup.counter.value;
