package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class InventoryTrashBinCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "InventoryTrashBinCardMediator";
      
      public var cardData:TrashbinShopData;
      
      public var datas:Array;
      
      public function InventoryTrashBinCardMediator(param1:Array)
      {
         this.cardData = param1[0] as TrashbinShopData;
         this.datas = param1;
         _inventoryMode = true;
         super(getNameFromPrefix(NAME,Categories.TRASHBIN,this.cardData.itemId),param1[0],new ItemCard());
      }
      ...
      override protected function handleSellItem(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_.push(TrashbinShopData(this.datas[_loc5_]).uniqueId);
            _loc5_++;
         }
      ...
      override public function handleNotification(param1:INotification) : void
      {
         ...
         switch(param1.getName())
         {
            case CARDS.CHANGE_INVENTORY_AMOUNT:
               ...
               if(_loc2_[0] != this.cardData.categoryId || _loc2_[1][0] != TrashbinShopData(this.datas[0]).uniqueId)
               {
                  return;
               }
