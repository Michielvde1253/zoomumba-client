package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class PowerupCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "PowerupCardMediator_";
      
      public var cardData:PowerupShopData;
      
      public function PowerupCardMediator(param1:PowerupShopData)
      {
      ...
      {
         var _loc1_:String = TextIdHelper.getCardName(Categories.POWERUP,this.cardData.itemId);
      ...
      {
         this.cardData.localisedInfoId = TextIdHelper.getCardInfo(Categories.POWERUP,this.cardData.itemId);
      }
