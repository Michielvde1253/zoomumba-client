package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class CageCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "CageCardMediator_";
      
      public var cardData:CageShopData;
      
      public function CageCardMediator(param1:CageShopData)
      {
