package com.bigpoint.zoomumba.view.windows.anniversary
{
   ...
   public class GenericComicWindowMediator extends WindowMediator
   {
      public static const NAME:String = "GenericComicWindowMediator";
      ...
      public function GenericComicWindowMediator(param1:GenericComicWindow)
      {
         super(NAME,param1);
      }
      ...
      override public function init(param1:Object) : void
      {
         ...
         if(param1.eventId)
         {
            this._eventId = parseInt(String(param1.eventId));
         }
         if(param1.eventName)
         {
            this._eventName = String(param1.eventName);
         }
         if(param1.pages)
         {
            this._maxPages = parseInt(String(param1.pages));
         }
         if(param1.eventId)
         {
            this.loadAsset();
      ...
      private function loadAsset() : void
      {
         ...
         AssetLibrary.sendAssetToFunction(this._eventName + "ComicStep" + String(this._currentStep),this.assetsLoaded);
      }
      ...
      private function assetsLoaded(param1:SWFAsset) : void
      {
         ...
         if(this._asset.getChildByName("textGradientLayer"))
         {
            ...
            this.content.textGradient.htmlText = TextResourceModule.getText("zoo.window.infoLayers." + this._eventName + "Comic.layer" + String(this._currentStep) + ".content");
            if(this.content.textGradient.htmlText == "zoo.window.infoLayers." + this._eventName + "Comic.layer" + String(this._currentStep) + ".content")
            {
               _loc3_ = this._eventName.charAt(0).toUpperCase() + this._eventName.slice(1,this._eventName.length);
         ...
         if(this._asset.getChildByName("textNormalLayer"))
         {
            ...
            this.content.textNormal.htmlText = TextResourceModule.getText("zoo.window.infoLayers." + this._eventName + "Comic.layer" + String(this._currentStep) + ".bubble");
            if(this.content.textNormal.htmlText == "zoo.window.infoLayers." + this._eventName + "Comic.layer" + String(this._currentStep) + ".bubble")
            {
               _loc3_ = this._eventName.charAt(0).toUpperCase() + this._eventName.slice(1,this._eventName.length);
