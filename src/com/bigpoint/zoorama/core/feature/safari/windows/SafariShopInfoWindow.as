package com.bigpoint.zoorama.core.feature.safari.windows
{
   ...
   public class SafariShopInfoWindow extends SafariSizedMediumWindow
   {
      ...
      public function SafariShopInfoWindow(param1:Notifier, param2:WindowButtonParams = null)
      {
      ...
      override protected function assignLoadedContentGUI() : void
      {
         ...
         if(this.scrollContainer)
         {
            ...
            this.infoTxt = TextResourceModule.getText("zoo.safari.shopWindow.infoText");
