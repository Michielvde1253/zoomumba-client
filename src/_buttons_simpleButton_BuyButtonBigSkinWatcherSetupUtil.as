package
{
   ...
   public class _buttons_simpleButton_BuyButtonBigSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      public function _buttons_simpleButton_BuyButtonBigSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         BuyButtonBigSkin.watcherSetupUtil = new _buttons_simpleButton_BuyButtonBigSkinWatcherSetupUtil();
      }
