package
{
   ...
   public class _components_textfield_gradientText_GradientTextWatcherSetupUtil implements IWatcherSetupUtil2
   {
      public function _components_textfield_gradientText_GradientTextWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         GradientText.watcherSetupUtil = new _components_textfield_gradientText_GradientTextWatcherSetupUtil();
      }
