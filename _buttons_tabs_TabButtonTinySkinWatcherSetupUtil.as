package
{
   ...
   public class _buttons_tabs_TabButtonTinySkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      public function _buttons_tabs_TabButtonTinySkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         TabButtonTinySkin.watcherSetupUtil = new _buttons_tabs_TabButtonTinySkinWatcherSetupUtil();
      }
