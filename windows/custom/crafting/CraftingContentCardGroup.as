package windows.custom.crafting
{
   ...
   public class CraftingContentCardGroup extends Group
   {
      ...
      public function CraftingContentCardGroup()
      {
         super();
         this.percentWidth = 100;
         this.percentHeight = 100;
         this.mxmlContent = [this._CraftingContentCardGroup_InnerGroup1_c()];
      }
      ...
      private function _CraftingContentCardGroup_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._CraftingContentCardGroup_StandardTextInput1_i(),this._CraftingContentCardGroup_CardGroupHolder1_i()];
         if(!_loc1_.document)
         {
      ...
      private function _CraftingContentCardGroup_StandardTextInput1_i() : StandardTextInput
      {
      ...
      private function _CraftingContentCardGroup_CardGroupHolder1_i() : CardGroupHolder
      {
