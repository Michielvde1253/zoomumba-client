package windows.custom.nursery.success
{
   ...
   public class NurserySuccessContent extends Group implements IBindingClient
   {
      ...
      private var _113766sex:RadioButton;
      ...
      public function NurserySuccessContent()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         super();
         bindings = this._NurserySuccessContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_nursery_success_NurserySuccessContentWatcherSetupUtil");
         ...
         {
            return NurserySuccessContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._NurserySuccessContent_InnerGroup1_c(),this._NurserySuccessContent_OuterGroup1_c()];
         i = 0;
      ...
      {
         NurserySuccessContent._watcherSetupUtil = param1;
      }
      ...
      private function _NurserySuccessContent_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._NurserySuccessContent_StandardText1_i(),this._NurserySuccessContent_Group2_c()];
         if(!_loc1_.document)
         {
      ...
      private function _NurserySuccessContent_StandardText1_i() : StandardText
      {
      ...
      private function _NurserySuccessContent_Group2_c() : Group
      {
         ...
         _loc1_.mxmlContent = [this._NurserySuccessContent_StandardImage1_i(),this._NurserySuccessContent_StandardImage2_i(),this._NurserySuccessContent_RadioButton1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _NurserySuccessContent_StandardImage1_i() : StandardImage
      {
      ...
      private function _NurserySuccessContent_StandardImage2_i() : StandardImage
      {
      ...
      private function _NurserySuccessContent_RadioButton1_i() : RadioButton
      {
         ...
         this.sex = _loc1_;
         BindingManager.executeBindings(this,"sex",this.sex);
         return _loc1_;
      }
      
      private function _NurserySuccessContent_OuterGroup1_c() : OuterGroup
      {
         var _loc1_:OuterGroup = new OuterGroup();
         _loc1_.mxmlContent = [this._NurserySuccessContent_StandardImage3_i(),this._NurserySuccessContent_StandardImage4_i(),this._NurserySuccessContent_WindowHeader1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _NurserySuccessContent_StandardImage3_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
         _loc1_.left = 0;
         _loc1_.bottom = 0;
      ...
      private function _NurserySuccessContent_StandardImage4_i() : StandardImage
      {
         var _loc1_:StandardImage = new StandardImage();
         _loc1_.right = 0;
         _loc1_.bottom = 0;
      ...
      private function _NurserySuccessContent_WindowHeader1_i() : WindowHeader
      {
      ...
      private function _NurserySuccessContent_bindingsSetup() : Array
      {
         var result:Array = [];
      ...
      [Bindable(event="propertyChange")]
      public function get sex() : RadioButton
      {
         return this._113766sex;
      }
      
      public function set sex(param1:RadioButton) : void
      {
