package windows.custom.confirmation.extended
{
   ...
   public class BuyOnceContent extends Group implements IBindingClient
   {
      ...
      private var _106934601price:LabelDisplay;
      ...
      public function BuyOnceContent()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         super();
         bindings = this._BuyOnceContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_confirmation_extended_BuyOnceContentWatcherSetupUtil");
         ...
         {
            return BuyOnceContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.percentWidth = 100;
         this.percentHeight = 100;
         this.mxmlContent = [this._BuyOnceContent_InnerGroup1_c(),this._BuyOnceContent_OuterGroup1_c()];
         i = 0;
      ...
      {
         BuyOnceContent._watcherSetupUtil = param1;
      }
      ...
      private function _BuyOnceContent_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._BuyOnceContent_Group2_c(),this._BuyOnceContent_LabelDisplay1_i()];
         if(!_loc1_.document)
         {
      ...
      private function _BuyOnceContent_Group2_c() : Group
      {
         ...
         _loc1_.top = 110;
         _loc1_.bottom = 75;
         _loc1_.mxmlContent = [this._BuyOnceContent_StandardText1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _BuyOnceContent_StandardText1_i() : StandardText
      {
      ...
      private function _BuyOnceContent_LabelDisplay1_i() : LabelDisplay
      {
         ...
         this.price = _loc1_;
         BindingManager.executeBindings(this,"price",this.price);
         return _loc1_;
      }
      
      private function _BuyOnceContent_OuterGroup1_c() : OuterGroup
      {
         var _loc1_:OuterGroup = new OuterGroup();
         _loc1_.mxmlContent = [this._BuyOnceContent_WindowHeader1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _BuyOnceContent_WindowHeader1_i() : WindowHeader
      {
      ...
      private function _BuyOnceContent_bindingsSetup() : Array
      {
         var result:Array = [];
      ...
      [Bindable(event="propertyChange")]
      public function get price() : LabelDisplay
      {
         return this._106934601price;
      }
      
      public function set price(param1:LabelDisplay) : void
      {
