package windows.custom.confirmation.extended
{
   ...
   public class BuyConfirmationContent extends Group implements IBindingClient
   {
      ...
      public function BuyConfirmationContent()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         super();
         bindings = this._BuyConfirmationContent_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_confirmation_extended_BuyConfirmationContentWatcherSetupUtil");
         ...
         {
            return BuyConfirmationContent[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.percentWidth = 100;
         this.percentHeight = 100;
         this.mxmlContent = [this._BuyConfirmationContent_InnerGroup1_c(),this._BuyConfirmationContent_OuterGroup1_c()];
         i = 0;
      ...
      {
         BuyConfirmationContent._watcherSetupUtil = param1;
      }
      ...
      private function _BuyConfirmationContent_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._BuyConfirmationContent_VGroup1_c()];
         if(!_loc1_.document)
         {
      ...
      private function _BuyConfirmationContent_VGroup1_c() : VGroup
      {
         ...
         _loc1_.mxmlContent = [this._BuyConfirmationContent_Label1_i(),this._BuyConfirmationContent_LabelDisplay1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _BuyConfirmationContent_Label1_i() : Label
      {
      ...
      private function _BuyConfirmationContent_LabelDisplay1_i() : LabelDisplay
      {
      ...
      private function _BuyConfirmationContent_OuterGroup1_c() : OuterGroup
      {
         var _loc1_:OuterGroup = new OuterGroup();
         _loc1_.mxmlContent = [this._BuyConfirmationContent_WindowHeader1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _BuyConfirmationContent_WindowHeader1_i() : WindowHeader
      {
      ...
      private function _BuyConfirmationContent_bindingsSetup() : Array
      {
         var result:Array = [];
