package windows.custom.shop
{
   ...
   public class ShopContentCardGroup extends Group
   {
      ...
      public function ShopContentCardGroup()
      {
         super();
         this.percentWidth = 100;
         this.percentHeight = 100;
         this.mxmlContent = [this._ShopContentCardGroup_InnerGroup1_c()];
      }
      ...
      private function _ShopContentCardGroup_InnerGroup1_c() : InnerGroup
      {
         var _loc1_:InnerGroup = new InnerGroup();
         _loc1_.mxmlContent = [this._ShopContentCardGroup_StandardTextInput1_i(),this._ShopContentCardGroup_CardGroupHolder1_i()];
         if(!_loc1_.document)
         {
      ...
      private function _ShopContentCardGroup_StandardTextInput1_i() : StandardTextInput
      {
      ...
      private function _ShopContentCardGroup_CardGroupHolder1_i() : CardGroupHolder
      {
