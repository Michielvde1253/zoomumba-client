package windows.custom.dailyLogin
{
   ...
   public class DailyLoginWindow extends AbstractWindow implements IBindingClient
   {
      ...
      public function DailyLoginWindow()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_custom_dailyLogin_DailyLoginWindowWatcherSetupUtil");
