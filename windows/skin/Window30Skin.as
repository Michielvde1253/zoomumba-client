package windows.skin
{
   ...
   public class Window30Skin extends Skin implements IBindingClient, IStateClient2
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _Window30Skin_BitmapFill1:BitmapFill;
      
      public var _Window30Skin_HGroup2:HGroup;
      ...
      private var _embed_mxml__windows_Borders_swf_Border30_993268912:Class;
      ...
      public function Window30Skin()
      {
         ...
         this._embed_mxml__windows_Borders_swf_Border30_993268912 = Window30Skin__embed_mxml__windows_Borders_swf_Border30_993268912;
         this._embed_mxml__general_Decorations_swf_LoaderProgress_1407024497 = Window30Skin__embed_mxml__general_Decorations_swf_LoaderProgress_1407024497;
         this.mx_internal::_bindings = [];
         this.mx_internal::_watchers = [];
         this.mx_internal::_bindingsByDestination = {};
         this.mx_internal::_bindingsBeginWithWord = {};
         super();
         bindings = this._Window30Skin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_windows_skin_Window30SkinWatcherSetupUtil");
         ...
         {
            return Window30Skin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._Window30Skin_SpriteVisualElement1_i(),this._Window30Skin_Group1_i()];
      ...
      {
         Window30Skin._watcherSetupUtil = param1;
      }
      ...
      private function _Window30Skin_SpriteVisualElement1_i() : SpriteVisualElement
      {
      ...
      private function _Window30Skin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._Window30Skin_Group2_c(),this._Window30Skin_Group3_i(),this._Window30Skin_BitmapImage1_i(),this._Window30Skin_Group4_i(),this._Window30Skin_HGroup1_i(),this._Window30Skin_Image1_i(),this._Window30Skin_Button1_i(),this._Window30Skin_HGroup2_i(),this._Window30Skin_HGroup3_c()];
         _loc1_.id = "viewport";
         if(!_loc1_.document)
         {
      ...
      private function _Window30Skin_Group2_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._Window30Skin_Path1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _Window30Skin_Path1_c() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.y = -55.5;
         _loc1_.data = "M475 90.5 489 273.5 477 315.5 447 337.5 232 344.5 36 335.5 9 312.5 0 180.5 23 84.5 62.2 67.3 244 55.5 443 63.5 475 90.5";
         _loc1_.fill = this._Window30Skin_BitmapFill1_i();
         _loc1_.initialized(this,null);
         BindingManager.executeBindings(this,"temp",_loc1_);
         return _loc1_;
      }
      
      private function _Window30Skin_BitmapFill1_i() : BitmapFill
      {
         var _loc1_:BitmapFill = new BitmapFill();
         _loc1_.fillMode = "repeat";
         _loc1_.scaleX = 1;
         _loc1_.scaleY = 1;
         this._Window30Skin_BitmapFill1 = _loc1_;
         BindingManager.executeBindings(this,"_Window30Skin_BitmapFill1",this._Window30Skin_BitmapFill1);
         return _loc1_;
      }
      
      private function _Window30Skin_Group3_i() : Group
      {
         var _loc1_:Group = new Group();
      ...
      private function _Window30Skin_BitmapImage1_i() : BitmapImage
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.source = this._embed_mxml__windows_Borders_swf_Border30_993268912;
      ...
      private function _Window30Skin_Group4_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
      ...
      private function _Window30Skin_HGroup1_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.percentWidth = 100;
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalAlign = "top";
         _loc1_.mxmlContent = [this._Window30Skin_UIComponent1_i()];
      ...
      private function _Window30Skin_UIComponent1_i() : UIComponent
      {
      ...
      private function _Window30Skin_Image1_i() : Image
      {
      ...
      private function _Window30Skin_Button1_i() : Button
      {
      ...
      private function _Window30Skin_HGroup2_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalAlign = "top";
         _loc1_.mxmlContent = [this._Window30Skin_LoaderImage1_i()];
         _loc1_.id = "_Window30Skin_HGroup2";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._Window30Skin_HGroup2 = _loc1_;
         BindingManager.executeBindings(this,"_Window30Skin_HGroup2",this._Window30Skin_HGroup2);
         return _loc1_;
      }
      
      private function _Window30Skin_LoaderImage1_i() : LoaderImage
      {
      ...
      private function _Window30Skin_HGroup3_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         ...
         _loc1_.x = 0;
         _loc1_.y = 282;
         _loc1_.mxmlContent = [this._Window30Skin_Button2_i(),this._Window30Skin_Button3_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _Window30Skin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
      ...
      private function _Window30Skin_Button3_i() : Button
      {
         var _loc1_:Button = new Button();
      ...
      private function _Window30Skin_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():Number
         {
            return WindowConstants.WIDTH_SKIN_30;
         },null,"viewport.width");
         result[1] = new Binding(this,function():Number
         {
            return WindowConstants.HEIGHT_SKIN_30;
         },null,"viewport.height");
         result[2] = new Binding(this,function():Object
         {
            return hostComponent.backgroundPattern;
         },null,"_Window30Skin_BitmapFill1.source");
         result[3] = new Binding(this,function():Number
         {
            return -header.height / 8;
         },null,"_Window30Skin_HGroup2.y");
         return result;
      }
