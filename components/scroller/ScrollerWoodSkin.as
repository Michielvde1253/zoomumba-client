package components.scroller
{
   ...
   public class ScrollerWoodSkin extends SparkSkin
   {
      ...
      public function ScrollerWoodSkin()
      {
         super();
         this.mxmlContent = [this._ScrollerWoodSkin_VScrollBar1_i(),this._ScrollerWoodSkin_HScrollBar1_i()];
      }
      ...
      private function _ScrollerWoodSkin_VScrollBar1_i() : VScrollBar
      {
         var _loc1_:VScrollBar = new VScrollBar();
         _loc1_.visible = false;
         _loc1_.percentHeight = 100;
         _loc1_.setStyle("fixedThumbSize",true);
         _loc1_.setStyle("skinClass",VScrollBarSkin);
      ...
      private function _ScrollerWoodSkin_HScrollBar1_i() : HScrollBar
      {
