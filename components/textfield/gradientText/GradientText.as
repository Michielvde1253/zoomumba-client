package components.textfield.gradientText
{
   ...
   public class GradientText extends Group implements IBindingClient
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _GradientText_Rect2:Rect;
      ...
      private var _94842723color:uint = 0;
      ...
      public function GradientText()
      {
         ...
         super();
         bindings = this._GradientText_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_components_textfield_gradientText_GradientTextWatcherSetupUtil");
         ...
         {
            return GradientText[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._GradientText_Text1_i(),this._GradientText_Rect1_i(),this._GradientText_Rect2_i()];
         this.addEventListener("creationComplete",this.___GradientText_Group1_creationComplete);
         this.addEventListener("addedToStage",this.___GradientText_Group1_addedToStage);
         i = 0;
      ...
      {
         GradientText._watcherSetupUtil = param1;
      }
      ...
      private function draw(param1:int) : void
      {
         ...
         {
            _loc2_ = [13984270,16744483,16777093,16777215,16777093,16744483,13984270];
            _loc3_ = [1,1,1,1,1,1,1];
            _loc4_ = [0,40,112,122,133,215,255];
      ...
      private function _GradientText_Text1_i() : Text
      {
      ...
      private function _GradientText_Rect1_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.fill = this._GradientText_BitmapFill1_i();
      ...
      private function _GradientText_BitmapFill1_i() : BitmapFill
      {
      ...
      private function _GradientText_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.stroke = this._GradientText_SolidColorStroke1_c();
         _loc1_.initialized(this,"_GradientText_Rect2");
         this._GradientText_Rect2 = _loc1_;
         BindingManager.executeBindings(this,"_GradientText_Rect2",this._GradientText_Rect2);
         return _loc1_;
      }
      
      private function _GradientText_SolidColorStroke1_c() : SolidColorStroke
      {
      ...
      public function ___GradientText_Group1_creationComplete(param1:FlexEvent) : void
      {
         this.created(param1);
      }
      
      public function ___GradientText_Group1_addedToStage(param1:Event) : void
      {
         this.update(param1);
      }
      
      private function _GradientText_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         result[17] = new Binding(this,null,null,"_GradientText_Rect2.visible","debugMode");
         return result;
      }
