package
{
   ...
   public class _buttons_simpleButton_BuyButtonGoldSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      public function _buttons_simpleButton_BuyButtonGoldSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         BuyButtonGoldSkin.watcherSetupUtil = new _buttons_simpleButton_BuyButtonGoldSkinWatcherSetupUtil();
      }
