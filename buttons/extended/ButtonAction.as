package buttons.extended
{
   ...
   public class ButtonAction extends Group implements IBindingClient, IStateClient2
   {
      ...
      public function ButtonAction()
      {
         ...
         super();
         bindings = this._ButtonAction_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_buttons_extended_ButtonActionWatcherSetupUtil");
         ...
         {
            return ButtonAction[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.width = 112;
         this.height = 30;
         this.mxmlContent = [this._ButtonAction_Button1_i(),this._ButtonAction_GradientText1_i(),this._ButtonAction_LabelDisplay1_i()];
      ...
      {
         ButtonAction._watcherSetupUtil = param1;
      }
      ...
      private function _ButtonAction_Button1_i() : Button
      {
      ...
      private function _ButtonAction_GradientText1_i() : GradientText
      {
      ...
      private function _ButtonAction_LabelDisplay1_i() : LabelDisplay
      {
         ...
         _loc1_.mouseEnabled = false;
         _loc1_.verticalCenter = 0;
         _loc1_.setStyle("skinClass",LabelDisplayWhiteSkin);
         _loc1_.id = "label";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ButtonAction_bindingsSetup() : Array
      {
         var result:Array = [];
