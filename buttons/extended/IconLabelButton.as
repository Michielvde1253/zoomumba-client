package buttons.extended
{
   ...
   public class IconLabelButton extends Group implements IBindingClient, IStateClient2
   {
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      private var _3141bg:BackgroundImage;
      ...
      public function IconLabelButton()
      {
         ...
         super();
         bindings = this._IconLabelButton_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_buttons_extended_IconLabelButtonWatcherSetupUtil");
         ...
         {
            return IconLabelButton[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.width = 220;
         this.height = 50;
         this.mxmlContent = [this._IconLabelButton_Button1_i(),this._IconLabelButton_Group2_i()];
      ...
      {
         IconLabelButton._watcherSetupUtil = param1;
      }
      ...
      private function _IconLabelButton_Button1_i() : Button
      {
      ...
      private function _IconLabelButton_Group2_i() : Group
      {
         ...
         _loc1_.verticalCenter = 0;
         _loc1_.left = 5;
         _loc1_.mxmlContent = [this._IconLabelButton_Group3_c(),this._IconLabelButton_GradientText1_i()];
         _loc1_.id = "content";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _IconLabelButton_Group3_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._IconLabelButton_BackgroundImage1_i(),this._IconLabelButton_Image1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _IconLabelButton_BackgroundImage1_i() : BackgroundImage
      {
      ...
      private function _IconLabelButton_Image1_i() : Image
      {
      ...
      private function _IconLabelButton_GradientText1_i() : GradientText
      {
      ...
      private function _IconLabelButton_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         result[2] = new Binding(this,null,null,"icon.source","iconClass");
         result[3] = new Binding(this,null,null,"gradientText.text","label");
         return result;
      }
      
      [Bindable(event="propertyChange")]
      public function get bg() : BackgroundImage
      {
         return this._3141bg;
      }
      
      public function set bg(param1:BackgroundImage) : void
      {
