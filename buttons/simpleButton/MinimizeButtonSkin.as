package buttons.simpleButton
{
   ...
   public class MinimizeButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _embed_mxml__removeFromHere_ButtonsBackgrounds_swf_MinimizeButton_1080481:Class = MinimizeButtonSkin__embed_mxml__removeFromHere_ButtonsBackgrounds_swf_MinimizeButton_1080481;
      ...
      public function MinimizeButtonSkin()
      {
         ...
         this.width = 39;
         this.height = 38;
         this.mxmlContent = [this._MinimizeButtonSkin_HGroup1_c(),this._MinimizeButtonSkin_HGroup2_i()];
         this.currentState = "up";
         this.addEventListener("creationComplete",this.___MinimizeButtonSkin_SparkSkin1_creationComplete);
         states = [new State({
            "name":"up",
            "overrides":[]
         }),new State({
      ...
      private function _MinimizeButtonSkin_HGroup1_c() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._MinimizeButtonSkin_Image1_c()];
         if(!_loc1_.document)
         {
      ...
      private function _MinimizeButtonSkin_Image1_c() : Image
      {
         var _loc1_:Image = new Image();
         _loc1_.source = this._embed_mxml__removeFromHere_ButtonsBackgrounds_swf_MinimizeButton_1080481;
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _MinimizeButtonSkin_HGroup2_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.verticalAlign = "middle";
         _loc1_.horizontalAlign = "center";
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._MinimizeButtonSkin_Ellipse1_i()];
      ...
      private function _MinimizeButtonSkin_Ellipse1_i() : Ellipse
      {
         var _loc1_:Ellipse = new Ellipse();
         _loc1_.width = 39;
         _loc1_.height = 39;
         _loc1_.fill = this._MinimizeButtonSkin_SolidColor1_c();
      ...
      private function _MinimizeButtonSkin_SolidColor1_c() : SolidColor
      {
      ...
      public function ___MinimizeButtonSkin_SparkSkin1_creationComplete(param1:FlexEvent) : void
      {
         this.config(param1);
      }
