package buttons.simpleButton
{
   ...
   public class OKButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _embed_mxml__removeFromHere_ButtonsBackgrounds_swf_OKButton_1475311839:Class = OKButtonSkin__embed_mxml__removeFromHere_ButtonsBackgrounds_swf_OKButton_1475311839;
      ...
      public function OKButtonSkin()
      {
         ...
         this.width = 75;
         this.height = 74;
         this.mxmlContent = [this._OKButtonSkin_BackgroundImage1_c(),this._OKButtonSkin_HGroup1_c(),this._OKButtonSkin_HGroup2_i()];
         this.currentState = "up";
         this.addEventListener("creationComplete",this.___OKButtonSkin_SparkSkin1_creationComplete);
         states = [new State({
            "name":"up",
            "overrides":[]
         }),new State({
      ...
      private function _OKButtonSkin_BackgroundImage1_c() : BackgroundImage
      {
      ...
      private function _OKButtonSkin_HGroup1_c() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._OKButtonSkin_Rect1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _OKButtonSkin_Rect1_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.width = 53;
         _loc1_.height = 54;
         _loc1_.fill = this._OKButtonSkin_BitmapFill1_c();
      ...
      private function _OKButtonSkin_BitmapFill1_c() : BitmapFill
      {
         var _loc1_:BitmapFill = new BitmapFill();
         _loc1_.smooth = true;
         _loc1_.source = this._embed_mxml__removeFromHere_ButtonsBackgrounds_swf_OKButton_1475311839;
         BindingManager.executeBindings(this,"temp",_loc1_);
         return _loc1_;
      }
      
      private function _OKButtonSkin_HGroup2_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.verticalAlign = "middle";
         _loc1_.horizontalAlign = "center";
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._OKButtonSkin_Ellipse1_i()];
      ...
      private function _OKButtonSkin_Ellipse1_i() : Ellipse
      {
         var _loc1_:Ellipse = new Ellipse();
         _loc1_.width = 60;
         _loc1_.height = 60;
         _loc1_.fill = this._OKButtonSkin_SolidColor1_c();
      ...
      private function _OKButtonSkin_SolidColor1_c() : SolidColor
      {
      ...
      public function ___OKButtonSkin_SparkSkin1_creationComplete(param1:FlexEvent) : void
      {
         this.config(param1);
      }
