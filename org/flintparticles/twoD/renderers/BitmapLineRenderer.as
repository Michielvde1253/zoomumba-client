package org.flintparticles.twoD.renderers
{
   ...
   public class BitmapLineRenderer extends BitmapRenderer
   {
      ...
      public function BitmapLineRenderer(param1:Rectangle, param2:Boolean = false)
      {
         super(param1,param2);
      ...
      override protected function drawParticle(param1:Particle2D) : void
      {
         ...
         this._shape.graphics.moveTo(param1.previousX - _canvas.x,param1.previousY - _canvas.y);
         this._shape.graphics.lineTo(param1.x - _canvas.x,param1.y - _canvas.y);
