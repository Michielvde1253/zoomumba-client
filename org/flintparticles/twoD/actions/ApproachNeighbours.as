package org.flintparticles.twoD.actions
{
   ...
   public class ApproachNeighbours extends ActionBase
   {
      ...
      public function ApproachNeighbours(param1:Number = 0, param2:Number = 0)
      {
         super();
         priority = 10;
      ...
      override public function update(param1:Emitter, param2:Particle, param3:Number) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc12_ < -this._max)
            {
               break;
            }
            _loc13_ = _loc7_.y - _loc4_.y;
            if(!(_loc13_ > this._max || _loc13_ < -this._max))
            {
               _loc11_ = _loc13_ * _loc13_ + _loc12_ * _loc12_;
               if(_loc11_ <= this._maxSq && _loc11_ > 0)
               {
