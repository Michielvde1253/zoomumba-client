package org.flintparticles.twoD.actions
{
   ...
   public class MatchVelocity extends ActionBase
   {
      ...
      public function MatchVelocity(param1:Number = 0, param2:Number = 0)
      {
         super();
         priority = 10;
      ...
      override public function update(param1:Emitter, param2:Particle, param3:Number) : void
      {
         ...
         if(_loc15_ != 0)
         {
            _loc13_ = _loc13_ / _loc15_ - _loc4_.velX;
            _loc14_ = _loc14_ / _loc15_ - _loc4_.velY;
            if(_loc13_ != 0 || _loc14_ != 0)
            {
               _loc16_ = param3 * this._acc / Math.sqrt(_loc13_ * _loc13_ + _loc14_ * _loc14_);
               if(_loc16_ > 1)
               {
                  _loc16_ = 1;
               }
               _loc4_.velX += _loc16_ * _loc13_;
               _loc4_.velY += _loc16_ * _loc14_;
            }
         }
      }
   }
