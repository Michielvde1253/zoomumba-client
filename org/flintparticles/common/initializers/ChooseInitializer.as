package org.flintparticles.common.initializers
{
   ...
   public class ChooseInitializer extends InitializerBase
   {
      ...
      public function ChooseInitializer(param1:Array = null, param2:Array = null)
      {
         super();
         this._initializers = new WeightedArray();
         if(param1 == null)
         {
            return;
         }
      ...
      private function init(param1:Array = null, param2:Array = null) : void
      {
         ...
         if(param2 != null && param2.length == _loc3_)
         {
            ...
            while(_loc4_ < _loc3_)
            {
               this._initializers.add(param1[_loc4_],param2[_loc4_]);
               _loc4_++;
            }
         }
         else
         {
            ...
            while(_loc4_ < _loc3_)
            {
               this._initializers.add(param1[_loc4_],1);
               _loc4_++;
            }
         }
      }
      
      public function addInitializer(param1:Initializer, param2:Number = 1) : void
      {
      ...
      {
         this._initializers.remove(param1);
      }
      
      public function set initializers(param1:Array) : void
      {
         this._mxmlInitializers = param1;
      ...
      {
         if(Boolean(this._mxmlInitializers) && Boolean(this._mxmlWeights))
         {
            this.init(this._mxmlInitializers,this._mxmlWeights);
            this._mxmlInitializers = null;
            this._mxmlWeights = null;
      ...
      {
         var _loc3_:Initializer = this._initializers.getRandomValue();
