package com.flexspy.imp.metadata
{
   ...
   {
      private static var COMPONENTS:XML = <components>
      ...
      public function FrameworkMetadata()
      {
         super();
      }
      
      private static function containsStyleMetadata(param1:Array, param2:String) : Boolean
      {
         var _loc3_:StyleMetadata = null;
      ...
      public static function getClassStyles(param1:Object) : Array
      {
         var subClass:XML = null;
         var className:String = null;
         var qualifiedSubClassName:String = null;
         var xmlClassStyleMetadata:XMLList = null;
         var xmlStyleMetadata:XML = null;
         var styleMetadata:StyleMetadata = null;
         ...
         for each(subClass in classHierarchy)
         {
            qualifiedSubClassName = subClass.toString().replace("::",".");
            hierarchy.push(qualifiedSubClassName);
         }
         for each(className in hierarchy)
         {
            xmlClassStyleMetadata = COMPONENTS.component.(@name == className).style;
            for each(xmlStyleMetadata in xmlClassStyleMetadata)
            {
               styleMetadata = new StyleMetadata(xmlStyleMetadata);
