package com.bigpoint.zoomumba.controller.playfield.cageActions
{
   ...
   public class CageSuperFeedActionCommand extends SimpleCommand
   {
      public function CageSuperFeedActionCommand()
      {
         super();
      }
      ...
      override public function execute(param1:INotification) : void
      {
         ...
         _loc8_ = _loc3_.getResourseUsedAmount(_loc7_,ActionType.SUPER_FEED);
         ...
         if(_loc19_)
         {
            _loc17_ = _loc5_.oceanSuperFood;
            _loc18_ = Resources.SUPER_FISH_FOOD;
         }
         else
         {
            _loc17_ = _loc5_.superfood;
            _loc18_ = Resources.SUPERFOOD;
         }
         if(_loc17_ >= _loc8_)
         {
            ...
            _loc21_ = new CageDropRequestVO(_loc2_,CageActionIds.SUPERFEED);
            sendNotification(Note.GENERATE_DROPS,_loc21_);
            _loc15_.feedTimeStamp = TimeManager.currentTime + _loc9_.feedTime;
            sendNotification(NET.SUPER_FEED_ANIMAL_CAGE,[_loc2_]);
            ...
            if(!Settings.TUTORIAL_ACTIVE)
            {
               _loc23_ = _loc3_.getItemCalculatedXP(_loc7_,ActionType.SUPER_FEED);
