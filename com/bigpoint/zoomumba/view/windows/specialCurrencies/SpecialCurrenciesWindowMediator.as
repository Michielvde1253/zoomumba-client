package com.bigpoint.zoomumba.view.windows.specialCurrencies
{
   import com.bigpoint.zoomumba.model.app.resources.AssetLibrary;
   import com.bigpoint.zoomumba.model.app.resources.decoder.SWFAsset;
   import com.bigpoint.zoomumba.model.net.NetHelperProxy;
   import com.bigpoint.zoomumba.view.windowSystem.WindowMediator;
   import com.bigpoint.zoomumba.view.windows.specialCurrencies.tabMediators.SpecialPetPawTabMediator;
   ...
   public class SpecialCurrenciesWindowMediator extends WindowMediator
   {
      public static const NAME:String = "SpecialCurrenciesWindowMediator";
      
      private var _lastTabMediator:String = null;
      
      public function SpecialCurrenciesWindowMediator(param1:SpecialsCurrenciesWindow)
      {
         super(NAME,param1);
      }
      ...
      override public function init(param1:Object) : void
      {
         ...
         (this.window.getContent() as SpecialsCurrenciesContent).tab1.label = TextResourceModule.getText("zoo.inventory.tabs.pawprints");
         ...
         switch(event.contentClass)
         {
            case CurrencyTabContent:
               AssetLibrary.sendAssetToFunction("SpecialCurrenciesAssets",function(param1:SWFAsset):void
               {
                  ...
                  facade.registerMediator(new SpecialPetPawTabMediator(window.getContent() as CurrencyTabContent,param1));
                  _lastTabMediator = SpecialPetPawTabMediator.NAME;
               });
               break;
