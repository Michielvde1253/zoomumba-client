package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class InventoryRoadCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "InventoryRoadCardMediator";
      
      public var cardData:RoadShopData;
      
      public var datas:Array;
      
      public function InventoryRoadCardMediator(param1:Array)
      {
         this.cardData = param1[0];
         this.datas = param1;
         _inventoryMode = true;
         super(getNameFromPrefix(NAME,Categories.ROAD,this.cardData.itemId),param1[0],new ItemCard());
      }
      ...
      override protected function handleSellItem(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_.push(RoadShopData(this.datas[_loc5_]).uniqueId);
            _loc5_++;
         }
      ...
      override public function handleNotification(param1:INotification) : void
      {
         ...
         switch(param1.getName())
         {
            case CARDS.CHANGE_INVENTORY_AMOUNT:
               ...
               if(_loc2_[0] != this.cardData.categoryId || _loc2_[1][0] != RoadShopData(this.datas[0]).uniqueId)
               {
                  return;
               }
