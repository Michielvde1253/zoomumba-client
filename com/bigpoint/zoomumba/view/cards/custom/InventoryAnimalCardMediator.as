package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class InventoryAnimalCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "InventoryAnimalCardMediator_";
      
      public var cardData:AnimalShopData;
      
      public var datas:Array;
      
      public function InventoryAnimalCardMediator(param1:Array)
      {
         this.cardData = param1[0];
         this.datas = param1;
         _inventoryMode = true;
         super(getNameFromPrefix(NAME,Categories.ANIMAL,this.cardData.itemId),param1[0],new ItemCard());
      }
      ...
      override protected function handleSellItem(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_.push(AnimalShopData(this.datas[_loc5_]).uniqueId);
            _loc5_++;
         }
      ...
      override public function handleNotification(param1:INotification) : void
      {
         ...
         switch(param1.getName())
         {
            case CARDS.CHANGE_INVENTORY_AMOUNT:
               ...
               if(_loc2_[0] != this.cardData.categoryId || _loc2_[1][0] != ShopItemData(this.datas[0]).uniqueId)
               {
                  return;
               }
               ...
               _card.topGroup.counter.value = _loc4_ - _loc3_;
               if(_loc4_ - _loc3_ == 0)
               {
