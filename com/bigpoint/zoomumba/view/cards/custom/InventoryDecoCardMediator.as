package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class InventoryDecoCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "InventoryDecoCardMediator_";
      
      public var cardData:DecorShopData;
      
      public var datas:Array;
      
      public function InventoryDecoCardMediator(param1:Array)
      {
      ...
      override protected function handleSellItem(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_.push(DecorShopData(this.datas[_loc5_]).uniqueId);
            _loc5_++;
         }
      ...
      override public function handleNotification(param1:INotification) : void
      {
         ...
         switch(param1.getName())
         {
            case CARDS.CHANGE_INVENTORY_AMOUNT:
               ...
               if(_loc2_[0] != this.cardData.categoryId || _loc2_[1][0] != DecorShopData(this.datas[0]).uniqueId)
               {
                  return;
               }
