package com.bigpoint.zoomumba.view.cards.custom
{
   ...
   public class InventoryStoreCardMediator extends BaseCardMediator
   {
      public static const NAME:String = "InventoryStoreCardMediator_";
      
      public var cardData:StoreShopData;
      
      public var datas:Array;
      
      public function InventoryStoreCardMediator(param1:Array)
      {
         this.cardData = param1[0];
         this.datas = param1;
         _inventoryMode = true;
         super(getNameFromPrefix(NAME,Categories.DECOR,this.cardData.itemId),param1[0],new ItemCard());
      }
      ...
      override protected function handleSellItem(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_.push(StoreShopData(this.datas[_loc5_]).uniqueId);
            _loc5_++;
         }
      ...
      override public function handleNotification(param1:INotification) : void
      {
         ...
         switch(param1.getName())
         {
            case CARDS.CHANGE_INVENTORY_AMOUNT:
               ...
               if(_loc2_[0] != this.cardData.categoryId || _loc2_[1][0] != StoreShopData(this.datas[0]).uniqueId)
               {
                  return;
               }
      ...
      {
         var _loc1_:String = TextIdHelper.getCardName(Categories.STORE,this.cardData.itemId);
      ...
      {
         this.cardData.localisedInfoId = TextIdHelper.getCardInfo(Categories.STORE,this.cardData.itemId);
      }
